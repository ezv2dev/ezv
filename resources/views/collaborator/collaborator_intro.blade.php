...
<div class="page-container">
    <section id="header-container">
     ...
     {{-- navbar --}}
        <div class="h-100 w-100" style="box-sizing: border-box; background-color: #000000;">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-20">
                <div class="right-image">
                    <img class="lozad" src="{{ LazyLoad::show() }}" data-src="https://source.unsplash.com/random/?people,collaboration">
                </div>
            </div>
        </div>
    </section>
