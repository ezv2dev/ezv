...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  ...
  <tr data-element="blue-logo" data-label="Logo">
    <td align="center" class="center-text" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:900;font-style:normal;color:#230379;text-decoration:none;letter-spacing:1px;">
      ...
      <singleline style="font-size: 50px;">
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" width="640" style="width:640px;max-width:640px;" data-module="blue-header">
  ...
  <tr>
    <td align="center" class="img-responsive container-padding">
      <img class="auto-width" style="display:block;width:100%;max-width:100%;border:0px;height: 200px;object-fit: cover;" data-image-edit data-url data-label="Header image" width="640" src="{{ URL::asset('/foto/gallery/'.strtolower($details['villa_name']).'/'.$details['villa_photo'])}}" border="0" editable="true" alt="picture">
    </td>
  </tr>
  <!-- blue-header -->
</table>

<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="blue-preface-16">
  <!-- blue-preface-16 -->
  <tr>
    <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor" class="container-padding">
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        <tr data-element="blue-subline" data-label="Sublines">
          <td class="center-text" data-text-style="Sublines" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:900;font-style:normal;color:#50C0FF;text-decoration:none;letter-spacing:1px;">
              <singleline style="font-size: 30px;">
                <div mc:edit data-text-edit>
                  INVOICE
                </div>
              </singleline>
        ...
        <tr data-element="blue-button" data-label="Buttons">
          <td align="center">
            ...
            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
              <tr>
                <td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="Buttons" data-bgcolor="Buttons" bgcolor="#0387EC" style="border-radius: 0px; border: 2px solid #0060aa;">
            <!--[if (gte mso 9)|(IE)]>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                    <singleline>
                      <a href="#" mc:edit data-button data-text-style="Buttons" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>My Account</span></a>
                    </singleline>
                  <!--[if (gte mso 9)|(IE)]>
                  </td>
                  <td align="center" width="35"></td>
        ...
        <tr data-element="blue-order-number" data-label="Order number">
          <td height="20" style="font-size:20px;line-height:20px;" data-height="Spacing under order number">&nbsp;</td>
        </tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
              <tr data-element="blue-content-paragraph" data-label="Paragraphs">
                ...
                <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        Villa : <strong>{{ $details['villa_name'] }}</strong><br>
                        Date : {{ $details['check_in'] }} – {{ $details['check_out'] }}<br>
                        Guests : {{ $details['adult'] }} Adults, {{ $details['children'] }} Children
                      </div>
                    </singleline>
                </td>
              </tr>
...
<table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;" data-module="blue-invoice-product-1">
  ...
  <tr>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
      <tr data-element="blue-arrow-divider" data-label="Arrow">
        <td align="center">
          <img style="width:50px;border:0px;display: inline!important;" src="images/arrow.png" width="50" border="0" editable="true" data-icon data-image-edit data-url data-label="Arrow" data-image-width alt="arrow">
        </td>
      </tr>
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center" class="row container-padding" width="90.63%" style="width:90.63%;max-width:90.63%;">
          ...
          <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" align="center" class="row container-padding" width="90.63%" style="width:90.63%;max-width:90.63%;">
              <tr data-element="blue-content-titles" data-label="Titles">
                <td class="center-text" data-text-style="Titles" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        <strong>Price:</strong><br>
                        Rp. {{ number_format($details['villa_price'], 0, ',', '.') }}
                      </div>
                    </singleline>
                </td>
              </tr>
              ...
              <tr data-element="blue-content-paragraph" data-label="Paragraphs">
                <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        Lorem ipsum dolor sit amet, consec tetur adipisicing elit, sed do eiusmod tempor ut labore et dolore.
                      </div>
                    </singleline>
                </td>
              </tr>
        ...
        <td class="rwd-col" align="center" valign="top" width="31.03%" style="width:31.03%;max-width:31.03%;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" align="center" class="row container-padding" width="90.63%" style="width:90.63%;max-width:90.63%;">
              <tr data-element="blue-content-option-1" data-label="1st Option">
                <td class="center-text" data-text-style="Options" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        <strong>Qty:</strong> <br>x{{ $details['stay'] }}
                      </div>
                    </singleline>
                </td>
              </tr>
              <tr data-element="blue-content-option-1" data-label="1st Option">
                <td height="20" style="font-size:20px;line-height:20px;" data-height="Spacing under 1st option">&nbsp;</td>
              </tr>
              <tr data-element="blue-content-option-2" data-label="2nd Option">
                <td class="center-text" data-text-style="Options" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        <strong>Price:</strong> <br>Rp. {{ number_format($details['total_price'], 0, ',', '.') }}
                      </div>
                    </singleline>
                </td>
              </tr>
  ...
  <tr>
    <td align="center" data-bgcolor="BgColor" bgcolor="#FFFFFF">
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        ...
        <tr data-element="blue-subtotal" data-label="Subtotal">
          <td height="10" style="font-size:10px;line-height:10px;" data-height="Spacing under subtotal">&nbsp;</td>
        </tr>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="m-padding-top10" width="100%" style="width:100%;max-width:100%;">
              <tr data-element="blue-content-paragraph" data-label="Paragraphs">
                ...
                <td class="center-text" data-text-style="Paragraphs" align="left" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:18px;line-height:24px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                    <singleline>
                      <div mc:edit data-text-edit>
                        Rp. {{ number_format(($details['total_price'] * 10)/100, 0, ',', '.') }}
                      </div>
                    </singleline>
                </td>
              </tr>
        ...
        <tr data-element="blue-content-total" data-label="Total">
          <td align="center">
            ...
            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="center-float">
              <tr>
                <td align="center" data-border-radius-default="0,6,36" data-border-radius-custom="Order Number" data-bgcolor="Order Number" bgcolor="#F8F8F8" style="border-radius: 0px; border: 2px solid #EEEEEE;">
                  <!-- Container -->
                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td width="35" style="width: 35px;"></td>
                      <td align="center" height="54" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;height:54px;">
                          <singleline>
                            <div mc:edit data-text-edit>
                              TOTAL: Rp. {{ number_format($details['total_price']+(($details['total_price'] * 10)/100), 0, ',', '.') }}
                            </div>
                          </singleline>
                      </td>
                      <td width="35" style="width: 35px;"></td>
            ...
            <td class="rwd-col" align="center" valign="top" width="2%" height="20" style="width:2%;max-width:2%;height: 20px;"></td>
            <td class="rwd-col" align="center" valign="top" width="49%" style="width:49%;max-width:49%;">
            ...
            <!--[if (gte mso 9)|(IE)]>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                    <singleline>
                      <a href="#" mc:edit data-button data-text-style="Buttons" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>Show Order</span></a>
                    </singleline>
                  <!--[if (gte mso 9)|(IE)]>
                  </td>
                  <td align="center" width="35"></td>
