                ...
                <div class="col-lg-4 col-md-6">
                    <div class="">
                        ...
                        <nav class="list-unstyled">
                            <li class="list-space">
                                <a href="" class="list-menu">{{ __('user_page.Homes') }}</a>
                            </li>
                            <li class="list-space">
                                <a href="" class="list-menu">{{ __('user_page.Hotels') }}</a>
                            </li>
                            <li class="list-space">
                                <a href="" class="list-menu">{{ __('user_page.Food') }}</a>
                            </li>
                            <li class="list-space">
                                <a href="" class="list-menu">WoW</a>
                            </li>
                        </nav>
                    </div>
                </div>
