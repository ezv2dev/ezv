    ...
    <div class="row">
        ...
        <a href="{{ route('index') }}"><img style="width: 90px; margin-top: 15px;" src="{{ asset('assets/logo_black.png') }}" alt="oke"></a>
        </div>
            ...
            <div id="row_popup" class="row">
                <div class="col-12 text-center">
                    ...
                    <ul class="nav-link-container">
                           ...
                           <form action="{{ route('list') }}" method="POST" id="villa-form" class="nav-link-form-detail">
                               @csrf
                               @if (Route::is('list'))
                               <i id="villa-button" class="fa-solid fa-house nav-link-gap nav-link-style-detail nav-link-icon-style-detail"></i>
                               @else
                                <i id="villa-button" class="fa-solid fa-house nav-link-gap nav-link-style-detail nav-link-icon-style-detail"></i>
                               @endif
                           ...
                           <form action="{{ route('restaurant_list') }}" method="POST" id="restaurant-form" class="nav-link-form-detail">
                               @csrf
                               @if(Route::is('restaurant_list'))
                               <i id="restaurant-button" class="fa-solid fa-utensils nav-link-gap nav-link-style-detail nav-link-icon-style-detail"></i>
                               @else
                                <i id="restaurant-button" class="fa-solid fa-utensils nav-link-gap nav-link-style-detail nav-link-icon-style-detail"></i>
                               @endif
                               <?php
                           ...
                           <form action="{{ route('hotel_list') }}" method="POST" id="hotel-form" class="nav-link-form-detail">
                               @csrf

                               @if (Route::is('hotel_list'))
                               <i id="hotel-button" class="fa-solid fa-city nav-link-gap nav-link-style-detail nav-link-icon-style-detail"></i>
                               @else
                                <i id="hotel-button" class="fa-solid fa-city nav-link-gap nav-link-style-detail nav-link-icon-style-detail"></i>
                               @endif
                               <?php
                           ...
                           <form action="{{ route('activity_list') }}" method="POST" id="activity-form" class="nav-link-form-detail">
                               @csrf
                               @if(Route::is('activity_list'))
                               <i id="activity-button" style="font-size: 24px;" class="fa-solid fa-person-running nav-link-gap nav-link-style-detail nav-link-icon-style-detail"></i>
                               @else
                               <i id="activity-button" style="font-size: 24px;" class="fa-solid fa-person-running nav-link-gap nav-link-style-detail nav-link-icon-style-detail"></i>
                               @endif
                               </li>
                            ...
                            <div class="bar">
                                <div class="location">
                                    ...
                                    <input type="text" class="form-control input-transparant" value="" id="loc_sugest"
                                        name="location" style="width: 100% !important"
                                            ...
                                            <div class="guest-popup dropdown-menu">
                                                <div class="guests-input-row">
                                                    ...
                                                    <div class="col-6"
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="number" id="adult3" name="adult" value="1"
                                                ...
                                                <div class="guests-input-row">
                                                    ...
                                                    <div class="col-6"
                                                        ...
                                                        <div
                                                            style="width: 40px; text-align: center; color: grey; font-size: 13px; padding: 0px;">
                                                            <input type="number" id="child3" name="child" value="0"
                                                                style="text-align: center; border:none; width:40px;"
                                                                min="0" readonly>
                                                        </div>
                                                ...
                                                <div class="guests-input-row">
                                                    ...
                                                    <div class="col-6"
                                                        ...
                                                        <div
                                                            style="width: 40px; text-align: center; color: grey; font-size: 13px; padding: 0px;">
                                                            <input type="number" id="infant3" name="infant" value="0"
                                                                style="text-align: center; border:none; width:40px;"
                                                                min="0" readonly>
                                                        </div>
                                                ...
                                                <div class="guests-input-row">
                                                    ...
                                                    <div class="col-6"
                                                        ...
                                                        <div
                                                            style="width: 40px; text-align: center; color: grey; font-size: 13px; padding: 0px;">
                                                            <input type="number" id="pet3" name="pet" value="0"
                                                                style="text-align: center; border:none; width:40px;"
                                                                min="0" readonly>
                                                        </div>
        ...
        <div class="col-4 list-villa-user right-bar">
            ...
            Route::is('license'))
            <input type="button" style="top: 0px !important;" onclick="location.href='{{ route('register.partner') }}';" value="Become a Host" />
            @endif
