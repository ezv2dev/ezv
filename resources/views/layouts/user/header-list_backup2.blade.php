    ...
    <div class="row nav-row">
        ...
        @if ($condition_villa)
        <div class="col-4 search-box" class="padding-0">
            <div class="row">
                <div class="col-12 text-center">
                    <div id="searchbox" class="searchbox display-block" onclick="popUp();" style="cursor: pointer;">
                    ...
                    <div id="search_bar" class="display-none">
        ...
        <script>
            function popUp() {
                ...
                document.getElementById("search_bar").classList.add("display-block");
                document.getElementById("search_bar").classList.remove("display-none");
        ...
        <script>
            ...
            function whenScroll() {
                ...
                document.getElementById("search_bar").classList.remove("display-block");
                document.getElementById("search_bar").classList.add("display-none");
