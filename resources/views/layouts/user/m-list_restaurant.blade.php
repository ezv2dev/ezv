...
<head>
    ...
    <link rel="stylesheet" id="css-main" href="{{ asset('assets/css/m-list-restaurant.css') }}">
...
<body style="background-color: black;">
    ...
    <div id="page-container">
        <!-- Header -->
        <header>
            <div class="autohide2 header-fixed scroll-down">
                <div class="header-mobile">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="add-guest">
                                <ul class="nav">
                                    <li class="button-dropdown cat-gap">
                                        ...
                                        <a href="javascript:void(0)" class="dropdown-toggle" style="margin-left: 20px;">
                                            Add
                                        </a>
                                    ...
                                    <div class="numberofrooms-input-row">
                                            ...
                                            <div class="col-6 roomnumberoption-button-container">
                                                ...
                                                <div class="roomnumber-popup-display-container">
                                                    <input class="roomnumber-popup-display" type="number"
                                                        id="bedroom_number" name="bedroom" value="0" min="0" readonly>
                                                </div>
                                        ...
                                        <div class="roomnumber-input-row">
                                            ...
                                            <div class="col-6"
                                                ...
                                                <div class="roomnumber-popup-display-container">
                                                    <input class="roomnumber-popup-display" type="number"
                                                        id="bathroom_number" name="bathroom" value="0" min="0" readonly>
                                                </div>
                            ...
                            <form id="form" method="get" action="{{ route('amenities_filter') }}">
                                ...
                                <div class="cat action cat-gap">
                                    <label>
                                        ...
                                        @endphp
                                        <input type="checkbox" onchange="$('#form').submit();" name="filterAmenities[]"
                                            value="{{ $item->id_amenities }}" @if(in_array($item->id_amenities,
                                        $checked2)) checked
                                        @endif
                                        ><span class="cat-span">{{ $item->name }}</span>
                                    </label>
                                </div>
                                @endforeach
                                ...
                                <div class="cat action cat-gap">
                                    <label>
                                        ...
                                        @endphp
                                        <input type="checkbox" onchange="$('#form').submit();" name="filterSuitable[]"
                                            value="{{ $item2->id_suitable }}" @if(in_array($item2->id_suitable,
                                        $checked3)) checked
                                        @endif
                                        ><span class="cat-span">{{ $item2->name }}</span>
                                    </label>
                                </div>
                                @endforeach
                            </form>
                        ...
                        <li class="button-dropdown cat-margin-0 cat-gap">
                            ...
                            <div class="restauranttype-popup dropdown-menu">
                                <div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="checkdesign">{{ $type->name }}
                                                        <input type="checkbox" class="type-form-input" name="fType[]"
                                                            value="{{ $type->id_type }}" {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                @empty
                                    ...
                                    <div style="margin-top: 25px;">
                                        <button type="submit" class="btn btn-choose"
                                            style="border-radius:12px; width: 100%; padding: 10px;" onclick="restaurantFilter()">Filter</button>
                                    </div>
                                </div>
                            </div>
                        </li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="checkdesign">{{ $price->name }}
                                                        <input type="checkbox" class="price-form-input" name="fPrice[]"
                                                            value="{{ $price->id_price }}" {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                @empty
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="checkdesign">{{ $facility->name }}
                                                        <input type="checkbox" class="facilities-form-input"
                                                            name="fFacilities[]" value="{{ $facility->id_facilities }}"
                                                            {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="checkdesign">{{ $meal->name }}
                                                        <input type="checkbox" class="meal-form-input" name="fMeal[]"
                                                            value="{{ $meal->id_meal }}" {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                @empty
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="checkdesign">{{ $dietaryfood->name }}
                                                        <input type="checkbox" class="dietaryfood-form-input"
                                                            name="fDietaryfood[]"
                                                            value="{{ $dietaryfood->id_dietaryfood }}" {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                @empty
                                                ...
                                                <div class="col-6 mb-3">
                                                    <label class="checkdesign">{{ $goodfor->name }}
                                                        <input type="checkbox" class="goodfor-form-input"
                                                            name="fGoodfor[]" value="{{ $goodfor->id_goodfor }}"
                                                            {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 mb-3"
                                                    ...
                                                    <label class="checkdesign"
                                                        ...
                                                        <input type="checkbox" class="category-form-input"
                                                            name="fCategory[]" id="{{ $category->id_category  }}"
                                                            value="{{ $category->id_category  }}" {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                @empty
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-3" id="timeofday-form-input">
                                                    <label class="checkdesign">Morning
                                                        <input type="checkbox" class="timeofday-form-input"
                                                            name="fTimeofday[]" value="morning" {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 mb-3" id="timeofday-form-input">
                                                    <label class="checkdesign">Afternoon
                                                        <input type="checkbox" class="timeofday-form-input"
                                                            name="fTimeofday[]" value="afternoon" {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="col-6 mb-3" id="timeofday-form-input">
                                                    <label class="checkdesign">Evening
                                                        <input type="checkbox" class="timeofday-form-input"
                                                            name="fTimeofday[]" value="evening" {{ $isChecked }}>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                <input type="submit" onclick="activityFilter()"
            ...
            <div class="modal-content video-container">
                ...
                <div class="overlay-social">
                    <div class="row social-share">
                        ...
                        style="color: #f00;  font-size: 10px;"></i>
                    {{-- <span>CANCEL</span> --}}
                    </a>
                    </p>
                    @else
                    <p>
                        <a href="{{ route('restaurant_favorit', $restaurant[0]->id_restaurant) }}"><i class="fa fa-heart"
                                style="color: #aaa;  font-size: 10px;"></i>
    ...
    @include('user.modal.filter.restaurant_modal')
    <!-- END Footer -->
    </div>
    <!-- END Page Container -->
