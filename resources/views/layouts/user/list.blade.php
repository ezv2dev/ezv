...
<body id="bodyList" class="{{ $bgColor }}">
    ...
    <div id="page-container">
        <!-- Header -->
        <header>
            <div id="new-bar-black" class="page-header-fixed d-flex flex-column {{ $bgColor }}">
    ...
    <script>
        ...
        function filters_hotel_click() {
            var element = document.getElementById("filters_hotel");
            element.classList.toggle("filter-active");
            $('#modal-filters-hotel').modal('show');
        }
    </script>
