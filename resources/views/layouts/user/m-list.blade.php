...
<body>
        ...
        <header>
            <div class="autohide2 header-fixed">
                <div class="header-mobile">
                    <div class="row">
                        <div class="col-3">
                            <a class="text-white" type="button" href="{{ route('index') }}"><i class="fa fa-chevron-left"></i> EZV2</a>
                        </div>
                        <div class="col-7">
                            <div class="row header-search-block">
                                <div class="col-5 header-date">
                                    <input placeholder="{{ Translate::translate('Check In') }}" type="text" onfocus="(this.type = 'date')"  id="checkin">
                                </div>
                                <div class="col-5 header-date">
                                    <input placeholder="{{ Translate::translate('Check Out') }}" type="text" onfocus="(this.type = 'date')"  id="checkout">
                                </div>
                                <div class="col-2">
            ...
            <div class="row">
                <div id="myBtnContainer" class="menu col-12">
                    <ul>
                                    ...
                                    <div class="double-slider">
                                        <form action="{{ route('price') }}" method="GET">
                                            <div class="extra-controls form-inline">
                                                <div class="col-lg-12">
                                                    <p class="price-popup-title">{{ Translate::translate('Price') }}</p>
                                                </div>
                                ...
                                <div>
                                    <form action="{{ route('box_filter') }}" method="GET">
                                                    ...
                                                    <div class="col-6 mb-3">
                                                        <label class="checkdesign">{{ $item->name }}
                                                            <input type="checkbox" name="filterProperty[]"
                                                                ...
                                                                @if(in_array($item->id_property_type, $checked)) checked
                                                            @endif>
                                        ...
                                        <div style="margin-top: 25px;">
                                            ...
                                            style="border-radius:12px; width: 100%; padding: 10px;">Filter</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <li class="button-dropdown">
                            {{-- <a href="#" class="list-villa-nav-button">Number of rooms</a> --}}
                            <a href="javascript:void(0)" id="rooms" onclick="rooms_click()" class="dropdown-toggle">
                            {{ Translate::translate('Number of rooms') }}
                            </a>
                            ...
                            <div class="roomnumber-popup dropdown-menu">
                                <form action="{{ route('more_filter') }}" method="GET">
                                    <div class="numberofrooms-input-row">
                                        <div class="col-lg-12">
                                            <p class="roomnumber-input-row">{{ Translate::translate('Number of rooms') }}</p>
                                        </div>
                                        <div class="roomnumber-input-row">
                                            <div class="col-6 vertical-center">
                                                <div class="col-12 roomnumberoption-type-container">
                                                    <p class="roomnumberoption-type-title">{{ Translate::translate('Bedrooms') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-6 roomnumberoption-button-container">
                                                ...
                                                <div class="roomnumber-popup-display-container">
                                                    <input class="roomnumber-popup-display" type="number"
                                                        id="bedroom_number" name="bedroom" value="1" min="0" readonly>
                                                </div>
                                        ...
                                        <div class="roomnumber-input-row">
                                            <div class="col-6 vertical-center">
                                                <div class="col-12 roomnumberoption-type-container">
                                                    <p class="roomnumberoption-type-title">{{ Translate::translate('Bathrooms') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-6"
                                                ...
                                                <div class="roomnumber-popup-display-container">
                                                    <input class="roomnumber-popup-display" type="number"
                                                        id="bathroom_number" name="bathroom" value="1" min="0" readonly>
                                                </div>
                                        ...
                                        <div class="roomnumber-input-row">
                                            <div class="col-6 vertical-center">
                                                <div class="col-12 roomnumberoption-type-container">
                                                    <p class="roomnumberoption-type-title">{{ Translate::translate('Beds') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-6"
                                                style="display: flex; align-items: center; justify-content: end;">
                                                ...
                                                <div class="roomnumber-popup-display-container">
                                                    <input class="roomnumber-popup-display" type="number"
                                                        id="bed_number" name="beds" value="1" min="0" readonly>
                                                </div>
                                        ...
                                        <div class="col-12 dropdown-pd-0 text-small">
                                            <input type="submit" class="btn btn-choose roomnumber-popup-button-search"
                                                value="Search">
                                        </div>
                                </form>
                            </div>
                        ...
                        <li class="">
                            <a href="{{ route('filter', '5') }}" id="parking" onclick="parking_click()"
                                class="">{{ Translate::translate('Parking') }}</a>
                        </li>
                        <li class="">
                            <a href="{{ route('filter', '14') }}" id="kitchen" onclick="kitchen_click()"
                                class="">{{ Translate::translate('Kitchen') }}</a>
                        </li>
                        <li class="">
                            <a href="{{ route('filter', '12') }}" id="ocean" onclick="ocean_click()" class="">{{ Translate::translate('Ocean
                                View') }}</a>
                        </li>
                        <li class="">
                            <a href="{{ route('filter', '13') }}" id="breakfast" onclick="breakfast_click()"
                                class="">{{ Translate::translate('Breakfast') }}</a>
                        </li>
                        <li class="">
                            <a href="#" id="filters" onclick="filters_click()" class=""><i class="fa fa-sliders"
                                    aria-hidden="true"></i> {{ Translate::translate('Filters') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <!-- Modal -->
    {{--Modal Filter --}}
    @include('user.modal.filter.m-filter_modal')
    {{-- MODAL SHARE --}}
    ...
    <script src="{{ asset('assets/js/m-list-villa.js') }}"></script>
        ...
        (function (factory) {
            ...
            var IonRangeSlider = function (input, options, plugin_count) {
                ...
                if (val !== undefined && val !== "") {
                    val = val.split(config_from_data.input_values_separator || options
                        .input_values_separator ||
                        ";");
            ...
            IonRangeSlider.prototype = {
                ...
                bindEvents: function () {
                    ...
                    this.$cache.body.on("touchmove.irs_" + this.plugin_count, this.pointerMove.bind(
                        this));
                    this.$cache.body.on("mousemove.irs_" + this.plugin_count, this.pointerMove.bind(
                        this));

                    this.$cache.win.on("touchend.irs_" + this.plugin_count, this.pointerUp.bind(this));
                    this.$cache.win.on("mouseup.irs_" + this.plugin_count, this.pointerUp.bind(this));

                    this.$cache.line.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(
                        this,
                        "click"));
                    this.$cache.line.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(
                        this,
                        "click"));
                    ...
                    if (this.options.drag_interval && this.options.type === "double") {
                        this.$cache.bar.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(
                            this, "both"));
                        this.$cache.bar.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(
                            this,
                            "both"));
                    } else {
                        this.$cache.bar.on("touchstart.irs_" + this.plugin_count, this.pointerClick
                            .bind(
                                this, "click"));
                    ...
                    if (this.options.type === "single") {
                        this.$cache.single.on("touchstart.irs_" + this.plugin_count, this.pointerDown
                            .bind(
                                this, "single"));
                        this.$cache.s_single.on("touchstart.irs_" + this.plugin_count, this.pointerDown
                            .bind(this, "single"));
                        this.$cache.shad_single.on("touchstart.irs_" + this.plugin_count, this
                            .pointerClick
                            .bind(this, "click"));

                        this.$cache.single.on("mousedown.irs_" + this.plugin_count, this.pointerDown
                            .bind(
                                this, "single"));
                        this.$cache.s_single.on("mousedown.irs_" + this.plugin_count, this.pointerDown
                            .bind(
                                this, "single"));
                        this.$cache.edge.on("mousedown.irs_" + this.plugin_count, this.pointerClick
                            .bind(
                                this, "click"));
                        this.$cache.shad_single.on("mousedown.irs_" + this.plugin_count, this
                            .pointerClick
                            .bind(this, "click"));
                    } else {
                        this.$cache.single.on("touchstart.irs_" + this.plugin_count, this.pointerDown
                        ...
                        this.$cache.from.on("touchstart.irs_" + this.plugin_count, this.pointerDown
                            .bind(
                                this, "from"));
                        this.$cache.s_from.on("touchstart.irs_" + this.plugin_count, this.pointerDown
                            .bind(
                                this, "from"));
                        this.$cache.to.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(
                            this,
                            "to"));
                        this.$cache.s_to.on("touchstart.irs_" + this.plugin_count, this.pointerDown
                            .bind(
                                this, "to"));
                        this.$cache.shad_from.on("touchstart.irs_" + this.plugin_count, this
                            .pointerClick
                            .bind(this, "click"));
                        ...
                        this.$cache.from.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(
                            this, "from"));
                        this.$cache.s_from.on("mousedown.irs_" + this.plugin_count, this.pointerDown
                            .bind(
                                this, "from"));
                        this.$cache.to.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(
                            this,
                            "to"));
                        ...
                        this.$cache.shad_from.on("mousedown.irs_" + this.plugin_count, this.pointerClick
                            .bind(this, "click"));
                        this.$cache.shad_to.on("mousedown.irs_" + this.plugin_count, this.pointerClick
                            .bind(
                                this, "click"));
                    }
                    ...
                    if (is_old_ie) {
                        this.$cache.body.on("mouseup.irs_" + this.plugin_count, this.pointerUp.bind(
                            this));
                ...
                key: function (target, e) {
                    if (this.current_plugin !== this.plugin_count || e.altKey || e.ctrlKey || e
                        .shiftKey ||
                        e.metaKey) {
                        return;
                    }
                ...
                setMinMax: function () {
                    ...
                    if (this.options.values.length) {
                        ...
                        this.$cache.min.html(this.decorate(this._prettify(this.options.min), this
                            .options
                            .min));
                        this.$cache.max.html(this.decorate(this._prettify(this.options.max), this
                            .options
                            .max));
                    }
                ...
                calc: function (update) {
                    ...
                    switch (this.target) {
                        case "base":
                            ...
                            this.coords.p_from_real = this.checkDiapason(this.coords.p_from_real, this
                                .options.from_min, this.options.from_max);
                            this.coords.p_to_real = this.checkDiapason(this.coords.p_to_real, this
                                .options
                                .to_min, this.options.to_max);

                            this.coords.p_single_fake = this.convertToFakePercent(this.coords
                                .p_single_real);
                            this.coords.p_from_fake = this.convertToFakePercent(this.coords
                                .p_from_real);
                        ...
                        case "to":
                            ...
                            this.coords.p_to_real = this.checkDiapason(this.coords.p_to_real, this
                                .options
                                .to_min, this.options.to_max);
                            this.coords.p_to_real = this.checkMinInterval(this.coords.p_to_real, this
                                .coords
                                .p_from_real, "to");
                            this.coords.p_to_real = this.checkMaxInterval(this.coords.p_to_real, this
                                .coords
                                .p_from_real, "to");
                    ...
                    if (this.options.type === "single") {
                        ...
                        this.coords.p_bar_x = this.toFixed(this.coords.p_from_fake + (this.coords
                            .p_handle /
                            2));
                        this.coords.p_bar_w = this.toFixed(this.coords.p_to_fake - this.coords
                            .p_from_fake);
                ...
                calcPointerPercent: function () {
                    ...
                    this.coords.p_pointer = this.toFixed(this.coords.x_pointer / this.coords.w_rs *
                        100);
                },
                ...
                calcLabels: function () {
                    ...
                    if (this.options.type === "single") {
                        ...
                        this.labels.p_single_left = this.coords.p_single_fake + (this.coords.p_handle /
                                2) -
                            (this.labels.p_single_fake / 2);
                        this.labels.p_single_left = this.checkEdges(this.labels.p_single_left, this
                            .labels
                            .p_single_fake);
                ...
                drawLabels: function () {
                    ...
                    if (this.options.type === "single") {
                        ...
                        if (values_num) {
                            ...
                            if (this.options.decorate_both) {
                                text_single = this.decorate(this._prettify(this.result.from), this
                                    .result
                                    .from);
                                text_single += this.options.values_separator;
                                ...
                                text_single = this.decorate(this._prettify(this.result.from) + this
                                    .options
                                    .values_separator + this._prettify(this.result.to), this.result
                                    .to);
                            }
                            text_from = this.decorate(this._prettify(this.result.from), this.result
                                .from);
                        ...
                        if (this.labels.p_from_left + this.labels.p_from_fake >= this.labels
                            .p_to_left) {
                            this.$cache.from[0].style.visibility = "hidden";
                            this.$cache.to[0].style.visibility = "hidden";
                ...
                drawShadow: function () {
                    ...
                    if (o.type === "single") {
                        if (o.from_shadow && (is_from_min || is_from_max)) {
                            ...
                            from_max = this.convertToPercent(is_from_max ? o.from_max : o.max) -
                                from_min;
                ...
                validate: function () {
                    ...
                    if (typeof o.keyboard_step !== "number" || isNaN(o.keyboard_step) || !o
                        .keyboard_step ||
                        o.keyboard_step < 0) {
                        o.keyboard_step = 5;
                    }
                    ...
                    if (typeof o.min_interval !== "number" || isNaN(o.min_interval) || !o
                        .min_interval || o
                        .min_interval < 0) {
                        o.min_interval = 0;
                    }

                    if (typeof o.max_interval !== "number" || isNaN(o.max_interval) || !o
                        .max_interval || o
                        .max_interval < 0) {
                        o.max_interval = 0;
                    }
                ...
                appendGrid: function () {
                    ...
                    for (i = 0; i < big_num + 1; i++) {
                        ...
                        html += '<span class="irs-grid-text js-grid-text-' + i + '" style="left: ' +
                            big_w +
                            '%">' + result + '</span>';
                    }
                ...
                calcGridLabels: function () {
                    ...
                    for (i = 0; i < num; i++) {
                        ...
                        this.coords.big_p[i] = this.toFixed(this.coords.big_w[i] / this.coords.w_rs *
                            100);
