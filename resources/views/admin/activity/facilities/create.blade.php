            ...
            <form action="{{ route('admin_activity_facilities_store') }}" method="POST" id="frm_tambah"
                ...
                <div class="block-content font-size-sm">
                    <div class="form-group row mb-2">
                        <label class="col-sm-3 col-form-label" for="name">Name Facilities <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Enter a name of type facilities.." maxlength="50" required>
                        </div>
                    </div>
                </div>
