            ...
            @foreach($gallery as $item)
                <div class="col-md-6 col-lg-4 col-xl-3 animated fadeIn">
                    <div class="options-container fx-item-rotate-r">
                        <img class="img-fluid" style="width: 234px; height: 156px; object-fit: cover" src="{{ URL::asset('/foto/activity/'.strtolower($find[0]->name).'/'.$item->name)}}" alt="">
                        <div class="options-overlay bg-black-75">
                            <div class="options-overlay-content">
                                <a class="btn btn-sm btn-primary img-lightbox" href="{{ URL::asset('/foto/activity/'.strtolower($find[0]->name).'/'.$item->name)}}">
                                    <i class="fa fa-search-plus mr-1"></i> View
                                </a>
                                <a class="btn btn-sm btn-danger" href="{{ route('admin_activity_delete_gallery', $item->id_photo) }}">
    ...
    <div class="block-content block-content-sm block-content-full bg-body-light rounded-bottom">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form class="dropzone" action="{{ route('admin_activity_store_gallery') }}" id="frmTarget">
                @csrf 
                <input type="hidden" value="{{ $find[0]->id_activity }}" id="id_activity" name="id_activity">
                </form>
                <br>
            </div>
        </div>
    ...
    <div class="block-content block-content-sm block-content-full bg-body-light rounded-bottom">
        <div class="row">
            ...
            <div class="col-6 text-right">
                ...
                <a type="button" class="btn btn-alt-success" href="{{ route('admin_activity') }}">
...
Dropzone.options.frmTarget = {
    ...
    url: '/admin/activity/store_gallery',
    parallelUploads: 50,
    init: function () {
