        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2 text-center text-sm-left">
                ...
                <div class="mt-3 mt-sm-0 ml-sm-3">
                    <a type="button" class="btn btn-sm btn-alt-primary" href="{{ route('admin_villa_create_nearby', $data[0]->id_villa) }}">
        ...
        <table class="table table-hover table-vcenter" id="tabel" >
            <thead>
                <tr>
                    ...
                    <th class="d-none d-sm-table-cell text-center" style="width: 15S%;">DISTANCE</th>
...
<div class="block-content block-content-sm block-content-full bg-body-light rounded-bottom">
    <div class="row">
        ...
        <div class="col-6 text-right">
            ...
            <a type="button" class="btn btn-alt-success" href="{{ route('admin_villa_index_extraprice', $data[0]->id_villa) }}">
...
<script>
    ...
    var table = $('#tabel').dataTable({
        processing: true,
        serverSide: true,
        ajax:"/admin/villa/datatable_nearby/" + $("#id_villa").val(),      
        columns: [
            ...
            { data: 'distance', name: 'distance', class:'font-w600 font-size-sm' },
