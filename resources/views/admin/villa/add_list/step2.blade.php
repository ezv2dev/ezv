...
.file-upload {
    ...
    <form class="js-validation" action="{{ route('villa_add_step_two_store') }}" method="POST" id="basic-form" enctype="multipart/form-data">
    @csrf
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                ...
                <div style="padding-top:25%;">
                    <div class="form-group">
                        <label class="form-label" for="name" style="font-size: 20px;">Villa Name</label>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="original_name" style="font-size: 20px;">Villa Original Name</label>
                        <input class="form-control" style="border-radius:10px; height:100px; font-size:30px;" type="text" id="original_name" name="original_name" value="{{ $data[0]->original_name }}">
                    </div>
                </div>
