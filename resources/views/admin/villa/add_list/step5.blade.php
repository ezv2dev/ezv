...
<link rel="stylesheet" href="{{ asset('assets/js/plugins/select2/css/select2.min.css') }}">
    ...
    <form class="js-validation" action="{{ route('villa_add_step_five_store') }}" method="POST" id="basic-form" enctype="multipart/form-data">
    @csrf
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                ...
                <div style="padding-top:6%;">
                    ...
                    <div class="form-group">
                        <div class="row mb-3">
                            <div class="col-lg-4">
                                <label for="id_location" class="form-label" style="font-size: 20px;">Villa Address</label>
                            </div>
                            <div class="col-lg-8">
                ...
                <div style="position: fixed; bottom: 0; width: 100%;">
                    <div class="row">
                        <div class="col-lg-5" style="padding:auto auto;">
                            <a type="button" class="btn btn-outline-secondary" href="{{ route('villa_add_step_four') }}">
                                Back
                            </a>
