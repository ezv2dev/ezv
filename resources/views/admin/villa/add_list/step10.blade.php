        ...
        <div class="row">
            <div class="col-lg-6">
                <div id="background" class="bg-gd-sublime-op">
                    <h1 class="headingWh " style="color: #FFF; font-size: 40px; padding-top:30%; padding-right:15px; text-align:right;">Congratulations, your villa has been registered</h1>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div style="padding-top:32%;">
                    <div class="form-group">
                        <a type="button" class="btn btn-lg rounded-pill btn-outline-secondary" href="{{ route('admin_villa') }}">
                            <i class="fa fa-home"></i> List Villa
                        </a>
                    </div>
                </div>
