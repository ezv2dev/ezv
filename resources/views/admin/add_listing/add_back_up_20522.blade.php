            ...
            <div style="padding-left : 20px; padding-right:20px;">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-6 col-md-6">
                            <form action="{{ route('admin_hotel_store') }}" method="post" enctype="multipart/form-data" id="hotel-form" class="js-validation">
                                @csrf
                                <a id="btn_hotel" class="block block-rounded text-center bg-image" href="javascript:void(0)"
                                    style="background-color : #ff7400; border-radius:15px;">
                                    <div class="block-content block-content-full ratio ratio-16x9">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <div>
