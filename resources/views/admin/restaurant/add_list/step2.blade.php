...
.file-upload {
    ...
    <form class="js-validation" action="{{ route('restaurant_add_step_two_store') }}" method="POST" id="basic-form" enctype="multipart/form-data">
    @csrf
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                ...
                <div style="padding-top:25%;">
                    <div class="form-group">
                        <label class="form-label" for="name" style="font-size: 20px;">Restaurant Name</label>
