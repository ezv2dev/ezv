...
.file-upload {
    ...
    <form class="js-validation" action="{{ route('restaurant_add_step_three_store') }}" method="POST" id="basic-form" enctype="multipart/form-data">
    @csrf
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                ...
                <div style="padding-top:25%;">
                    <div class="form-group">
                        <label class="form-label" for="description" style="font-size: 20px;">Create your description</label>
                        <textarea class="form-control" id="description" name="description" rows="5">{{ $data[0]->description }}</textarea>
                    </div>
                </div>
                ...
                <div style="position: fixed; bottom: 0; width: 100%;">
                    <div class="row">
                        <div class="col-lg-5" style="padding:auto auto;">
                            <a type="button" class="btn btn-outline-secondary" href="{{ route('restaurant_add_step_two') }}">
                                Back
                            </a>
...
$("#basic-form").validate({
    ...
    messages:{
        "description":{
            required:"Please enter a restaurant description",
