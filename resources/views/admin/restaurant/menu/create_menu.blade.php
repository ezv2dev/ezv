...
<!-- Dynamic Table Full -->
<form action="{{ route('admin_restaurant_store_menu') }}" method="POST" id="basic-form" class="js-validation" enctype="multipart/form-data" >
@csrf
<input type="hidden" id="id_restaurant" name="id_restaurant" value="{{ $find[0]->id_restaurant }}">
            ...
            <div class="form-group row mb-2">
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <input type="number" min="1" class="form-control" id="price" name="price" placeholder="Enter a price from menu..">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group row">
