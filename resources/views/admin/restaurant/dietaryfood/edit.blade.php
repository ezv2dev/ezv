...
<div class="block block-rounded">
    <div class="block-content">
        <form action="{{ route('admin_restaurant_dietary_food_update', $find[0]->id_dietaryfood) }}" method="POST" id="frm_tambah" class="js-validation"  >
            @csrf
            @method('PUT')
            <div class="block-content font-size-sm">
                <div class="form-group row mb-2">
                    <label class="col-sm-3 col-form-label" for="name">Name Dietary Food <span class="text-danger">*</span></label>
                    <div class="col-sm-9">
