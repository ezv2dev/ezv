...
<div class="bg-body-light">
    ...
    <div id="div-to-refresh">
            ...
            <div class="row top-20">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <div class="row">
                        ...
                        <div class="short-description">Short description will be appear here ....</div>
                        <!-- End Villa Bed Type -->
                        <div class="address">
                            <i class="fa fa-map-pin color-green"></i> {{ $data->location_name }} - <span><a
                                    href="javascript.void(0)" data-bs-toggle="modal"
                                    data-bs-target="#modal-map-{{$data->id_villa}}">View Map</a></span>
                        </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12">
            <div class="col-sm-12 rates-block">
                ...
                <div style="padding-top:10px">
                    <a type="button" href="{{ route('villa', $data->id_villa) }}" class="btn btn-sm btn-choose"
    ...
    <!-- END AMENITIES -->
    <!-- MAP MODAL -->
    <div class="modal fade" id="modal-map-{{$data->id_villa}}" tabindex="-1" role="dialog"
        aria-labelledby="modal-default-fadein" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-map">
                ...
                <div class="modal-body pb-1" style="height: 500px">
                    <iframe src="https://maps.google.com/?q={{$data->latitude}},{{$data->longitude}}&output=embed"
...
<script>
    function view(id) {
        ...
        document.getElementById('button_prev').setAttribute('onclick','prev_villa('+prev+')');
        $.ajax({
            type: "GET",
