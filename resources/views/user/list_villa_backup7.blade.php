            ...
            <div class="modal-content video-container">
                ...
                @section('scripts')
                    ...
                    <script>
                        ...
                        $(window).on('load', () => {
                            ...
                            for (let i = 0; i < villaLocations.length; i++) {
                                addMarker(
                                    { lat: villaLocations[i][1], long: villaLocations[i][2] },
                                    {
                                        text: villaLocations[i][0],
                            ...
                            markers[4].setLabel({
                                text: villaLocations[4][0],
                                className: 'text-white fw-bold px-1 py-1 rounded-pill bg-black'
                            });
                            infowindow.setContent(villaLocations[4][0]);
                    ...
                    {{-- <script>
                        function view_maps(mapId) {
                            var villa;
                            var customContent = `<div class="card" style="width: 18rem;">
                                <img src="{{ URL::asset('/foto/default/no-image.jpeg') }}" class="card-img-top" height="50px">
                                <div class="card-body">
                            ...
                            if (villa != null && villaLocations.length > 0) {
                                ...
                                marker = new google.maps.Marker({
                                    ...
                                    label: {
                                        ...
                                        className: 'text-white fw-bold px-4 py-2 rounded-pill bg-black'
                                    },
                                    icon: {
                                        path: google.maps.SymbolPath.CIRCLE,
                                        scale: 0
                                ...
                                infowindow.setContent(customContentvilla[0]);
                                ...
                                for (i = 0; i < villaLocations.length; i++) {
                                    marker = new google.maps.Marker({
                                        ...
                                        label: {
                                            text: `lorem ipsum dolor`,
                                            className: 'text-black fw-bold px-4 py-2 rounded-pill bg-white'
                                        },
                                        icon: {
                                            path: google.maps.SymbolPath.CIRCLE,
                                            scale: 0
