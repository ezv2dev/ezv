...
<head>
    ...
    <title>EZV Confirm Booking</title>
                                ...
                                <div class="cc__front">
                                    <div class="cc__brand">
                                        <div class="cc__brand-logo">
                                            <center><img style="width:30%; padding-top:10px" src="{{ URL::asset('assets/payment_logo/'.$params["bank_code"].'-logo.svg') }}"></center>
                                        </div>
                                        <span class=""></span>
                                    </div>
                                    <div style="padding-top: 25px;">
                                        <center><b><span style="font-size: 25px;">{{ $createVA['account_number'] }}</span></b></center>
                                    </div>
                                    <center><div style="font-size: 20px"><b>{{ CurrencyConversion::exchangeWithUnit($params['expected_amount']) }}</b></div></center>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                       <p>
                                            ...
                                            8. Masukkan nomor Virtual Account Anda (<b>{{ $createVA['account_number'] }}</b>). <br>
