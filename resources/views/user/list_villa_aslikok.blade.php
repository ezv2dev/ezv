...
<div class="bg-body-black">
    ...
    <div id="div-to-refresh">
        <div class="col-lg-12 grid-container-43">
            <a href="https://www.google.com/" class="col-lg-6 grid-image-container" style="position: relative; max-width: 50%;">
                <img class="grid-image" style="display: block;" src="https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80">
                <div class="image-overlay">
                    <div class="col-lg-9" style="float: left;">
                        <p class="villa-list-name">Murphy’s Long Beach California</p>
                        <p class="villa-list-location">Villa | <i class="fa-solid fa-location-dot villa-list-location-icon"></i>Map | 5 minute to beach</p>
                        <p class="villa-list-promotion">Promotion</p>
                    </div>
                    <div class="col-lg-3" style="float: left; text-align: right;">
                        <div class="villa-list-video-container">
                            <img class="villa-list-video" src="https://images.unsplash.com/photo-1564703048291-bcf7f001d83d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=765&q=80">
                        </div>                  
                    </div>
                    <div class="col-lg-12 villa-list-desc-container">
                    <p class="col-lg-12 villa-list-title">$30 / night</p>
                    <p class="villa-list-title">2 Bedroom 2 Bath 3 Parking</p>
                    </div>
                </div>
            </a>

            <div class="col-lg-6 grid-image-container" style="position: relative; max-width: 50%;">
                <img class="grid-image" style="display: block;" src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80">
                <div class="image-overlay">
                    <div class="col-lg-9" style="float: left;">
                        <p class="villa-list-name">Danaya's villa</p>
                        <p class="villa-list-location">Villa | <i class="fa-solid fa-location-dot villa-list-location-icon"></i>Map | 5 minute to beach</p>
                        <p class="villa-list-promotion"></p>
                    </div>
                    <div class="col-lg-3" style="float: left; text-align: right;">
                        <div class="villa-list-video-container">
                            <img class="villa-list-video" src="https://images.unsplash.com/photo-1577842041275-2da5ff5d6c23?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80">
                        </div>
                    </div>
                    <div class="col-lg-12 villa-list-desc-container">
                    <p class="col-lg-12 villa-list-title">$30 / night</p>
                    <p class="villa-list-title">2 Guests 2 Bedroom 1 Bath 2 Parking</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 grid-image-container" style="position: relative; max-width: 50%;">
                ...
                <div class="image-overlay">
                    <div class="col-lg-9" style="float: left;">
                        <p class="villa-list-name">Villa Ozora Central Seminyak</p>
                        <p class="villa-list-title">2 Guests 2 Bedroom 1 Bath 2 Parking</p>
                        <p class="villa-list-promotion-1"></p>
                    </div>
                    <div class="col-lg-3" style="float: left; text-align: right;">
                        <div class="villa-list-video-container">
                            <img class="villa-list-video" src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80">
                        </div>
                    </div>
                    <div class="col-lg-12 villa-list-desc-container">
                    <p class="col-lg-12 villa-list-title">$30 / night</p>
            ...
            <div class="col-lg-6 grid-image-container" style="position: relative; max-width: 50%;">
                <img class="grid-image" style="display: block;" src="https://images.unsplash.com/photo-1577842041275-2da5ff5d6c23?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80">
                <div class="image-overlay">
                    <div class="col-lg-9" style="float: left;">
                        <p class="villa-list-name">Bali Cinta Villa</p>
                        <p class="villa-list-location">Villa | <i class="fa-solid fa-location-dot villa-list-location-icon"></i>Map | 5 minute to beach</p>
                        <p class="villa-list-promotion"></p>
                    </div>
                    <div class="col-lg-3" style="float: left; text-align: right;">
            ...
            <div class="col-lg-6 grid-image-container" style="position: relative; max-width: 50%;">
                <img class="grid-image" style="display: block;" src="https://images.unsplash.com/photo-1581974206967-93856b25aa13?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1454&q=80">
                <div class="image-overlay">
                    <div class="col-lg-9" style="float: left;">
                        <p class="villa-list-name">Happy home Los Angeles </p>
                        <p class="villa-list-title">2 Guests 2 Bedroom 1 Bath 2 Parking</p>
                        <p class="villa-list-promotion-1"></p>
                    </div>
                    <div class="col-lg-3" style="float: left; text-align: right;">
                        <div class="villa-list-video-container">
                            <img class="villa-list-video" src="https://images.unsplash.com/photo-1581974206967-93856b25aa13?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1454&q=80">
                        </div>
                    </div>
                    <div class="col-lg-12 villa-list-desc-container">
                    <p class="villa-list-location">Villa | <i class="fa-solid fa-location-dot villa-list-location-icon"></i>Map | 5 minute to beach</p>
                    <p class="villa-list-title">$45 / night</p>
                    </div>
                </div>
            </div>

            <div class="col-lg-6 grid-image-container" style="position: relative; max-width: 50%;">
                <img class="grid-image" style="display: block;" src="https://images.unsplash.com/photo-1593714604578-d9e41b00c6c6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80">
                <div class="image-overlay">
                    <div class="col-lg-9" style="float: left;">
                        <p class="villa-list-name">The Star Kuta</p>
                        <p class="villa-list-location">Villa | <i class="fa-solid fa-location-dot villa-list-location-icon"></i>Map | 5 minute to beach | $54 / night</p>
                        <p class="villa-list-title">Promotion</p>
                    </div>
                    <div class="col-lg-3" style="float: left; text-align: right;">
                        <div class="villa-list-video-container">
                            <img class="villa-list-video" src="https://images.unsplash.com/photo-1593714604578-d9e41b00c6c6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80">
                        </div>
                    </div>
                    <div class="col-lg-12 villa-list-desc-container">
                    <p class="villa-list-title">2 Guests 2 Bedroom 1 Bath 2 Parking</p>
            ...
            <div class="col-lg-6 grid-image-container" style="position: relative; max-width: 50%;">
                <img class="grid-image" style="display: block;" src="https://images.unsplash.com/photo-1564703048291-bcf7f001d83d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=765&q=80">
                <div class="image-overlay">
                    <div class="col-lg-9" style="float: left;">
                        <p class="villa-list-name">Deva Bali Apartment</p>
                        <p class="villa-list-location">Villa | <i class="fa-solid fa-location-dot villa-list-location-icon"></i>Map | 5 minute to beach</p>
                        <p class="villa-list-promotion"></p>
                    </div>
                    <div class="col-lg-3" style="float: left; text-align: right;">
                    ...
                    <div class="col-lg-12 villa-list-desc-container">
                    <p class="villa-list-title">2 Guests 2 Bedroom 1 Bath 2 Parking</p>
                    <p class="villa-list-title">$30 / night</p>
                    </div>
                </div>
            </div>

            <div class="col-lg-6 grid-image-container" style="position: relative; max-width: 50%;">
                <img class="grid-image" style="display: block;" src="https://images.unsplash.com/photo-1607250844650-eae520552a4c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80">
                <div class="image-overlay">
                    <div class="col-lg-9" style="float: left;">
                        <p class="villa-list-name">Villa Jingga</p>
                        <p class="villa-list-location">Villa | <i class="fa-solid fa-location-dot villa-list-location-icon"></i>Map | 5 minute to beach</p>
                        <p class="villa-list-promotion"></p>
                    </div>
                    <div class="col-lg-3" style="float: left; text-align: right;">
                        <div href="facebook.com" class="villa-list-video-container">
                            <img class="villa-list-video" src="https://images.unsplash.com/photo-1607250844650-eae520552a4c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80">
                        </div>
                    </div>
                    <div class="col-lg-12 villa-list-desc-container">
                    <p class="villa-list-title">$45 / night</p>
