...
<body>
    ...
    <div id="page-container" class="page-container">
            ...
            <div class="page-header-fixed d-flex flex-column">
                <div class="row">
                    ...
                    <div class="col-1" style="margin-top: 10px;">
                        <i class="fa fa-bars" aria-hidden="true" onMouseOver="this.style.color='#ff7400'"
                            onMouseOut="this.style.color='#000'" onclick="view_bars()" style="cursor: pointer;"></i>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="container-profile"
            style="padding-top: 150px; box-sizing: border-box; margin-top: -30px; margin-bottom: 20px;">
            <div class="col-lg-4 col-6 float-left">
                @if (Auth::user()->avatar)
                    <img src="{{ Auth::user()->avatar }}" class="margin-auto" alt=""
                        style="width: 34%; border-radius: 50%;">
                @else
            ...
            <div class="col-lg-3 col-6 float-left" id="reward-program1">

                <div onclick="showhotels()">
                    <img src="https://cdn-icons-png.flaticon.com/512/1426/1426708.png"
                        style="height:40px; width: 40px; margin-left: auto; margin-right: auto; cursor: pointer;">
                    <p style="text-align: center; font-size: 11px; cursor: pointer;">Reward Program</p>
                </div>

            </div>

            <div class="col-lg-5 col-12 float-left">
                <h1 class=" margin-bottom profile-user-name-text">{{ Auth::user()->first_name }}
                    {{ Auth::user()->last_name }}</h1>

                <p class="profile-user-desc margin-bottom"><b>Address</b>
                ...
                <p class="profile-user-desc margin-bottom"><b>Email</b>
                    {{ Auth::user()->email }}</p>

                <p class="profile-user-desc margin-bottom"><b>Phone</b>
                ...
                <p class="profile-user-desc margin-bottom" style="color: #FF7400"><b>User ID</b>
                    {{ Auth::user()->user_code }}</p>

                <a class="margin-bottom"
                    style="border-radius: 5px; color: white; font-size: 12px; padding: 9px; box-sizing: border-box; margin-top: 9px; background-color: #FF7400;"
                    onclick="edit_profile()" style="max-width: 40%; font-size: 12px;" type="button">Edit Profile</a>

            </div>
            <div id="reward-program2" class="col-lg-3 col-6 float-left">
        ...
        <div id="navbar" class="menubar">
            <div class="container">
                <div class="col-3" style="text-align: center; " onclick="showhomes()">
                    <i class="fa-solid fa-house" style="font-size:40px; cursor: pointer;"></i>
                    <p style="cursor: pointer;">Villas</p>
                </div>
                <div class="col-3" style="text-align: center; " onclick="showhotels()">
                    <i class="fa fa-hotel" style="font-size:40px; cursor: pointer;"></i>
                    <p style="cursor: pointer;">Hotel</p>
                </div>
                <div class="col-3" style="text-align: center; " onclick="showrestaurants()">
                    <i class="fa-solid fa-utensils" style="font-size:40px; cursor: pointer;"></i>
                    <p style="cursor: pointer;">Restaurants</p>
                </div>
                <div class="col-3" style="text-align: center; " onclick="showactivities()">
                    <i class="fa-solid fa-person-hiking" style="font-size:40px; cursor: pointer;"></i>
                    <p style="cursor: pointer;">Activities</p>
                </div>
            </div>
        </div>
        ...
        <div id="hotels" onclick="showhotels()">
            @foreach ($location as $data)
                <div class="container" style="padding-left: 58px; box-sizing: border-box;">
                    ...
                    <div id="cards-container">
                        <div class="cards">
                            @foreach ($villa as $item)
                                @if ($item->id_location == $data->id_location)
                                    <div class="card col-lg-3" style="border-radius: 5px;">
                                        <a href="{{ route('villa', $item->id_villa) }}" target="_blank">
                                            <img src="{{ URL::asset('/foto/gallery/' . strtolower($item->name) . '/' . $item->image) }}"
                                                alt="Villas"
                                                style="width:100%; aspect-ratio: 3/4; object-fit: cover; border-radius: 5px">
                                        </a>
                                        <center>
                                            ...
                                            <h5 style="margin-top: -20px;">
                                                <p style="color: #515151; font-size: 15px;">Bedroom
                                                    {{ $item->bedroom }}</p>
                                                <p style="color: #515151; margin-top: -30px; font-size: 15px;">Bathroom
                                                    {{ $item->bathroom }}</p>
                                                <p style="color: #515151; margin-top: -30px; font-size: 15px;">Beds
                                                    {{ $item->beds }}</p>
                                                <p style="color: #FF7400; margin-top: -30px;"><b>IDR
                                                        {{ number_format($item->price, 0, ',', '.') }}</b></p>
                                            </h5>
                                        </center>
                                    </div>
                                @endif
        ...
        @include('user.modal.user.profile_edit')
