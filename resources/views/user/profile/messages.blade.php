...
<body>
    <div id="page-container" class="page-container">
            ...
            <div class="page-header-fixed d-flex flex-column">
                <div class="row">
                    ...
                    <div class="col-1" style="margin-top: 10px;">
                        <i class="fa fa-bars" aria-hidden="true"  onclick="view_bars()"></i>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="container-profile" style="padding-top: 150px; box-sizing: border-box; margin-top: -30px; margin-bottom: 20px;">
            <div class="col-lg-4 col-6 float-left">
                @if (Auth::user()->avatar)
                <img src="{{Auth::user()->avatar}}" class="margin-auto" alt="" style="width: 34%; border-radius: 50%;">
                @else
            ...
            <div class="col-lg-3 col-6 float-left" id="reward-program1">
                ...
                <div onclick="showhotels()">
                    ...
                    <p style="text-align: center; font-size: 11px;">Reward Program</p>
                </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body pb-1">
                                            ...
                                            @if (!$conversation->is_reply)
                                                <h3>reply</h3>
                                                <p>this message has not been replied</p>
                                            @else
                                                <h3>reply</h3>
                                                <p>this message already replied</p>
                                                <p>message: {{ $conversation->conversationReply->message }}</p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
