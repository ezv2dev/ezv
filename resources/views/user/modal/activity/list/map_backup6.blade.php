...
<script>
    ...
    function addCustomContentRestaurant(restaurantLocations) {
        ...
        <div class="card col-12">
                                ...
                                <div class="d-flex mt-1" style="height: 140px; width: 100%; border-radius: 12px; overflow: hidden;">
        ...
        <div class="card col-12">
                                ...
                                <div class="mt-3">
                                    <a href="{{ env('APP_URL') }}/villa/${villaLocations.id_villa}" target="_blank">
                                        ...
                                        <p class="card-text text-orange text-17 fw-500 mt-1">${price}/Night</p>
                                    </a>
                                </div>
                                ...
                                <div class="d-flex mt-3 align-items-center">
                                    ...
                                    <div class="d-flex justify-content-end col-6">
                                        ...
                                        <div class="me-2"></div>
                                        <button class="button-next" id="modal-map-right-next" disabled="true" onclick="next_marker('villa', ${villaLocations.id_villa})"><i class="fa-solid fa-chevron-right"></i></button>
                                    </div>
                                </div>
                            </div>`;
                    ...
                    viewedMarkerVilla.forEach(id_villa => {
                        for (let j = 0; j < villaLocations.length; j++) {
                            if(villaLocations[j].id_villa && villaLocations[j].id_villa == id_villa) {
                                markerVilla[j].setIcon({
                                    url:`{{ asset('assets/icon/map/villa_clicked.png') }}`,
                                    scaledSize : new google.maps.Size(30, 30)
                                });
                            } else {
                                // console.log('error on markedViewedMarker');
    ...
    async function view_maps(id) {
        ...
        fetch(`/map/by-coordinate-area/activity/${id}`)
            ...
            .then(async (data)=>{
                ...
                resetPrimaryMarker();
                // set primary marker
                setPrimaryMarker(data, 'activity');
                ...
                setTimeout(async () => {
                    ...
                    // add viewed marker
                    addViewedMarkerNew(data.id_activity, 'activity');
                    // marked viewed marker
                    markedViewedMarkerNew();
                    // enable event google map
                    setMapEvent();
        ...
        <div class="modal-content modal-content-map modal-map" style="height:auto !important;">
                ...
                <div class="row" style="width:100%;">
                    ...
                    <div class="col-4">
                        <div class="d-flex justify-content-center">
                            ...
                            <a class="mx-2 icon-filter-map" id="map-filter-activity" data-indicator="true" onclick="filter_map('activity')">
                                <img
            ...
            <div class="modal-body modal-body-map">
                <div class="col-12 d-flex justify-content-center">
                    <div class="col-4" style="border: 2px solid #ff7400; padding: 9px; border-radius: 12px; margin-bottom: 1.5rem;">
                        Search here ...
                    </div>
                </div>
