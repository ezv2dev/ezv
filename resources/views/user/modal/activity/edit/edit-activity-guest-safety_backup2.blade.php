    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-content3" style="border-radius:15px; background: #fff;">
            <div class="modal-header modal-header3 filter-modal d-flex justify-content-between">
                <h3>{{ Translate::translate('Health & Safety') }}</h3>
            ...
            <div class="modal-body modal-body3">
                <div class="tabbable column-wrapper">
                    <form method="POST" action="{{ route('activity_update_guest_safety') }}">
                        ...
                        <div class="container">
                            <h5>{{ Translate::translate('Safety Considerations') }}</h5>
                            <hr style="margin-top: -10px;">

                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Pool/hot tub without a gate or lock') }}</p>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Nearby lake, river, other body of water') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Climbing or play structure') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Heights without rails or protection') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Potentially dangerous animal') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                        ...
                        <div class="container">
                            <h5 style="margin-top: 40px;">{{ Translate::translate('Safety Devices') }}</h5>
                            <hr style="margin-top: -10px;">

                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Security cameras/audio recording devices') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Carbon monoxide alarm') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Smoke alarm') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                        ...
                        <div class="container">
                            <h5 style="margin-top: 40px;">{{ Translate::translate('Property Info') }}</h5>
                            <hr style="margin-top: -10px;">

                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Must climb stairs') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate('Guests can expect to walk up and down stairs during their stay.') }}
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Potential for noise') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Pet(s) live on property') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('No parking on property') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate('This property does not have dedicated parking for guests.') }}
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Some spaces are shared') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Amenity limitations') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>{{ Translate::translate('Weapons on property') }}</p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        {{ Translate::translate("
            ...
            <div class="modal-filter-footer d-flex justify-content-between" style="padding-bottom: 80px;">
                <p style="color: red; font-size: 12px; margin-left: 20px; margin-top: 20px;">
                    <sup>*</sup>{{ Translate::translate('Please make sure you select all the list') }}
                </p>
                <button type="submit"
