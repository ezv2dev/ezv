...
<div id="modal-edit-activity-rules" class="modal fade bs-example-modal-lg">
    <div class="modal-dialog modal-lg" style="overflow-y: initial !important;">
        <div class="modal-content modal-content3" style="border-radius:15px; background-color: #fff;">
            <div class="modal-header modal-header3 filter-modal d-flex justify-content-between">
                <h3>{{ __('user_page.Place Rules') }}</h3>
            ...
            <div class="modal-body modal-body3">
                <div class="tabbable column-wrapper translate-text-group">
                    ...
                    <form method="POST" action="{{ route('activity_update_activity_rules') }}">
                        @csrf
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Suitable for children (2-12 years)</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">You can let guests know that your place isn't suitable for
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Suitable for infants (under 2 years)</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">You can let guests know that your place isn't suitable for infants if there are
                                            features
                                            that are dangerous for them. Guests will still be able to reach out for more
                                            details.</span>
                                    </p>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Pets allowed</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">You can limit guests from bringing pets, but you must reasonably accommodate
                                            guests
                                            that
                                            might bring an assistant animal.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Smoking allowed</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Events allowed</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
