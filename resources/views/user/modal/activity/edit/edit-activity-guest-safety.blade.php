...
<div id="modal-edit-activity-guest-safety" class="modal fade bs-example-modal-lg"
        ...
        <div class="modal-content modal-content3" style="border-radius:15px; background: #fff;">
            ...
            <div class="modal-body modal-body3">
                <div class="tabbable column-wrapper translate-text-group">
                    <form method="POST" action="{{ route('activity_update_guest_safety') }}">
                        @csrf
                        <input type="hidden" id="activity" name="id_activity" value="{{ $activity->id_activity }}">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Pool/hot tub without a gate or lock</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests will have direct access to an ungated / unlocked in-ground or
                                            above-ground
                                            swimming pool or hot tub.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Nearby lake, river, other body of water</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests will have direct, unrestricted access to any permanent natural or
                                            artificial
                                            body
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Climbing or play structure</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests (including children) will have access to structures or items intended for
                                            climbing or playing on. Ex: swing, slide, playset, climbing ropes.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Heights without rails or protection</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests will have access to an area or structure that reaches a height of more
                                            than
                                            1.4
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Potentially dangerous animal</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests (and their pets) will be around or near wild or domesticated animals that
                                            could
                        ...
                        <div class="container">
                            <h5 style="margin-top: 40px;">{{ __('user_page.Safety Devices') }}</h5>
                            <hr style="margin-top: -10px;">

                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Security cameras/audio recording devices</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">The property has a security camera or recording device capable of recording or
                                            ...
                                            private
                                            spaces like bedrooms, bathrooms, or sleeping areas.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Carbon monoxide alarm</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">The property has an alarm that detects and warns about the presence of carbon
                                            monoxide gas. Check your local laws for specific requirements.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Smoke alarm</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">The property has an alarm that detects and warns about the presence of smoke and
                                            fire. Check your local laws for specific requirements.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                        ...
                        <div class="container">
                            <h5 style="margin-top: 40px;">{{ __('user_page.Property Info') }}</h5>
                            <hr style="margin-top: -10px;">

                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Must climb stairs</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests can expect to walk up and down stairs during their stay.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Potential for noise</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests can expect to hear some noise during their stay. Ex: traffic,
                                            construction,
                                            nearby businesses.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Pet(s) live on property</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests may come across pets and experience a little animal love during their
                                            stay.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">No parking on property</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">This property does not have dedicated parking for guests.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Some spaces are shared</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests can expect to share spaces with other people during their stay. Ex:
                                            kitchen,
                                            bathroom, patio.</span>
                                    </p>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Amenity limitations</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests shouldn’t expect some essentials they may be used to having when
                                            traveling.
                                            Ex: wifi, running water, indoor shower.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>
                                        <span class="translate-text-group-items">Weapons on property</span>
                                    </p>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">Guests should be aware that there is at least one weapon stored on this
                                            property.
                                            EZV requires all weapons to be properly stored and secured.</span>
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
            ...
            <div class="modal-filter-footer d-flex justify-content-between" style="padding-bottom: 80px;">
                <p style="color: red; font-size: 12px; margin-left: 20px; margin-top: 20px;">
                    <sup>*</sup>{{ __('user_page.Please make sure you select all the list') }}
                </p>
                <button type="submit"
