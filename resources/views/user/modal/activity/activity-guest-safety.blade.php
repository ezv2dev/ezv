...
<div id="modal-activity_guest_safety" class="modal fade bs-example-modal-lg" style="font-family: 'Poppins' !important">
        ...
        <div class="modal-content modal-content3" style="border-radius:15px;">
            ...
            <div class="modal-body modal-body3">
                <div class="tabbable column-wrapper translate-text-group">
                    ...
                    @forelse ($activity->guestSafety as $item)
                        <p>
                            <i class="fas fa-{{ $item->icon }}"></i>
                            <span class="translate-text-group-items">{{ $item->guest_safety }}</span>
                        </p>
                        <p style="font-size: 12px; margin-top: -20px;">
                            <span class="translate-text-group-items">{{ $item->description }}</span>
                        </p>
                    @empty
