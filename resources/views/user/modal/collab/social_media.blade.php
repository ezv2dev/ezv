        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-1">
                <div class="row mb-12 margin-bottom-12px">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control modal-input" id="instagram_name" name="instagram_name"
                            placeholder="Instagram Name" value="">
                    </div>
                </div>
                <div class="row mb-12 margin-bottom-12px">
                ...
                <div class="row mb-12 margin-bottom-12px">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control modal-input" id="facebook_name" name="facebook_name"
                            placeholder="Facebook Name" value="">
                    </div>
                </div>
                <div class="row mb-12 margin-bottom-12px">
