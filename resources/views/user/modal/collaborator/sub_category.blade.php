    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="overflow-y: initial !important">
        <div class="modal-content" style="background: #fff;">
            <div class="modal-header filter-modal" style="padding-left: 2.2rem !important;">
                <div class="col-10">
                    <h5 class="mb-0">{{ Translate::translate('Sub Category') }}</h5>
                </div>
                                ...
                                <div class="col-6 checkdesign-gap">
                                    <label class="checkdesign checkdesign-modal-filter">
                                        ...
                                        @php
                                            ...
                                            if (in_array($item->id_collab_filter, $filterIds)) {
                                                $isChecked = 'checked';
                                            }
                                        @endphp

                                        <input type="checkbox" name="filter[]" value="{{ $item->id_collab_filter }}"
                                            onchange="collabFilter({{ request()->get('fCategory') ?? 'null' }})"
                                            {{ $isChecked }}>
