...
<style>
    ...
    .js-slider-border-none > .slick-list{
...
<script>
    ...
    function addCustomContentRestaurant(restaurantLocations) {
        ...
        var customContent = `
                            <div class="card" style="width: 17rem">
                                <div class="js-slider js-slider-test js-slider-border-none slick-nav-black slick-dotted-inner slick-dotted-white" data-dots="true"
                                data-arrows="true">
                                    ${image}
                                </div>
                                <div class="p-3">
                            ...
                            <div class="card col-12">
                                ...
                                <div class="mt-3">
                                    <a href="{{ env('APP_URL') }}/hotel/${hotelLocations.id_hotel}" target="_blank">
                                        <p class="card-text text-20 text-orange fw-600 mt-1">${hotelLocations.name}</p>
                                    </a>
                                </div>
                            </div>`;
        ...
        for (let i = 0; i < hotelLocations.length; i++) {
            ...
            google.maps.event.addListener(markerHotel[i], 'click', (function (marker, i) {
                return function () {
                    ...
                    // add viewed marker hotel
                    addViewedMarker(hotelLocations[i].id_hotel);

                    // marked viewed marker hotel
                    markedViewedMarker();
                    ...
                    primaryContent = addCustomContentHotel(hotelLocations[i]);
    ...
    // function to marked viewed marker hotel
    function markedViewedMarker() {
        if(viewedMarkers.length > 0 && hotelLocations.length > 0 && markerHotel.length > 0) {
            viewedMarkers.forEach(id_hotel => {
                for (let j = 0; j < markerHotel.length; j++) {
                    if(hotelLocations[j].id_hotel == id_hotel) {
