...
<script>
                ...
                <div
                    ...
                    <a style="position: absolute; z-index: 99; top: 10px; right: 10px; cursor: pointer;"
                        ...
                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                            ...
                            class="favorite-button favorite-button-28 unlikeButtonrestaurant${restaurantLocations.id_restaurant}">
                            <path
            ...
            favorite = `
                <div
                    ...
                    <a style="position: absolute; z-index: 99; top: 10px; right: 10px; cursor: pointer;"
                        ...
                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                            role="presentation" focusable="false"
                            class="favorite-button favorite-button-28 unlikeButtonvilla${villaLocations.id_villa}">
                            <path
                                d="m16 28c7-4.733 14-10 14-17 0-1.792-.683-3.583-2.05-4.95-1.367-1.366-3.158-2.05-4.95-2.05-1.791 0-3.583.684-4.949 2.05l-2.051 2.051-2.05-2.051c-1.367-1.366-3.158-2.05-4.95-2.05-1.791 0-3.583.684-4.949 2.05-1.367 1.367-2.051 3.158-2.051 4.95 0 7 7 12.267 14 17z">
                            </path>
                        </svg>
            ...
            favorite = `
                <div
                    ...
                    <a style="position: absolute; z-index: 99; top: 10px; right: 10px; cursor: pointer;"
                        ...
                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                            role="presentation" focusable="false"
                            class="favorite-button favorite-button-28 unlikeButtonhotel${hotelLocations.id_hotel}">
                            <path
                                d="m16 28c7-4.733 14-10 14-17 0-1.792-.683-3.583-2.05-4.95-1.367-1.366-3.158-2.05-4.95-2.05-1.791 0-3.583.684-4.949 2.05l-2.051 2.051-2.05-2.051c-1.367-1.366-3.158-2.05-4.95-2.05-1.791 0-3.583.684-4.949 2.05-1.367 1.367-2.051 3.158-2.051 4.95 0 7 7 12.267 14 17z">
                            </path>
                        </svg>
    ...
    function addCustomContentActivity(activityLocations) {
            ...
            favorite = `
                <div
                    ...
                    <a style="position: absolute; z-index: 99; top: 10px; right: 10px; cursor: pointer;"
                        ...
                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                            role="presentation" focusable="false"
                            class="favorite-button favorite-button-28 unlikeButtonactivity${activityLocations.id_activity}">
                            <path
                                d="m16 28c7-4.733 14-10 14-17 0-1.792-.683-3.583-2.05-4.95-1.367-1.366-3.158-2.05-4.95-2.05-1.791 0-3.583.684-4.949 2.05l-2.051 2.051-2.05-2.051c-1.367-1.366-3.158-2.05-4.95-2.05-1.791 0-3.583.684-4.949 2.05-1.367 1.367-2.051 3.158-2.051 4.95 0 7 7 12.267 14 17z">
                            </path>
                        </svg>
        ...
        var customContent = `
                            <div class="card col-12 d-flex justify-content-between">
                                <div>
                                    <div class="image-in-map-container">
                                        @guest
                                            <div
...
<script>
    ...
    function init_map(){
        ...
        markerIcon.setAttribute("src", "{{ asset('assets/icon/map/hotel_active.png') }}");
    ...
    async function view_maps(id) {
        ...
        // find hotel
        fetch(`/map/by-coordinate-area/hotel/${id}`)
            ...
            .then(async (data)=>{
                ...
                setTimeout(async () => {
                    ...
                    await refetchMarkers({
                        ...
                        additionalArrayType: 'hotel',
                        additionalArrayData: [data]
                    });
                    // add viewed marker
                    addViewedMarkerNew(data.id_hotel, 'hotel');
                    // marked viewed marker
                    markedViewedMarkerNew();
                    // enable event google map
                    setMapEvent();
...
<div class="modal fade modal-map-padding overflow-hidden" id="modal-map" tabindex="-1" role="dialog" aria-labelledby="modal-default-fadein"
    aria-hidden="true">
    <div class="modal-dialog modal-fullscreen-md-down modal-dialog-map modal-xl overflow-y-scroll" role="document" style="height:100vh;">
        <div class="modal-content modal-content-map modal-map">
            <div class="modal-header modal-header-map flex-column">
                <div class="row" style="width:100%;">
                    ...
                    <div class="col-6">
                        <div class="d-flex justify-content-center">
                            ...
                            <a class="icon-filter-map" id="map-filter-hotel" data-indicator="true" onclick="filter_map('hotel')">
                                <img
                                    src="{{asset('assets/icon/map/hotel_active.png')}}"
                ...
                <div class="row col-12 justify-content-center modal-search-container" id="searchMapDekstop">
