                    ...
                    <form method="POST" action="javascript:void(0);" id="guestSafetyFormHotel">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasPool = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasLake = App\Models\HotelHasGuestSafety::where([['id_hotel', '=', $hotel[0]->id_hotel], ['id_guest_safety', '=', '2']])->count();
                                @endphp
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasClimb = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasHeight = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasAnimal = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasCamera = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasMonoxide = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasAlarm = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasMust = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasPotential = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasCome = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasParking = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasShared = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasAmenity = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
                            ...
                            <div class="row">
                                ...
                                @php
                                    $hotelHasWeapon = App\Models\HotelHasGuestSafety::where('id_hotel', $hotel[0]->id_hotel)
