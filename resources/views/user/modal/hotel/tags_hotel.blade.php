...
<div class="modal fade" id="ModalTagsHotel" tabindex="-1" role="dialog" aria-labelledby="modal-default-fadein"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="height: 550px;">
            ...
            <div class="modal-body" style="height: 450px; overflow-y: scroll; border-radius: 0px;">
                <form action="{{ route('hotel_update_tags') }}" method="POST" id="basic-form" class="js-validation"
                    ...
                    <div class="form-group pt-2 px-4">
                        <div class="row">
                            ...
                            <div class="translate-text-group"
                                ...
                                @foreach ($hotelFilter as $data)
                                    <div class="col-4">
                                        <div class="row" style="font-size: 13px;">
                                            @php
                                                $isChecked = '';
                                                foreach ($hotelTags as $item) {
                                                    if ($data->id_hotel_filter == $item->id_hotel_filter) {
                                                        $isChecked = 'checked';
                                                    }
                                                }
                                            @endphp
                                            <label class="container-checkbox2">
                                                ...
                                                <input type="checkbox" value="{{ $data->id_hotel_filter }}"
                                                    id="{{ $data->id_hotel_filter }}" name="hotelFilter[]"
                                                    {{ $isChecked }}>
