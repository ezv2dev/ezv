            ...
            <div class="modal-body">
                <div class="tabbable column-wrapper">
                    ...
                    <ul class="nav filter-language-option-container nav-tabs sideTab column"
                        ...
                        <li><a class="filter-language-option-text" href="#currency" data-toggle="tab">Currency</a></li>
                    </ul>
                    <div class="tab-content column rigth" id="tabs">
                        <div class="tab-pane active" id="language">
                            <h3 class="modal-body-title">Choose a Language</h3>
                                        ...
                                        <div class="">
                                            <div class="roomnumberoption-container" style="display: flex;">
                                                <div class="roomnumber-filter-container">
                                                    <input type="radio" value="" id="{{ $item->locale }}" name="b" />
                        ...
                        <div class="tab-pane" id="currency">
                            <h3 class="modal-body-title">Choose a currency</h3>
                            @php
