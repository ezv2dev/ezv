            ...
            <div class="modal-body modal-body-language">
                <div class="tabbable column-wrapper">
                    ...
                    <ul class="nav filter-language-option-container nav-tabs sideTab column"
                        ...
                        <li class="active"><a class="tab1 filter-language-option-text" href="#language"
                                data-toggle="tab">{{ Translate::translate('Language') }}</a></li>
                        <li><a class="filter-language-option-text" href="#currency" data-toggle="tab">{{ Translate::translate('Currency') }}</a></li>
                    </ul>
                    <div class="tab-content tab-content-language column rigth" id="tabs">
                        <div class="tab-pane active" id="language">
                            <h3 class="modal-body-title">{{ Translate::translate('Choose a Language') }}</h3>
                            ...
                            <form action="{{ route('language_set') }}" method="post" id="translateForm">
                                ...
                                <button type="submit" form="translateForm" class="d-none">{{ Translate::translate('translate') }}</button>
                            </form>

                        </div>

                        <div class="tab-pane" id="currency">
                            <h3 class="modal-body-title">{{ Translate::translate('Choose a currency') }}</h3>
                            @php
                                ...
                                <div class="propertytype-input-row">
                                    <div class="col-12 propertytype-grid-container">
                                        ...
                                        <div class="">
                                            <div class="roomnumberoption-container" style="display: flex;">
                                                <div class="roomnumber-filter-container">
                                                    <input type="radio" value="" id="{{ $item->code }}" name="b" />
                                                    <label class="language-checkbox-alias"
                                                        for="{{ $item->code }}">
                                                        <div>
