...
<div class="modal fade" id="modal-quick-enquiry" tabindex="-1" role="dialog" aria-labelledby="modal-default-fadein"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content " style="background: white; border-radius:20px; height:100%; margin-top:0 !important;">
            ...
            <div id="totalprice" class="modal-body p-4" style="overflow-y: scroll; height: 500px;">
                <div class="row">
                    <div class="col-9">
                        <p class="price-box">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email"
                            value="{{ Auth::user()->email }}" placeholder="name@example.com" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group">
                        <label for="phome">Phone Number</label>
                        <input type="number" class="form-control" id="phome"
