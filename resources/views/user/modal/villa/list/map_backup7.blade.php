...
<script>
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary" id="modal-map-right-prev" disabled="true" onclick="prev_marker('restaurant', ${restaurantLocations.id_restaurant})">prev</button>
                                    <div class="me-2"></div>
                                    <button class="btn btn-primary" id="modal-map-right-next" disabled="true" onclick="next_marker('restaurant', ${restaurantLocations.id_restaurant})">next</button>
                                </div>
                            </div>`;
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div style="overflow: hidden; height: 200px;">
                                    <div id="location-map-content-right-image-loading" style="background-color: #e8e8e8; height: 200px; width: 100%; position: absolute; z-index: 99; display: flex; justify-content: center; align-items: center;">
                                        <img style="height: 12px;" src="https://c.tenor.com/NqKNFHSmbssAAAAi/discord-loading-dots-discord-loading.gif">
                                    </div>
                                ...
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary" id="modal-map-right-prev" disabled="true" onclick="prev_marker('villa', ${villaLocations.id_villa})">prev</button>
                                    <div class="me-2"></div>
                                    <button class="btn btn-primary" id="modal-map-right-next" disabled="true" onclick="next_marker('villa', ${villaLocations.id_villa})">next</button>
                                </div>
                            </div>`;
    ...
    function addCustomContentHotel(hotelLocations) {
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary" id="modal-map-right-prev" disabled="true" onclick="prev_marker('hotel', ${hotelLocations.id_hotel})">prev</button>
                                    <div class="me-2"></div>
                                    <button class="btn btn-primary" id="modal-map-right-next" disabled="true" onclick="next_marker('hotel', ${hotelLocations.id_hotel})">next</button>
                                </div>
                            </div>`;
    ...
    function addCustomContentActivity(activityLocations) {
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary" id="modal-map-right-prev" disabled="true" onclick="prev_marker('activity', ${activityLocations.id_activity})">prev</button>
                                    <div class="me-2"></div>
                                    <button class="btn btn-primary" id="modal-map-right-next" disabled="true" onclick="next_marker('activity', ${activityLocations.id_activity})">next</button>
                                </div>
                            </div>`;
    ...
    function addViewedMarkerNew(id, target_type) {
        ...
        if(target_type == 'restaurant') {
            if(viewedMarkerRestaurant.length) {
                var checkViewedMarkerIdExist = false;
        ...
        if(target_type == 'activity') {
            if(viewedMarkerActivity.length) {
                var checkViewedMarkerIdExist = false;
        ...
        fetch(`/map/by-coordinate-area/villa/${id}`)
            ...
            .then(async (data)=>{
                ...
                setTimeout(async () => {
                    ...
                    // add viewed marker
                    addViewedMarkerNew(data.id_villa, 'villa');
                    // enable event google map
                    setMapEvent();
                    // enable action google map
                    setMapAction();
        ...
        <div class="modal-content modal-content-map modal-map" style="height:auto !important;">
            <div class="modal-header modal-header-map">
                <div class="row" style="width:100%;">
                    <div class="col-4"><h5 class="modal-title">{{ __('user_page.Map') }}</h5></div>
                    <div class="col-4">
                        <div class="d-flex justify-content-center">
                            <a class="mx-2 icon-filter-map" id="map-filter-villa" data-indicator="true" onclick="filter_map('villa')">
                                <img
                                    src="{{asset('assets/icon/map/villa_active.png')}}"
                                    data-src-active="{{asset('assets/icon/map/villa_active.png')}}"
                                    data-src="{{asset('assets/icon/map/villa.png')}}"
                                    alt="villa-icon">
                            </a>
                            <a class="mx-2 icon-filter-map" id="map-filter-restaurant" data-indicator="false" onclick="filter_map('restaurant')">
                                <img
            ...
            <div class="modal-body modal-body-map">
                <div class="d-flex justify-content-between align-items-start">
                    ...
                    <div class="w-30" style="display: none; padding-left: 1.5rem;" id="modal-map-right">
