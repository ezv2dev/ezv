...
<div class="modal fade modal-map-padding overflow-hidden" id="modal-map" tabindex="-1" role="dialog" aria-labelledby="modal-default-fadein"
    aria-hidden="true">
    <div class="modal-dialog modal-fullscreen modal-xl overflow-y-scroll" role="document">
        <div class="modal-content modal-map">
            <div class="modal-header modal-header-map flex-column">
                <div class="row" style="width:100%;">
                    ...
                    <div class="col-6">
                        <div class="d-flex justify-content-center">
                            <a class="icon-filter-map" id="map-filter-villa" data-indicator="true" onclick="filter_map('villa')">
                                <img
                ...
                <div class="row col-12 justify-content-center" id="searchMapDekstop">
                    <div class="col-12 col-lg-3 close-modal modal-search" data-bs-dismiss="modal" aria-label="Close" onclick="popUp();">
                        Search here ...
                    </div>
                </div>
            </div>
