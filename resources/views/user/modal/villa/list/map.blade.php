...
<script>
            ...
            favorite = `
                <div
                    ...
                    <a style="position: absolute; z-index: 99; top: 10px; left: 10px; cursor: pointer;"
                        ...
                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                            role="presentation" focusable="false"
                            class="favorite-button-button favorite-button-28 likeButtonactivity${activityLocations.id_activity}">
                            <path
                                d="m16 28c7-4.733 14-10 14-17 0-1.792-.683-3.583-2.05-4.95-1.367-1.366-3.158-2.05-4.95-2.05-1.791 0-3.583.684-4.949 2.05l-2.051 2.051-2.05-2.051c-1.367-1.366-3.158-2.05-4.95-2.05-1.791 0-3.583.684-4.949 2.05-1.367 1.367-2.051 3.158-2.051 4.95 0 7 7 12.267 14 17z">
                            </path>
                        </svg>
    ...
    function showOnlyFilteredMarker() {
        ...
        // console.log('show',indicatorVilla,indicatorRestaurant,indicatorHotel, indicatorActivity)
        if(indicatorVilla) {
        ...
        <div class="modal-content modal-map">
                ...
                <div class="d-flex justify-content-between align-items-center" style="width:100%;">
                    ...
                    <div style="flex:2;">
                        <div class="d-flex justify-content-center">
                            ...
                            <a class="d-flex mx-2 flex-column align-items-center" id="map-filter-villa" data-indicator="true" onclick="filter_map('villa')">
                                <img
                                    class="icon-filter-map" src="{{asset('assets/icon/map/nav_villa_active.png')}}"
                            ...
                            <a class="d-flex mx-2 flex-column align-items-center" id="map-filter-hotel" data-indicator="false" onclick="filter_map('hotel')">
                                <img
                                    class="icon-filter-map" src="{{asset('assets/icon/map/nav_hotel.png')}}"
            ...
            <div class="modal-body modal-body-map">
                <div class="map-modal-container">
                    ...
                    <!-- style="height: 73vh; border-radius: 10px;" -->
