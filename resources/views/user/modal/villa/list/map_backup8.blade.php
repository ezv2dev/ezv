...
<script>
                            ...
                            <div class="card col-12">
                                ...
                                <div class="mt-3">
                                    <a href="{{ env('APP_URL') }}/restaurant/${restaurantLocations.id_restaurant}" target="_blank">
                                        ...
                                        <p style="min-height: 43px;" class="card-text text-grey-2 limit-text text-14 fw-500 text-align-justify mt-1">${short_description}</p>
                                    </a>
                                </div>

                                <div class="d-flex" style="height: 70px; width: 100%; border-radius: 10px; overflow: hidden; position: relative;">
    ...
    function addCustomContentVilla(villaLocations) {
        ...
        var customContent = `
                            <div class="card col-12">
                                <div style="position: absolute; z-index: 99; top: 10px; left: 10px; border-radius: 15px;">
                                    <a href="google.com" style="cursor: pointer;">
                                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                                            role="presentation" focusable="false" class="list-like-button"
                                            id="">
                                ...
                                <div style="margin-top: 3.2rem;" class="d-flex align-items-center">
                                    <div class="col-6">
    ...
    function addCustomContentHotel(hotelLocations) {
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex" style="height: 140px; width: 100%; border-radius: 12px; overflow: hidden;">
    ...
    function addCustomContentActivity(activityLocations) {
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex" style="height: 70px; width: 100%; border-radius: 12px; overflow: hidden;">
                                    <div style="position: absolute; height: 70px;" class="col-12 d-flex justify-content-center align-items-center">
                                        <p class="text-align-center mb-0">
                                            <a href="https://www.apple.com/id/app-store/" target="_blank" class="btn-donwload-mobile-app" id="btn-to-app-store">
                                                <img style="width:30%;" src="{{ URL::asset('assets/media/photos/desktop/app-store-badge.svg') }}">
        ...
        <div class="modal-content modal-content-map modal-map" style="height:auto !important;">
            <div class="modal-header modal-header-map flex-column">
                ...
                <div class="row col-12 d-flex justify-content-center">
                    <div class="col-3 close-modal" style="cursor: pointer; border: 2px solid #ff7400; padding: 9px; border-radius: 12px; margin-top: 0.9rem;" onclick="popUp();">
                        Search here ...
                    </div>
                </div>
            </div>
            <div class="modal-body modal-body-map">
                <div class="d-flex justify-content-between align-items-start">
                    <div class="col-12" style="height: 73vh; border-radius: 10px;" id="map12"></div>
