                ...
                <div class="tabbable column-wrapper">
                    <form method="POST" action="{{ route('villa_update_cancellation_policy') }}">
                        ...
                        <div class="container">
                            ...
                            <p class="text-muted" style="font-size: 10pt;">Choose the policy that will apply to stays under 28 nights.</p>
                            <hr style="margin-top: -10px;">

                            <div class="row">
                                <div class="col-8">
                                    <p>Flexible</p>
                                    <p class="font-12" style="margin-top: -25px;">Full refund 1 day prior to arrival</p>
                                </div>
                                <div class="col-4">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>Flexible or Non-refundable</p>
                                    <p class="font-12" style="margin-top: -25px;">In addition to Flexible, offer a non-refundable option—guests pay 10% less, but you keep your payout no matter when they cancel.
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>Moderate</p>
                                    <p class="font-12" style="margin-top: -25px;">Full refund 5 days prior to arrival
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>Moderate or Non-refundable</p>
                                    <p class="font-12" style="margin-top: -25px;">In addition to Moderate, offer a non-refundable option—guests pay 10% less, but you keep your payout no matter when they cancel.
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>Firm</p>
                                    <p class="font-12" style="margin-top: -25px;">Full refund for cancellations up to 30 days before check-in. If booked fewer than 30 days before check-in, full refund for cancellations made within 48 hours of booking and at least 14 days before check-in. After that, 50% refund up to 7 days before check-in. No refund after that.
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>Firm or Non-refundable</p>
                                    <p class="font-12" style="margin-top: -25px;">In addition to Firm, offer a non-refundable option—guests pay 10% less, but you keep your payout no matter when they cancel.
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>Strict</p>
                                    <p class="font-12" style="margin-top: -25px;">Full refund for cancellations made within 48 hours of booking, if the check-in date is at least 14 days away. 50% refund for cancellations made at least 7 days before check-in. No refunds for cancellations made within 7 days of check-in.
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p>Strict or Non-refundable</p>
                                    <p class="font-12" style="margin-top: -25px;">In addition to Strict, offer a non-refundable option—guests pay 10% less, but you keep your payout no matter when they cancel.
                                    </p>
                                </div>
                                <div class="col-4">
                                    <div class="d-flex justify-content-end">
