...
<div class="modal fade" id="ModalTagsVilla" tabindex="-1" role="dialog" aria-labelledby="modal-default-fadein"
    aria-hidden="true">
                ...
                <div class="form-group pt-2 px-4">
                    <div class="row">
                        ...
                        <div class="translate-text-group" style="display: flex; flex-wrap: wrap; margin-left: 15px;">
                            @foreach ($villaFilter as $data)
                                <div class="col-4">
                                    <div class="row" style="font-size: 13px;">
                                        @php
                                            $isChecked = '';
                                            foreach ($villaTags as $item) {
                                                if ($data->id_villa_filter == $item->id_villa_filter) {
                                                    $isChecked = 'checked';
                                                }
                                            }
                                        @endphp
                                        <label class="container-checkbox2">
                                            ...
                                            <input type="checkbox" value="{{ $data->id_villa_filter }}"
                                                id="{{ $data->id_villa_filter }}" name="villaFilter[]"
                                                {{ $isChecked }}>
            ...
            <div class="modal-filter-footer d-flex justify-content-center"
                ...
                <div class="col-4" style="text-align: center;">
                    <button type="submit" class="btn btn-primary btn-sm w-100"
                        onclick="editVillaTag({{ $villa[0]->id_villa }})">
