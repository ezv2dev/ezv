...
<script>
    ...
    function initViewMap(){
        ...
        // inject html into map for full screen button
        var fullScreen = document.createElement("div");
        fullScreen.setAttribute("style",
            "background: white; width: 40px; height: 40px; margin: 10px; padding: 4px; box-shadow: rgb(0 0 0 / 30%) 0px 1px 4px -1px;"
        );
        var icon = document.createElement("i");
        icon.setAttribute("class", "fa-solid fa-expand d-flex justify-content-center align-items-center");
        icon.setAttribute("style", "font-size:30px; color: #ff7400;");
        fullScreen.appendChild(icon);
        map.controls[google.maps.ControlPosition.LEFT_BOTTOM].push(fullScreen);
        ...
        for (let i = 0; i < restaurantLocations.length; i++) {
            if (restaurantLocations[i].id_restaurant == restaurantLocations[i].id_restaurant) {
                markers[i].setIcon({
