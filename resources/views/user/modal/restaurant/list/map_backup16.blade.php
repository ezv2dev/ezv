...
<script>
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary" id="modal-map-right-prev" onclick="prev_marker('restaurant', ${restaurantLocations.id_restaurant})">prev</button>
                                    <div class="me-2"></div>
                                    <button class="btn btn-primary" id="modal-map-right-next" onclick="next_marker('restaurant', ${restaurantLocations.id_restaurant})">next</button>
                                </div>
                            </div>`;
    ...
    function addCustomContentVilla(villaLocations) {
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary" id="modal-map-right-prev" onclick="prev_marker('villa', ${villaLocations.id_villa})">prev</button>
                                    <div class="me-2"></div>
                                    <button class="btn btn-primary" id="modal-map-right-next" onclick="next_marker('villa', ${villaLocations.id_villa})">next</button>
                                </div>
                            </div>`;
    ...
    function addCustomContentHotel(hotelLocations) {
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary" id="modal-map-right-prev" onclick="prev_marker('hotel', ${hotelLocations.id_hotel})">prev</button>
                                    <div class="me-2"></div>
                                    <button class="btn btn-primary" id="modal-map-right-next" onclick="next_marker('hotel', ${hotelLocations.id_hotel})">next</button>
                                </div>
                            </div>`;
    ...
    function addCustomContentActivity(activityLocations) {
        ...
        var customContent = `
                            <div class="card col-12">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-primary" id="modal-map-right-prev" onclick="prev_marker('activity', ${activityLocations.id_activity})">prev</button>
                                    <div class="me-2"></div>
                                    <button class="btn btn-primary" id="modal-map-right-next" onclick="next_marker('activity', ${activityLocations.id_activity})">next</button>
                                </div>
                            </div>`;
    ...
    function setSecondaryMarker(data, markerType) {
        ...
        if(markerIcon != null && secondaryContent != null) {
            ...
            $('#modal-map-right-content').html('');
            $('#modal-map-right-content').append(secondaryContent);
        } else {
