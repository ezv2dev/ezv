...
<div id="modal-edit-restaurant-guest-safety" class="modal fade bs-example-modal-lg"
        ...
        <div class="modal-content modal-content3" style="border-radius:15px; background: #fff;">
            ...
            <div class="modal-body modal-body3">
                <div class="tabbable column-wrapper translate-text-group">
                    <form method="POST" action="{{ route('restaurant_update_guest_safety') }}">
                        @csrf
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Pool/hot tub without a gate or lock</span>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Nearby lake, river, other body of water</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Climbing or play structure</span>
                                    <p class="font-12" style="margin-top: -25px;">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Heights without rails or protection</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Potentially dangerous animal</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Security cameras/audio recording devices</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Carbon monoxide alarm</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Smoke alarm</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Must climb stairs</span>
                                    <p class="font-12" style="margin-top: -25px;">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Potential for noise</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Pet(s) live on property</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">No parking on property</span>
                                    <p class="font-12" style="margin-top: -25px;">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Some spaces are shared</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Amenity limitations</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <p><span class="translate-text-group-items">Weapons on property</span>
                                    <p class="font-12" style="margin-top: -25px;">
                                        <span class="translate-text-group-items">
