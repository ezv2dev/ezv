...
<div id="modal-restaurant_guest_safety" class="modal fade bs-example-modal-lg" style="font-family: 'Poppins' !important">
                ...
                <div class="tabbable column-wrapper translate-text-group">
                    ...
                    <div class="tab-content column rigth" id="tabs">
                        <div class="tab-pane active" id="currency">
                            <h5>{{ __('user_page.Health & Safety') }}</h5>
                        </div>
                    </div>
                    @forelse ($restaurant->guestSafety as $item)
                        <p>
