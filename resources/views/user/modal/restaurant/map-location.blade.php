                                ...
                                <div class="map-desc-mobile col-lg-12">
                                    ...
                                    <div class="">
                                        <a href="${contentLink}" target="_blank">
                                            ...
                                            <p class="card-text text-grey-1 mt-1 text-13 text-xs-11"><i class="fa-solid text-orange fa-location-dot"></i> <span class="text-grey-1"><span class="text-grey-1" id="travelDistance"></span> from this restaurant</span></p>
                                        </a>
                                    </div>
        ...
        var customContent = `
                            <div class="col-12 flex-row flex-lg-column mobile-map-desc-container" style="position: relative;">
                                ...
                                <div class="map-desc-mobile col-lg-12">
                                    ...
                                    <div class="">
                                        <a href="${contentLink}" target="_blank">
                                            <p class="card-text max-lines text-13 text-xs-11 text-grey-1 fw-500 mt-1">${villaLocations.adult ?? 0} Guest • ${villaLocations.bedroom ?? 0} Bedroom • ${villaLocations.bathroom ?? 0} Bath • ${villaLocations.parking ?? 0} Parking • ${villaLocations.size ?? 0}m² living</p>
                                            ...
                                            <p class="card-text d-none d-sm-block text-grey-1 mt-1 text-13 text-xs-11"><i class="fa-solid text-orange fa-location-dot"></i> <span class="text-grey-1"><span class="text-grey-1" id="travelDistance"></span> from this restaurant</span></p>
                                        </a>
                                    </div>
                                    <div class="col-12 d-flex">
                                        <div class="col-6">
                                            <p class="text-grey-1 mb-0 mt-1 text-13 text-xs-11"><i class="fa-solid text-orange fa-car"></i> <span class="text-grey-1" id="travelTimecar"></span> | <i class="fa-solid text-orange fa-person-walking"></i> <span class="text-grey-1" id="travelTime"></span></p>
                                        </div>
         ...
         map.addListener("click", ()=>{
            ...
            if(!contentIsExist && !mapMobileIsOpen) {
                ...
                setTimeout(async () => {
                    ...
                    document.getElementById("mobile-map-close").classList.remove('d-none');
                    document.getElementById("mobile-map-close").classList.add('d-block');
                    // refetch target restaurant
                    await view_maps('{{ $restaurant->id_restaurant }}');
                }, 200);
...
<script>
    ...
    function init_map(){
        ...
        reCenter.addEventListener('click', ()=>{
            view_maps('{{ $restaurant->id_restaurant }}');
        });
