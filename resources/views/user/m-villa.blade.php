...
<body style="background-color:white">
            ...
            {{-- ALERT CONTENT STATUS --}}
                @auth
                    ...
                    @if (in_array(auth()->user()->role->name, ['admin', 'superadmin']))
                        ...
                        @if ($villa[0]->status == '1')
                            <div class="alert alert-success d-flex flex-row align-items-center" role="success">
                            {{ Translate::translate('this content is active') }}
                            </div>
                        @endif
                        @if ($villa[0]->status == '2')
                            <div class="alert alert-warning d-flex flex-row align-items-center" role="warning">
                                ...
                                <form action="{{ route('admin_villa_update_status', $villa[0]->id_villa) }}" method="get">
                                    <button class="btn" type="submit">{{ Translate::translate('activate this content') }}</button>
                                </form>
                                <span> ?</span>
                            </div>
                        @endif
            ...
            <div class="col-12">
                <div class="row top-profile">
                    <div class="col-12 pd-0">
                        <div class="profile-image">
                            @if ($villa[0]->image)
                            <img src="{{ URL::asset('/foto/gallery/' . strtolower($villa[0]->uid) . '/' . $villa[0]->image) }}">
                            @else
                                            ...
                                            <div class="cards4">
                                                ...
                                                <div class="card4 col-lg-3 radius-5">
                                                    ...
                                                    <div class="video-position">
                                                        <a type="button" onclick="view_story(23)">
                                                        <div class="story-video-player"><i class="fa fa-play"></i>
                                                        </div>
                                                            <video preload href="" class="story-video-grid"
                                                                style="object-fit: cover;"
                                                                src="{{ URL::asset('/foto/gallery/' . strtolower($villa[0]->uid) . '/' . $item->name) }}#t=1.0">
                                                            </video>
                                                            @if (Auth::user()->id == $villa[0]->created_by ||
                    ...
                    <div class="col-12 profile-info">
                        <h2>{{ $villa[0]->name }}</h2>
                        <span>{{ $villa[0]->bedroom }} {{ Translate::translate('Bedrooms') }} | {{ $villa[0]->bathroom }} {{ Translate::translate('Bathroom') }} |
                            {{ $villa[0]->adult }} {{ Translate::translate('Adults') }} | {{ $villa[0]->children }} {{ Translate::translate('Children') }}
                            @auth
                            @if (Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 ||
                            Auth::user()->role_id == 2)
                            &nbsp;<a type="button" onclick="edit_bedroom()"><i class="fa fa-pencil-alt"
                                    style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover"
                                    data-bs-animation="true" data-bs-placement="bottom" title="{{ Translate::translate('Edit') }}"></i></a>
                            @endif
                            @endauth
                        </span>

                        {{-- SHORT DESCRIPTION --}}
                        <p class="short-desc" id="short-description-content">{{ Translate::translate($villa[0]->short_description ?? 'there is no description yet') }}
                            @auth
                            @if (Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 ||
                            Auth::user()->role_id == 2)
                ...
                <div class="js-gallery">
                    ...
                    <section id="gallery" class="section">
                        ...
                        <a href="{{ URL::asset('/foto/gallery/' . strtolower($villa[0]->uid) . '/' . $item->name) }}"
                            class="img-lightbox photosGrid__Photo"
                            style="background-image: url('{{ URL::asset('/foto/gallery/' . strtolower($villa[0]->uid) . '/' . $item->name) }}')">
                        </a>
                        @auth
                        @if (Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 ||
                        Auth::user()->role_id == 2)
                        ...
                        url('{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->uid).'/'.$item->name)}}')">
                        </a> --}}
                        @endforeach
                        @endif
                        {{-- @auth
                    ...
                    <section id="description" class="section-2">
                        ...
                        <div class="about-place">
                            <h2>{{ Translate::translate('About this place') }}</h2>
                            <p id="description-content">
                                {{ Translate::translate($villa[0]->description ?? 'there is no description yet') }}
                                @auth
                                @if (Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 ||
                                Auth::user()->role_id == 2)
                                &nbsp;
                    ...
                    <section id="amenities" class="section-2">
                        <div class="pd-tlr-10">
                            <h2>
                            {{ Translate::translate('What this place offers') }}
                                @auth
                                @if (Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 ||
                                Auth::user()->role_id == 2)
                                &nbsp;
                            ...
                            <div class="amenities-box">
                                <button type="button" onclick="amenities()">{{ Translate::translate('More amenities') }}</button>
                            </div>
                            <hr>
                        </div>
                    </section>
                    ...
                    <section id="availability" class="section-2" >
                        <div class="pd-tlr-10">
                            <h2>{{ Translate::translate('Availability') }}</h2>
                        ...
                        <div class="row">
                            <div class="col-7 mobile-price">
                                ...
                                <p class="price-box"><i class="fa fa-star" style="color: orange; font-size:14px"></i>
                                        @if ($ratting->count() > 0)
                                        {{ $ratting[0]->average }} {{ Translate::translate('reviews') }}
                                    </p>
                                    @endif
                                <p class="price-box">{{-- Tanggal Booking --}} <a href="#">12 May - 24 June 2022</a></p>
                            </div>
                            <div class="col-5 text-right">
                                <button onclick="reserve()" type="button" class="reserve-mobile-button">{{ Translate::translate('RESERVE') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-12 pd-left-right-10">
            <div class="col-12">
                <section id="review" class="section-2">
                        <h2 class="margin-0">{{ Translate::translate('Review') }}</h2>
                        <div class="row review">
                            @if ($detail->count() > 0)
                            <div class="col-lg-6 col-md-6 col-xs-12">
                                <div class="row">
                                    <div class="col-6">
                                    {{ Translate::translate('Cleanliness') }}
                                    </div>
                                    <div class="col-6 ">
                            ...
                            @else
                                <div class="col-12 no-review">{{ Translate::translate('There is no review yet') }}</div>
                            @endif
                        </div>
                    <hr>
                </section>
                <div class="section" id="host_end">
                        ...
                        <div class="row">
                            ...
                            <div class=" col-10">
                                <div class="member-profile">
                                    <h4>{{ Translate::translate('Hosted by') }} {{ $createdby[0]->first_name }}</h4>
                                    <p>{{ Translate::translate('Joined in') }} November 2020</p>
                                </div>
                            </div>
                        </div>
                        <div class="member-profile-desc">
                            <p class="host-review"><i class="fa fa-heart" style="color: red;"></i> 141 {{ Translate::translate('Reviews') }} | <i class="fa fa-check"
                                    style="color: green;"></i> {{ Translate::translate('Identity verified') }}</p>
                            <h4>{{ Translate::translate('During your stay') }}</h4>
                            <p>{{ Translate::translate('I would nott be there during your stay, however our amazingly') }}<br> {{ Translate::translate('friendly staff Yudha
                                will be there to attend your needs') }}</p>
                            <p>{{ Translate::translate('Response rate:') }} 100%</p>
                            <p>{{ Translate::translate('Response time:') }} {{ Translate::translate('within an hour') }}</p>
                            <button type="button" onclick="contactHostForm()" class="member-profile-button">{{ Translate::translate('Contact
                                Host') }}</button>
                            <div class="row mt-20">
                                <div class="payment-warning-icon">
                                    <i class="fa fa-exclamation-triangle"></i> <span class="payment-warning">
                                    {{ Translate::translate('To protect your payment, never transfer money or communicate outside of the') }} EZ
                                    Villas Bali {{ Translate::translate('website or app.') }}</span>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 ml-10">
                                    <h6>{{ Translate::translate('House Rules') }}</h6>
                                    <p><i class="fas fa-clock"></i> {{ Translate::translate('Check-in:') }} {{ Translate::translate('After') }} 3:00 PM<br>
                                        <i class="fas fa-smoking-ban"></i> {{ Translate::translate('No smoking') }}<br>
                                        <i class="fas fa-ban"></i> {{ Translate::translate('No parties or events') }}
                                    </p>
                                </div>
                                <div class="col-12 ml-10">
                                    <h6>{{ Translate::translate('Health & Safety') }}</h6>
                                    <p><i class="fas fa-hands-wash"></i> EZ Villas Bali's {{ Translate::translate('social-distancing and
                                        other COVID-19-related guidelines apply') }}<br>
                                        <i class="far fa-bell-slash"></i> {{ Translate::translate('Carbon monoxide alarm not reported') }}
                                        <span><a href="#">{{ Translate::translate('Show More') }}</a></span><br>
                                        <i class="far fa-bell-slash"></i> {{ Translate::translate('Smoke alarm not reported') }} <span><a
                                                href="#">{{ Translate::translate('Show More') }}</a></span>
                                    </p>
                                    <p><a href="#">{{ Translate::translate('Show More') }} <i class="fas fa-chevron-right"></i></a></p>
                                </div>
                                <div class="col-12 ml-10">
                                    <h6>{{ Translate::translate('Cancellation Policy') }}</h6>
                                            <p>{{ Translate::translate('Add your trip dates to get the cancellation details for this stay.') }} <button type="button" class="btn btn-outline-dark ml-2 rounded-circle"
                                            style="width: 35px; height: 35px;" data-bs-toggle="tooltip"
                                            data-bs-placement="bottom"
                                            title="Cancellation and prepayment policies vary according to accommodation type. Please enter the dates of your stay and check the conditions of your required room.">
                                            ?
                                        </button></p>
                                    <p><a href="#">{{ Translate::translate('Add Date') }} <i class="fas fa-chevron-right"></i></a></p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-12 extra-info ml-10">
                                    <h4><span><i class="fas fa-utensils"></i> </span> {{ Translate::translate('Restaurants & Cafes') }}</h4>
                                    @foreach ($last as $item)
                                    @if (!empty($item))
                                    <p>{{ $item[2] }} <span>{{ $item[0] }} Km</span></p>
                                    @endif
                                    @endforeach
                                    {{-- <h4><span><i class="fas fa-eye"></i> </span> {{ Translate::translate('What's Surrounding') }}</h4> --}}
                                ...
                                <div class="col-12 extra-info ml-10">
                                    <h4><span><i class="fas fa-glasses"></i> </span> {{ Translate::translate('Top Things To Do') }}</h4>
                                ...
                                <div class="col-12 extra-info ml-10">
                                    <h4><span><i class="fas fa-leaf"></i> </span> {{ Translate::translate('Beauty & Spas') }}</h4>
                                    ...
                                    <h4><span><i class="fas fa-map-marker-alt"></i> </span> {{ Translate::translate('Closest Airport') }}</h4>
                                    <p><i class="fas fa-plane"></i> Ngurah Rai International Airport <span>30
                                            Km</span>
                                    </p>
                                    <h6>{{ Translate::translate('How to get to') }} <strong>{{ $villa[0]->name }}</strong> {{ Translate::translate('from') }} Ngurah Rai
                                        International
                                        Airport?</h6>
                                    <p><i class="fas fa-car"></i> Taxi &nbsp; <i class="fas fa-bus"></i>
                                    {{ Translate::translate('Private Suttle') }}
                                        &nbsp; <i class="fas fa-motorcycle"></i> GoJek</p>
                                    <p><i class="fas fa-coffee"></i> <strong>{{ Translate::translate('Free welcome drink') }}</strong> {{ Translate::translate('upon
                                        arrival.') }}
                                    </p>
                                </div>
                            </div>
                            <p style="font-size: small;">* {{ Translate::translate('All distances are measured in straight lines. Actual
                                travel
                                distances may vary.') }}</p>
                            <hr>
                            <h4>{{ Translate::translate('Nearby Restaurants & Things To Do') }}</h4>

                            {{-- Oke --}}

                            <div class="row related-items">
                                <h6><span><i class="fas fa-utensils"></i></span> {{ Translate::translate('Restaurants') }}</h6>
                            ...
                            <div class="row related-items">
                                <h6><span><i class="fa fa-walking"></i></span> {{ Translate::translate('Things To Do') }}</h6>
                                    ...
                                    <div id="cards-container2">
                                        <div class="cards2">
                                            ...
                                            @empty
                                                <div class="col-12">
                                                    <p class="no-related-items">
                                                        <span>{{ Translate::translate('No Things To Do Found') }}</span></a>
                                                    </p>
                                                </div>
                                            @endforelse
                                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <center>
                                <p style="margin-bottom: 0px; text-align: center;">
                                    <span>{{ Translate::translate('No Things To Do Found') }}</span></a></p>
                            </center>
                        </div>
                        @endforelse
                    </div>
                    ...
                    <div class="row" style="margin-top: 14px;">
                        <h6><span><i class="fas fa-walking"></i></span> {{ Translate::translate('Things To Do') }}</h6>
                        @forelse ($nearby_activities as $item)
                        <div class="col-lg-3 col-md-3 col-xs-12">
                            <p style="margin-bottom: 0px; text-align: center;"><a
    ...
    @endauth
    {{-- STORY MODAL --}}
    <div class="modal fade modal-video-block" id="storymodal" tabindex="-1" role="dialog" aria-labelledby="modal-default-large modal-default-fadein" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="col-12 modal-video-header">
    ...
    {{-- MODAL VIDEO --}}
    <div class="modal fade modal-video-block" id="videomodal" tabindex="-1" role="dialog" aria-labelledby="modal-default-large modal-default-fadein" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content video-container">
            <div class="col-12 modal-video-header">
                <div class="overlay-close">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background: white; border-radius:15px">
                <div class="modal-header">
                    <h5 class="modal-title">{{ Translate::translate('All Amenities') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
					...
					<div class="reserve-block">
						...
						<form method="POST" action="{{ route('villa_booking_confirm') }}">
							...
							<div class="row">
								<div class="col-7">
									<p class="price-box">IDR
										<span>{{ number_format($villa[0]->price, 0, ',', '.') }}</span>/{{ Translate::translate('night') }}
									</p>
								</div>
							...
							<div class="reserve-inner-block">
											...
											<div class="flatpickr-container"
												...
												<div style="display: table;">
													<div style="padding-left: 15px; padding-right: 30px; text-align: right; text-align: center;"
														class="col-lg-12">
														<p style="margin: 0px; font-size: 13px;">{{ Translate::translate('Clear Dates') }}</p>
													</div>
								...
								<div class="col-12 p-9-price line-top" style="border: 2px solid #FF7400; margin-top: 19px; border-radius: 15px; box-shadow: 1px 1px 10px #a4a4a4">
									<button type="button" class="collapsible">Guest
										<p style="font-size: 10px; float: right; margin: 0px;">{{ Translate::translate('guest') }}</p>
									...
									<div class="content sidebar-popup" style="left: 973px;">
										<div class="row" style="margin-top: 10px;">
											<div class="reserve-input-row">
												<div class="col-6">
													<div class="col-12">
														<p class="price-box">{{ Translate::translate('Adults') }}</p>
													</div>
													<div class="col-12">
											...
											<div class="reserve-input-row">
												<div class="col-6">
													<div class="col-12">
														<p class="price-box">{{ Translate::translate('Children') }}</p>
													</div>
													<div class="col-12">
														<p class="price-box" style="color: grey">{{ Translate::translate('Ages') }} 2-12</p>
													</div>
												</div>
												<div class="col-6"
													style="display: flex; align-items: center; justify-content: end;">
											...
											<div class="reserve-input-row">
												<div class="col-6">
													...
													<div class="col-12">
														<p class="price-box" style="color: grey">{{ Translate::translate('Under') }} 2</p>
													</div>
												</div>
												<div class="col-6"
													style="display: flex; align-items: center; justify-content: end;">
											...
											<div class="reserve-input-row">
												<div class="col-6">
													<div class="col-12">
														<p class="price-box">{{ Translate::translate('Pets') }}</p>
													</div>
												</div>
												<div class="col-6"
													style="display: flex; align-items: center; justify-content: end;">
							...
							<div class="col-12"
								...
								<div class="col-12" style="display: flex;">
									<div class="col-6" style="border-right: 2px solid #ff7400;">
										<p style="font-size: 12px; margin:0px;">{{ Translate::translate('Total Nights') }}</p>
									</div>
								...
								<div class="col-12" style="display: flex;">
									<div class="col-6" style="border-right: 2px solid #ff7400;">
										<p style="font-size: 12px; margin:0px;">{{ Translate::translate('Sub Total') }}</p>
									</div>
									<div class="col-6" style="padding-left: 12px; box-sizing: border-box;">
								...
								<div class="col-12" style="display: flex;">
									<div class="col-6">
										<p style="font-size: 12px; margin:0px; border-right: 2px solid #ff7400;">{{ Translate::translate('Tax &
											Service') }}</p>
									</div>
									<div class="col-6" style="padding-left: 12px; box-sizing: border-box;">
								...
								<div class="col-12"
									...
									<div class="col-6">
										<p style="margin: 0px; font-size: 12px;">{{ Translate::translate('Total') }}</p>
									</div>
							...
							<div class="col-12 p-5-price text-center" style="padding: 0px; margin-top: 20px;"><input
									...
									value="{{ Translate::translate('RESERVE NOW') }}"></div>
							<div class="col-12 p-5-price price-box text-center" style="margin-top: 9px;">{{ Translate::translate('You would not be
								charged yet') }}</div>
						</form>
					</div>
                </div>
                ...
                <div class="modal-body pb-1">
                        ...
                        <ul id="sortable" >
                            ...
                            foreach($photo as $item){
                                ...
                                <img src="../foto/gallery/' . strtolower($villa[0]->uid) . '/' . $item->name.'" title="'.$name.'" >
                                </li>';
                            }
                            ?>
                        </ul>
