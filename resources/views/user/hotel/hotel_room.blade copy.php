    ...
    <div id="page-container">
        ...
        <div class="row page-content">
                ...
                <div class="row top-profile">
                    <div class="col-lg-4- col-md-4 col-xs-12 pd-0">
                        <div class="profile-image">
                            @if ($hotelRoom->image)
                                <img
                                    src="{{ URL::asset('/foto/hotel/' . strtolower($hotel[0]->name) . '/' . $hotelRoom->image) }}">
                            @else
                    ...
                    <div class="col-lg-6- col-md-6 col-xs-12 profile-info">
                        <h2>{{ $hotelRoom->hotelType->name }} Room - {{ $hotel[0]->name }}</h2>
                        ...
                        {{-- SHORT DESCRIPTION --}}
                        <p class="short-desc" id="short-description-content">{{ $hotelRoom->short_description }}
                            @auth
                                @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                            ...
                            @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                <div id="short-description-form" style="display:none;">
                                    <form action="{{ route('room_update_short_description') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="id_hotel_room" value="{{ $hotelRoom->id_hotel_room }}" required>
                                        <textarea style="width: 100%;" name="short_description" id="short-description-form-input" cols="30" rows="3"
                                            maxlength="255" required>{{ $hotelRoom->short_description }}</textarea>
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-check"></i> Done
                                        </button>
                                        <button type="reset" class="btn btn-sm btn-secondary"
                        ...
                        @auth
                            @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                <div id="short-description-form" style="display:none;">
                                    <form action="{{ route('room_update_short_description') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="id_hotel" value="{{ $hotelRoom->id_hotel_room }}" required>
                    ...
                    <div class="col-lg-2 col-md-2 col-xs-12 right-0">
                        <div class="row social-share">
                            <div class="col-6 text-center icon-center">
                                @if ($hotel[0]->is_favorit)
                                    <p>
                                        <a href="{{ route('villa_favorit', $hotel[0]->id_hotel) }}"><i
                                                class="fa fa-heart" style="color: #f00;  font-size: 18px;"></i>
                                            <span>CANCEL</span>
                                        </a>
                                    </p>
                                ...
                                @auth
                                    @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                        <a class="delete delete-video" href="javascript:void(0);"
                                            onclick="delete_photo_video({'id': `{{ $hotelRoom->id_hotel_room }}`, 'id_video': `{{ $item->id_video }}`})"><i
                                                class="fa fa-trash"></i></a>
                                        <a type="button" class="delete" style="left: -40px !important; "
                        ...
                        @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                            <section style="padding-right: 10px; padding-left:5px; box-sizing: border-box;">
                                <form class="dropzone" id="frmTarget">
                                    @csrf
                                    <input type="hidden" value="{{ $hotelRoom->id_hotel_room }}" id="id_hotel_room" name="id_hotel_room">
                                </form>
                                        ...
                                        <form action="{{ route('room_update_description') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                <textarea name="description" id="description-form-input" class="w-100" rows="5"
                                                    required>{{ $hotelRoom->room_description }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-check"></i> Done
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-6 col-xs-12">
                                    <div class="row amenities-block">
                                        @foreach ($hotelRoom->typeAmenities->take(3) as $item1)
                                ...
                                <div class="flatpickr-container" style="display: flex; justify-content: center;">
                                    <div
                                        ...
                                        <div class="flatpickr" id="inline" style="text-align: left;">
                                            <input type="hidden" id="id_hotel_room" value="{{ $hotelRoom->id_hotel_room }}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <p class="price-box">IDR
                                        <span>{{ number_format($hotelRoom->price, 0, ',', '.') }}</span>/night
                                    </p>
                                </div>
            ...
            <div id="rsv-block-btn">
                ...
                <div class="rsv">IDR
                    <strong>{{ number_format($hotelRoom->price, 0, ',', '.') }}</strong>/night
            ...
            <div class="modal-dialog" role="document" style="overflow-y: initial !important">
                <div class="modal-content" style="background: white; border-radius:15px">
                    ...
                    <div class="modal-body pb-1" style=" height: 500px; overflow-y: auto;">
                        @php
                            $amenities = App\Http\Controllers\ViewController::amenities($hotel[0]->id_hotel);
                            $bathroom = App\Http\Controllers\ViewController::bathroom($hotel[0]->id_hotel);
                            $bedroom = App\Http\Controllers\ViewController::bedroom($hotel[0]->id_hotel);
                            $kitchen = App\Http\Controllers\ViewController::kitchen($hotel[0]->id_hotel);
                            $safety = App\Http\Controllers\ViewController::safety($hotel[0]->id_hotel);
                            $service = App\Http\Controllers\ViewController::service($hotel[0]->id_hotel);
