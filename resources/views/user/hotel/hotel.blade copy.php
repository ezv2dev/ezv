                    ...
                    @if (auth()->user()->id == $hotel[0]->created_by)
                        ...
                        @if ($hotel[0]->status == '2')
                            <div class="alert alert-warning d-flex flex-row align-items-center" role="warning">
                                ...
                                <form action="{{ route('villa_cancel_request_update_status', $hotel[0]->id_hotel) }}"
                                    method="post">
                                    @csrf
                                    @method('PATCH')
                                    <input type="hidden" name="id_hotel" value="{{ $hotel[0]->id_hotel }}">
                    ...
                    @if (in_array(auth()->user()->role->name, ['admin', 'superadmin']))
                        ...
                        @if ($hotel[0]->status == '2')
                            <div class="alert alert-warning d-flex flex-row align-items-center" role="warning">
                                ...
                                <form action="{{ route('admin_villa_update_status', $hotel[0]->id_hotel) }}"
                                    method="get">
                ...
                <div class="row top-profile">
                    <div class="col-lg-4- col-md-4 col-xs-12 pd-0">
                        <div class="profile-image">
                            @if ($hotel[0]->image)
                                <img
                                    src="{{ URL::asset('/foto/hotel/' . strtolower($hotel[0]->name) . '/' . $hotel[0]->image) }}">
                            @else
                            ...
                            @auth
                                @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                    &nbsp;
                                    <a type="button" onclick="edit_hotel_profile()"><i class="fa fa-pencil-alt"
                            ...
                            <div>
                                <p id="property-type-content">
                                    ...
                                    @auth
                                        @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                            &nbsp;<a type="button" onclick="editPropertyTypeForm()"><i
                                    ...
                                    @auth
                                        @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                            <div id="property-type-form" style="display:none;">
                                                <form action="{{ route('villa_update_property_type') }}" method="post">
                                                    @csrf
                                                    <input type="hidden" name="id_hotel"
                                                        value="{{ $hotel[0]->id_hotel }}" required>
                                                    <select name="id_property_type" id="property-type-form-input" required>
                    ...
                    <div class="col-lg-6- col-md-6 col-xs-12 profile-info">
                        <h2>{{ $hotel[0]->name }}</h2>
                        <p>{{ $hotel[0]->bedroom }} Bedrooms | {{ $hotel[0]->bathroom }} Bathroom |
                            {{ $hotel[0]->adult }} Adults | {{ $hotel[0]->children }} Children
                            @auth
                                @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                        ...
                        {{-- SHORT DESCRIPTION --}}
                        <p class="short-desc" id="short-description-content">{{ $hotel[0]->short_description }}
                            @auth
                                @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                            ...
                            @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                <div id="short-description-form" style="display:none;">
                                    <form action="{{ route('hotel_update_short_description') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="id_hotel" value="{{ $hotel[0]->id_hotel }}" required>
                                        <textarea style="width: 100%;" name="short_description" id="short-description-form-input" cols="30" rows="3"
                                            maxlength="255" required>{{ $hotel[0]->short_description }}</textarea>
                                        <button type="submit" class="btn btn-sm btn-primary">
                                            <i class="fa fa-check"></i> Done
                                        </button>
                                        <button type="reset" class="btn btn-sm btn-secondary"
                                                                    ...
                                                                    <div class="video-position">
                                                                        <a type="button"
                                                                            ...
                                                                            <video preload href="" class="story-video-grid"
                                                                                ...
                                                                                src="{{ URL::asset('/foto/hotel/' . strtolower($hotel[0]->name) . '/' . $item->name) }}#t=1.0">
                                                                            </video>
                                                                            @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                    ...
                    <div class="col-lg-2 col-md-2 col-xs-12 right-0">
                        <div class="row social-share">
                            <div class="col-6 text-center icon-center">
                                @if ($hotel[0]->is_favorit)
                                    <p>
                                        <a href="{{ route('hotel_favorit', $hotel[0]->id_hotel) }}"><i
                    ...
                    <section id="gallery" class="photosGrid section">
                        @if ($photo->count() > 0)
                            @foreach ($photo as $item)
                                <a href="{{ URL::asset('/foto/hotel/' . strtolower($hotel[0]->name) . '/' . $item->name) }}"
                                    class="img-lightbox photosGrid__Photo"
                                    style="background-image: url('{{ URL::asset('/foto/hotel/' . strtolower($hotel[0]->name) . '/' . $item->name) }}')">
                                </a>
                                @auth
                                    @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                        {{-- <a class="delete" href="{{ route('villa_delete_photo_photo', ['id' => $hotel[0]->id_hotel, 'id_photo' => $item->id_photo]) }}"> --}}
                                        <a class="delete delete-photo" href="javascript:void(0);"
                                        ...
                                        <a type="button" class="delete" style="left: -40px !important; "
                                            onclick="position_photo()"><i class="fa fa-pencil"></i></a>
                                    @endif
                                @endauth
                            @endforeach
                                ...
                                @auth
                                    @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                        <a class="delete delete-video" href="javascript:void(0);"
                                            onclick="delete_photo_video({'id': `{{ $hotel[0]->id_hotel }}`, 'id_video': `{{ $item->id_video }}`})"><i
                                                class="fa fa-trash"></i></a>
                                        <a type="button" class="delete" style="left: -40px !important; "
                        ...
                        url('{{ URL::asset('/foto/hotel/'.strtolower($hotel[0]->name).'/'.$item->name)}}')">
                        </a> --}}
                            @endforeach
                        @endif
                        {{-- @auth
                        ...
                        @if (Auth::user()->id == $hotel[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                            <section style="padding-right: 10px; padding-left:5px; box-sizing: border-box;">
                                <form class="dropzone" id="frmTarget">
                                    @csrf
                                    <input type="hidden" value="{{ $hotel[0]->id_hotel }}" id="id_hotel" name="id_hotel">
                                </form>
                                        ...
                                        <form action="{{ route('hotel_update_description') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                <textarea name="description" id="description-form-input" class="w-100" rows="5"
                                                    required>{{ $hotel[0]->description }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-sm btn-primary">
                                                    <i class="fa fa-check"></i> Done
                    ...
                    <section id="availability" class="section-2">
                        <div class="pd-tlr-10">
                            <div class="row">
                                <h2>Rooms</h2>
                                <div class="col-12">
                                    <table class="table table-image" style="text-align: center; width: 100%;">
                                        <thead style="background-color: #FF7400; color: white;">
                                            <tr style="border-color: #ff7400 !important;">
                                        ...
                                        <tbody>
                                            @forelse ($hotelTypeDetail as $item)
                                                <tr style="border-color: #ff7400 !important;">
                                                    <td class="w-35" style="width: 35%;">
                                                        <!-- <img src="{{ asset('foto/hotel/hotel test again/' . $item->image) }}"
                                                            class="img-fluid"
                                                            style="border: 1px solid #ff7400 !important; background-color: #ff7400 !important; height:210px;"
                                                            alt="Room"> -->
                                                            <div class="col-12">
                                                                        ...
                                                                        data-dots="false" data-arrows="true">
                                                                            ...
                                                                            <a href="" target="_blank"
                                                                                ...
                                                                                <a href="" target="_blank"
                                                                                    class="col-lg-6 grid-image-container">
                                                                                    <img class="img-fluid grid-image" style="display: block;"
                                                                                        src="https://images.unsplash.com/photo-1609611606051-f22b47a16689?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="">
                                                                                </a>
                                                    ...
                                                    <td style="width: 40%;" class="text-justify">
                                                        <h4><p>{{ $item->hotelType->name }}</p></h4>
                                                        <p class="desc-hotel">{{ $item->room_description }}</p>
                                                        ...
                                                        <div class="d-flex" style="font-size: 14px;">
                                                            ...
                                                            <p style="margin-left: 10px; margin-top: 5px;" class="mb-0">
                                                                {{ $item->room_size }}
                                                                m<sup>2</sup> </p>
                                                            @forelse ($item->typeAmenities as $item2)
                                                    ...
                                                    <td style="width: 15%;">
                                                        ...
                                                        <br>
                                                        <a href="{{ route('room_hotel', $item->id_hotel_type_detail) }}"
                                                            class="btn btn-outline-dark table-room-button">Select Room</a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr style="border-color: #ff7400 !important;">
                        ...
                        <div class="host">
                            ...
                            <div class="member-profile-desc">
                                <p class="host-review"><i class="fa fa-heart" style="color: red;"></i> 141
                                    Reviews | <i class="fa fa-check" style="color: green;"></i> Identity verified
                                </p>
                                ...
                                <p>Petulu Village <span>4.7 Km</span></p> --}}
                                    ...
                                    <p>Nail Care - Svndari Salon & Spa <span>2.7s Km</span></p> -->
                                        ...
                                        <h6>How to get to <strong>{{ $hotel[0]->name }}</strong> from Ngurah Rai
                                            International
                                            Airport?</h6>
            ...
            <div class="modal-dialog modal-xl" role="document">
                ...
                <div class="modal-content modal-content-story video-container" style="width:980px;">
                    <center>
                        ...
                        <input type="hidden" id="id_story" name="id_story" value="{{ $hotel[0]->id_story }}">
                        <input type="hidden" id="hotel" name="hotel" value="{{ $hotel[0]->name }}">
                ...
                <div class="modal-content" style="background: white; border-radius:25px">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="d-flex gap-3 align-items-center py-3">
                            @if ($hotel[0]->image)
                                <img src="{{ URL::asset('/foto/hotel/' . strtolower($hotel[0]->name) . '/' . $hotel[0]->image) }}"
                        ...
                        <ul id="sortable-photo">
                            @forelse ($photo as $item)
                                ...
                                <li class="ui-state-default" data-id="{{ $id }}">
                                    <img src="{{ asset('foto/gallery/' . strtolower($hotel[0]->name) . '/' . $item->name) }}"
                                        title="{{ $name }}">
                                </li>
                            @empty
                    ...
                    <div class="modal-body pb-1">
                        ...
                        <ul id="sortable-video">
                            @forelse ($video as $item)
                                ...
                                <li class="ui-state-default" data-id="{{ $id }}">
                                    <video
                                        src="{{ asset('foto/gallery/' . strtolower($hotel[0]->name) . '/' . $item->name) }}#t=1.0">
                                </li>
                            @empty
                                there is no image yet
                            @endforelse
