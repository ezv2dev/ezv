                            ...
                            @auth
                                @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                    &nbsp;<a type="button" onclick="edit_restaurant_profile()"
                                        style="font-size: 12pt; font-weight: 600; color: #ff7400;">Edit</a>
                                    @if ($restaurant->image)
                                    ...
                                    @auth
                                        @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                            <a type="button" onclick="editTimeForm()"
                                                style="font-size: 10pt; font-weight: 600; color: #ff7400;">Edit</a>
                                        @endif
                                    @endauth
                                </p>
                                @auth
                ...
                <div class="js-gallery">
                                            ...
                                            <span class="edit-menu-icon">
                                                <a data-bs-toggle="popover" data-bs-animation="true"
                                                    ...
                                                    onclick="view_add_caption({'id': '{{ $restaurant->id_restaurant }}', 'id_menu': '{{ $menu->id_menu }}'})"><i
                                                        class="fa fa-pencil"></i></a>
                                                <a style="height:40px" href="javascript:void(0);"
                                                    onclick="delete_menu({'id': '{{ $restaurant->id_restaurant }}', 'id_menu': '{{ $menu->id_menu }}'})"
                                                    data-bs-toggle="popover" data-bs-animation="true"
                                                    data-bs-placement="bottom" title="Delete Menu"><i
                                                        class="fa fa-trash"></i></a>
                                            </span>
                                        @endif
                                    @endauth
                    ...
                    <section id="amenities" class="section-2">
                        ...
                        <div class="row-grid-amenities">
                            ...
                            <div
                                style="border: 0.5px solid #bebebe; border-radius: 12px; box-shadow: 1px 1px 15px rgb(0 0 0 / 16%);">
                                ...
                                @auth
                                    @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                        &nbsp;<a type="button" onclick="editDescriptionForm()"
                                            style="font-size: 10pt; font-weight: 600; color: #ff7400;">Edit</i></a>
                                    @endif
                                @endauth
                            </p>
                            @auth
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-xs-12">
                                    <div class="d-flex">
                                        ...
                                        @auth
                                            @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                                &nbsp;<a type="button" onclick="editRestaurantRules()"
                                                    style="font-size: 10pt; font-weight: 600; color: #ff7400;">Edit</a>
                                            @endif
                                        @endauth
                                    </div>
                            ...
                            <div class="container-xxl mx-auto p-0">
                                <div class="slick-pop-slider">
                                    <div class="Container1">
                                        <div class="Head">
                                            <h6><i class="fa-solid fa-house"></i></span> Villas <span
                            ...
                            <div class="container-xxl mx-auto p-0">
                                <div class="slick-pop-slider">
                                    <div class="Container2">
                                        ...
                                        <div class="Head">
                                            <h6><i class="fa fa-walking"></i></span> Things To Do <span
                        ...
                        @forelse ($restaurant->video->sortBy('order') as $item)
                            ...
                            <li class="ui-state-default" data-id="{{ $id }}">
                                <video class="lozad" src="{{ LazyLoad::show() }}"
                                    data-src="{{ asset('foto/restaurant/' . strtolower($restaurant->uid) . '/' . $item->name) }}#t=0.1">
                            </li>
                        @empty
                            there is no image yet
                        @endforelse
