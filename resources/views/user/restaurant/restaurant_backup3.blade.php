...
<body style="background-color:white">
    {{-- <input type="hidden" id="min_stay" name="min_stay" value="{{ $villa->min_stay }}">
    <input type="hidden" id="price" name="price" value="{{ $villa->price }}"> --}}
        ...
        <div class="head-inner-wrap">
            ...
            <div class="search-bar">
                <form action="{{ route('list') }}" method="POST" id="basic-form">
                    @csrf
                    <input id="location" type="text" name="location" placeholder="Let's find location..." />
                    <div id="textfield" style="display: none">
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <input class="flatpickr form-control bg-white input2" type="text" name="check_in"
                                    id="check_in_2" placeholder="Check In" />
                            </div>
                            <div class="col-lg-6">
                                <input class="flatpickr form-control bg-white input3" type="text" name="check_out"
                                    id="check_out_2" placeholder="Check Out" />
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <input class="form-control input2" type="number" min="0" name="adult" id="adult"
                                    placeholder="Number of adults" />
                            </div>
                            <div class="col-lg-6">
                                <input class="form-control input3" type="number" min="0" name="children"
                                    id="children" placeholder="Number of children" />
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="headaer-search"><i class="fa fa-search"></i></button>
                </form>
            </div>
            <div class="right-bar">
                <nav>
                    ...
                    <ul>
                        <li><a href="#"><i class="fa fa-user" style="font-size: 20px;"></i></a>
                            <ul>
                                ...
                                @else
                                <ul>
                                    <li><a href="#"><i class="fa fa-user-check"></i> {{ Auth::user()->name }}</a>
                                        <ul>
                                            <li>
                                                <a href="{{ route('logout') }}"
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-xs-12 rsv-block">
            <div class="row top-profile">
                <div class="col-lg-4- col-md-4 col-xs-12">
                    <div class="profile-image">
                        ...
                        <div class="amenities">
                            ...
                            @else
                            @auth
                            @if(Auth::user()->id == $villa->created_by || Auth::user()->role_id == 1 ||
                            Auth::user()->role_id == 2)
                ...
                <div class="col-lg-6- col-md-6 col-xs-12">
                    <h2>
                        ...
                        @auth
                            @if (in_array(auth()->user()->role->name, ['admin', 'superadmin']) || auth()->user()->role->name == $restaurant->created_at)
                                <span>
                                    &nbsp;
                                    <a type="button" onclick="edit_name()">
                                        <i class="fa fa-pencil-alt"
                                        style="color:green; padding-right:5px;" data-bs-toggle="popover"
                                        data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i>
                                    </a>
                    ...
                    {{-- <p>{{ $villa->bedroom }} Bedrooms | {{ $villa->bathroom }} Bathroom |
                        {{ $villa->adult }} Adults | {{ $villa->children }} Children
                        @auth
                        @if(Auth::user()->id == $villa->created_by || Auth::user()->role_id == 1 ||
                        Auth::user()->role_id == 2)
                    ...
                    <p class="short-desc">
                        ...
                        @auth
                            @if (in_array(auth()->user()->role->name, ['admin', 'superadmin']) || auth()->user()->role->name == $restaurant->created_at)
                                <span>
                                    &nbsp;
                                    <a type="button" onclick="edit_short_description()">
                                        <i class="fa fa-pencil-alt"
                                        style="color:green; padding-right:5px;" data-bs-toggle="popover"
                                        data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i>
                                    </a>
                                        ...
                                        <li class="story">
                                            <div class="img-wrap">
                                                <a type="button" onclick="view_story({{ $item->id_story }});">
                                                    {{-- <img src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant->name).'/'.$item->thumbnail)}}"> --}}
            ...
            <div class="js-gallery">
                ...
                <section id="gallery" class="photosGrid section">
                    ...
                    @if ($restaurant->video->count() > 0)
                        ...
                        <a href="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant->name).'/'.$video->name)}}"
                            class="img-lightbox photosGrid__Photo"
                            style="background-image: url('{{ URL::asset('/foto/restaurant/'.strtolower($restaurant->name).'/'.$video->name)}}')">
                        </a>
                        @endforeach
                    @endif
                    @auth
                        @if (in_array(auth()->user()->role->name, ['admin', 'superadmin']) || auth()->user()->role->name == $restaurant->created_at)
                            <div style="padding-top:10px; padding-left:10px; padding-right:10px;">
                                &nbsp;
                                <a type="button" onclick="edit_photo()">
                                    <i class="fa fa-pencil-alt"
                                    style="color:green; padding-right:5px;" data-bs-toggle="popover"
                                    data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i>
                                </a>
                ...
                <section id="menu" class="section-2">
                    ...
                    <div class="photosGrid">
                        @if ($restaurant->menu->count() > 0)
                            ...
                            {{-- MODAL MENU --}}
                            <div class="modal fade" id="modal-menu-{{ $menu->id_menu }}" tabindex="-1" role="dialog" aria-labelledby="modal-default-fadein"
                                aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="background: white; border-radius:25px">
                                        ...
                                        <div class="modal-body pb-1">
                                            <img src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant->name).'/menu'.'/'.$menu->foto)}}" alt="{{ $menu->foto }}" class="img-fluid" style="border-radius:15px;">
                                            <h5>{{ $menu->name }}</h5>
                                            <h6><small>IDR </small>{{ NumberToCurrency::IDR($menu->price) }}</h6>
                        ...
                        <p style="text-align: justify; padding-top:10px; padding-bottom:10px">
                            ...
                            @auth
                                @if (in_array(auth()->user()->role->name, ['admin', 'superadmin']) || auth()->user()->role->name == $restaurant->created_at)
                                    <span>
                                        &nbsp;
                                        <a type="button" onclick="edit_description()">
                                            <i class="fa fa-pencil-alt"
                                            style="color:green; padding-right:5px;" data-bs-toggle="popover"
                                            data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i>
                                        </a>
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="sidebar">
                    <div class="reserve-block">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <p class="price-box">IDR
                                    {{-- <span>{{ number_format($restaurant->price, 0, ',', '.') }}</span>/night</p> --}}
                            </div>
                            <div class="col-5">
                                <p class="price-box"><i class="fa fa-star" style="color: orange; font-size:14px"></i>
                                    {{-- {{ $ratting->average }} reviews</p> --}}
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6 p-5-price line-right">
                                    <p class="price-box text-center"><strong>CHECK-IN</strong><br>
                                        <input class="text-center" type="text" id="check_in" name="check_in"
                                ...
                                <div class="col-6 p-5-price">
                                    <p class="price-box text-center"><strong>CHECK-OUT</strong><br>
                                        <input class="text-center" type="text" id="check_out" name="check_out"
                                            style="width:80%; border:0" placeholder="yyyy/mm/dd">
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            {{-- <p class="price-box mb-2"><input type="number" min="0"
                                                    max="{{ $villa->adult }}" value="1" id="adult" name="adult"
                                                    style="width: 70%"></p> --}}
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            {{-- <p class="price-box mb-2"><input type="number" min="0"
                                                    max="{{ $villa->children }}" id="child" name="child" value="0"
                                                    style="width: 70%"></p> --}}
                                        </div>
                                        <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-7 price-box">Sub Totat<input id="sum_night" value="0"
                    ...
                    <div class="reserve-mobile">
                        <div class="row">
                            <div class="col-7 mobile-price">
                                {{-- <p>IDR <span>{{ number_format($villa->price, 0, ',', '.') }}</span>/night</p> --}}
        ...
        <div id="rsv-block-btn">
            ...
            <div class="rsv">IDR <strong>{{ number_format($restaurant->price, 0, ',', '.') }}</strong>/night <span><a onclick="reserve2()" type="button" class="rsv-btn-button">RESERVE NOW</a></div>
        ...
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-6 ">
                                        {{-- <div class="liner"></div>{{ $detail->average_clean }} --}}
                                    </div>
                                    <div class="col-6">
                                        Check In
                                    </div>
                                    <div class="col-6">
                                        {{-- <div class="liner"></div>{{ $detail->average_check_in }} --}}
                                    </div>
                                    <div class="col-6">
                                        Value
                                    </div>
                                    <div class="col-6">
                                        {{-- <div class="liner"></div>{{ $detail->average_value }} --}}
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        {{-- <div class="liner"></div>{{ $detail->average_service }} --}}
                                    </div>
                                    <div class="col-6">
                                        Location
                                    </div>
                                    <div class="col-6">
                                        {{-- <div class="liner"></div>{{ $detail->average_location }} --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="host">
                    <div class="row">
                        <div class="col-2">
                            {{-- <img src="{{ URL::asset('/foto/gallery/'.strtolower($villa->name).'/'.$villa->image)}}" style="border-radius: 50%; width: 80px; margin-left: 20px; height: 80px;"> --}}
                        </div>
                        <div class=" col-10">
                    ...
                    <div class="member-profile-desc">
                        <p><i class="fa fa-heart" style="color: red;"></i> 141 Reviews | <i class="fa fa-check"
                                style="color: green;"></i> Identity verified</p>
                        <h4>Co-hosts</h4>
                        <p class="member-profile-photo">
                            {{-- <img src="{{ URL::asset('/foto/gallery/'.strtolower($villa->name).'/'.$villa->image)}}"> --}}
                            <span>Chandra</span></p>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-xs-12">
                                ...
                                <p><i class="fas fa-clock"></i> Check-in: After 3:00 PM<br>
                                    ...
                                    <i class="fas fa-ban"></i> No parties or events</p>
                            </div>
                            <div class="col-lg-4 col-md-4 col-xs-12">
                                <h6>Health & Safety</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-12 extra-info">
                                ...
                                {{-- <h6>How to get to <strong>{{ $villa->name }}</strong> from Ngurah Rai International Airport?</h6> --}}
                                    <p><i class="fas fa-car"></i> Taxi &nbsp; <i class="fas fa-bus"></i> Private Suttle &nbsp; <i class="fas fa-motorcycle"></i> GoJek</p>
                        ...
                        <div class="row related-properties">
                            <div class="col-lg-3 col-md-3 col-xs-12">
                                <p><a href="#"><img src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant->name).'/'.$restaurant->image)}}">
                                <span>{{ $restaurant->name }}</span></a></p>
                            </div>
                            <div class="col-lg-3 col-md-3 col-xs-12">
                                <p><a href="#"><img src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant->name).'/'.$restaurant->image)}}">
                                <span>{{ $restaurant->name }}</span></a></p>
        ...
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-content video-container" style="width: 1000px; border-radius: 25px;">
                <center>
                    ...
                    {{-- <input type="hidden" id="villa" name="villa" value="{{ $villa->name }}"> --}}
    ...
    <div class="modal fade" id="modal-amenities" tabindex="-1" role="dialog" aria-labelledby="modal-default-fadein"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background: white; border-radius:25px">
                ...
                <div class="modal-body pb-1">
                    {{-- @php
                    $amenities = App\Http\Controllers\ViewController::amenities($villa->id_villa);
                    $bathroom = App\Http\Controllers\ViewController::bathroom($villa->id_villa);
                    $bedroom = App\Http\Controllers\ViewController::bedroom($villa->id_villa);
                    $kitchen = App\Http\Controllers\ViewController::kitchen($villa->id_villa);
                    $safety = App\Http\Controllers\ViewController::safety($villa->id_villa);
                    $service = App\Http\Controllers\ViewController::service($villa->id_villa);
                    echo '<div class="row">';
                        foreach($amenities as $item)
                        {
    ...
    <div class="modal fade" id="modal-reserve" tabindex="-1" role="dialog"
        ...
        <div class="modal-body pb-1">
            <div class=" reserve-block">
                ...
                @auth
                @if(Auth::user()->id == $villa->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id ==
                2)
                &nbsp;<a type="button" onclick="edit_price()"><i class="fa fa-pencil-alt"
                        style="color:green; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true"
                        data-bs-placement="bottom" title="Edit"></i></a>
                @endif
                @endauth --}}
                {{-- <div class="row">
                    <div class="col-7">
                        <p class="price-box">IDR <span>{{ number_format($villa->price, 0, ',', '.') }}</span>/night
                        </p>
                    </div>
                    <div class="col-5">
                        <p class="price-box"><i class="fa fa-star" style="color: orange; font-size:14px"></i>
                    ...
                    <div class="col-12 p-5-price line-top">
                        ...
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    {{-- <p class="price-box mb-2"><input type="number" min="0" max="{{ $villa->adult }}" value="1" id="adult" name="adult" style="width: 70%"></p> --}}
                                </div>
                                <div class="col-6">
                                    <p class="price-box mb-2">Children (2-12)</p>
                                </div>
                                <div class="col-6">
                                    {{-- <p class="price-box mb-2"><input type="number" min="0" max="{{ $villa->children }}" id="child" name="child" value="0" style="width: 70%"></p> --}}
                                </div>
                                <div class="col-6">
                                    <p class="price-box mb-2">Infant (under 2)</p>
                                </div>
            ...
            <div class="modal-content" style="background: white; border-radius:25px">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="d-flex gap-3 align-items-center py-3">
                        {{-- <img src="{{ URL::asset('/foto/gallery/'.strtolower($villa->name).'/'.$villa->image)}}" style="height: 48px; width: 48px;" class="rounded-circle shadow"> --}}
                        {{-- <p class="d-flex align-items-center">{{ $villa->name }}</p> --}}
                    </div>
                    <div>
                        <div class="row row-cols-1 row-cols-lg-2">
                            ...
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('villa', $villa->id_villa) }}&display=popup" target="_blank" class="d-flex p-0">
                                    <div class="pr-5"><i class="fab fa-facebook"></i> <span class="fw-normal">Facebook</span></div>
                                </a> --}}
                            </div>
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="#" class="d-flex p-0">
                                    <div class="pr-5"><i class="fab fa-facebook-messenger"></i> <span class="fw-normal">Facebook Messenger</span></div>
                                </a> --}}
                            </div>
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="https://api.whatsapp.com/send?text={{ route('villa', $villa->id_villa) }}" target="_blank" class="d-flex p-0">
                                    <div class="pr-5"><i class="fab fa-whatsapp"></i> <span class="fw-normal">WhatsApp</span></div>
                                </a> --}}
                            </div>
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="https://telegram.me/share/url?url={{ route('villa', $villa->id_villa) }}&text={{ route('villa', $villa->id_villa) }}" target="_blank" class="d-flex p-0">
                                    <div class="pr-5"><i class="fab fa-telegram"></i> <span class="fw-normal">Telegram</span></div>
                                </a> --}}
                            </div>
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="mailto:?subject=I wanted you to see this site&amp;body={{ route('villa', $villa->id_villa) }}" target="_blank" class="d-flex p-0">
