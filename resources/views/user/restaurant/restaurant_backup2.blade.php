...
<body style="background-color:white">
    ...
    <div class="row">
            ...
            <div class="row top-profile">
                ...
                <div class="col-lg-6- col-md-6 col-xs-12">
                    ...
                    <p style="margin-top: 20px;"><a
                            ...
                            target="_blank"><i class="fa fa-map-marker-alt" style="font-size:14px"></i> {{ $restaurant[0]->location }}</a></p>
                    <p class="short-desc" id="short-description"></p>
                    <ul class="stories inner-wrap">
                        @auth
                        @if(Auth::user()->id == $restaurant[0]->created_by || Auth::user()->role_id == 1 ||
                        Auth::user()->role_id == 2)
                        @if($stories->count() == 0)
                        @for($i = 0; $i < 5; $i++) <li class="story">
                            <div class="img-wrap">
                            ...
                            @endfor
                            @else
                            @if($stories->count() < 5) @foreach($stories as $item) <li class="story">
                                <div class="img-wrap">
                                    <a type="button" onclick="view_story({{ $item->id_story }});">
                                        <img src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant[0]->name).'/'.$item->thumbnail)}}">
                                    </a>
                                </div>
                                </li>
                                @endforeach
                                @php
                                $count = 5 - $stories->count();
                                @endphp
                                @if($count > 0)
                                @for($i=0;$i<$count;$i++) <li class="story">
                                    <div class="img-wrap">
                                        <a type="button" onclick="edit_story()">
                                        ...
                                        <div class="img-wrap">
                                            <a type="button" onclick="view_story({{ $item->id_story }});">
                                                ...
                                                <video preload href="" class="story-video-grid"
                                                    ...
                                                    src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant[0]->name).'/'.$item->name)}}#t=1.0">
                                                </video></a>
                                        </div>
                    ...
                    <div class="row social-share">
                        <div class="col-6 text-center">
                            @if ($restaurant[0]->is_favorit)
                                <p>
                                    <a href="{{ route('restaurant_favorit', $restaurant[0]->id_restaurant) }}"><i class="fa fa-heart" style="color: #f00;  font-size: 18px;"></i>
                                        <span>CANCEL FAVORIT</span>
                                    </a>
                                </p>
                            @else
                                <p>
                                    <a href="{{ route('restaurant_favorit', $restaurant[0]->id_restaurant) }}"><i class="fa fa-heart" style="color: #aaa;  font-size: 18px;"></i>
            ...
            <div class="js-gallery">
                ...
                <section id="gallery" class="photosGrid section">
                    @if ($photo->count() > 0)
                        ...
                        <a href="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant[0]->name).'/'.$item->name)}}"
                        ...
                        @endforeach
                    @endif
                    @if (auth()->check() && in_array(auth()->user()->role->name, ['admin', 'superadmin']))
                ...
                <section id="menu" class="section-2">
                    ...
                    <div class="photosGrid">
                        @if ($menu->count() > 0)
                            ...
                            <a  data-bs-toggle="modal" data-bs-target="#modal-menu-{{ $item->id_menu }}"
                                class="img-lightbox photosGrid__Photo"
                                style="background-image: url('{{ URL::asset('/foto/restaurant/'.strtolower($restaurant[0]->name).'/menu'.'/'.$item->foto)}}')">
                            </a>
                            {{-- MODAL MENU --}}
                            <div class="modal fade" id="modal-menu-{{ $item->id_menu }}" tabindex="-1" role="dialog" aria-labelledby="modal-default-fadein"
                                aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content" style="background: white; border-radius:25px">
                                        ...
                                        <div class="modal-body pb-1">
                                            <img src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant[0]->name).'/menu'.'/'.$item->foto)}}" alt="{{ $item->foto }}" class="img-fluid" style="border-radius:15px;">
                                            <h5>{{ $item->name }}</h5>
                                            <h6><small>IDR </small>{{ $item->price }}</h6>
                ...
                <section id="description" class="section-2">
                    ...
                    <div style="padding-top:10px; padding-left:10px; padding-right:10px;">
                        ...
                        <p style="text-align: justify; padding-top:10px; padding-bottom:10px">
                            @if (!empty($restaurant[0]->description))
                ...
                {{-- <section id="location-map" class="section-2">
                    <div style="padding-top:10px; padding-left:10px; padding-right:10px;">
                        <h2>Location</h2>
                        <input type="hidden" value="{{$restaurant[0]->latitude}}" name="latitude" id="latitude">
                        <input type="hidden" value="{{$restaurant[0]->longitude}}" name="longitude" id="longitude">
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="sidebar">
                    <div class="reserve-block">
                        <input type="hidden" id="id_restaurant" name="id_restaurant" value="{{ $restaurant[0]->id_restaurant }}">
                        @auth
                        @if(Auth::user()->id == $restaurant[0]->created_by || Auth::user()->role_id == 1 ||
                        Auth::user()->role_id == 2)
                        ...
                        <div class="row">
                            <div class="col-7">
                                <p class="price-box">IDR
                                    {{-- <span>{{ number_format($restaurant[0]->price, 0, ',', '.') }}</span>/night</p> --}}
                            </div>
                            <div class="col-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            {{-- <p class="price-box mb-2"><input type="number" min="0"
                                                    max="{{ $villa[0]->adult }}" value="1" id="adult" name="adult"
                                                    style="width: 70%"></p> --}}
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            {{-- <p class="price-box mb-2"><input type="number" min="0"
                                                    max="{{ $villa[0]->children }}" id="child" name="child" value="0"
                                                    style="width: 70%"></p> --}}
                                        </div>
                                        <div class="col-6">
        ...
        <div id="rsv-block-btn">
            ...
            <div class="rsv">IDR <strong>{{ number_format($restaurant[0]->price, 0, ',', '.') }}</strong>/night <span><a onclick="reserve2()" type="button" class="rsv-btn-button">RESERVE NOW</a></div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="host">
                    <div class="row">
                        <div class="col-2">
                            {{-- <img src="{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->name).'/'.$villa[0]->image)}}" style="border-radius: 50%; width: 80px; margin-left: 20px; height: 80px;"> --}}
                        </div>
                        <div class=" col-10">
                    ...
                    <div class="member-profile-desc">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-12 extra-info">
                                ...
                                {{-- <h6>How to get to <strong>{{ $villa[0]->name }}</strong> from Ngurah Rai International Airport?</h6> --}}
                        ...
                        <div class="row related-properties">
                            <div class="col-lg-3 col-md-3 col-xs-12">
                                <p><a href="#"><img src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant[0]->name).'/'.$restaurant[0]->image)}}">
                                <span>{{ $restaurant[0]->name }}</span></a></p>
                            </div>
                            <div class="col-lg-3 col-md-3 col-xs-12">
                                <p><a href="#"><img src="{{ URL::asset('/foto/restaurant/'.strtolower($restaurant[0]->name).'/'.$restaurant[0]->image)}}">
                                <span>{{ $restaurant[0]->name }}</span></a></p>
    ...
    <div class="modal fade" id="modal-reserve" tabindex="-1" role="dialog"
        ...
        <div class="modal-body pb-1">
            <div class=" reserve-block">
                ...
                @auth
                @if(Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id ==
                2)
                &nbsp;<a type="button" onclick="edit_price()"><i class="fa fa-pencil-alt"
                ...
                {{-- <div class="row">
                    <div class="col-7">
                        <p class="price-box">IDR <span>{{ number_format($villa[0]->price, 0, ',', '.') }}</span>/night
                        </p>
                    </div>
                    <div class="col-5">
                        <p class="price-box"><i class="fa fa-star" style="color: orange; font-size:14px"></i>
                    ...
                    <div class="col-12 p-5-price line-top">
                        ...
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    {{-- <p class="price-box mb-2"><input type="number" min="0" max="{{ $villa[0]->adult }}" value="1" id="adult" name="adult" style="width: 70%"></p> --}}
                                </div>
                                <div class="col-6">
                                    <p class="price-box mb-2">Children (2-12)</p>
                                </div>
                                <div class="col-6">
                                    {{-- <p class="price-box mb-2"><input type="number" min="0" max="{{ $villa[0]->children }}" id="child" name="child" value="0" style="width: 70%"></p> --}}
                                </div>
                                <div class="col-6">
                                    <p class="price-box mb-2">Infant (under 2)</p>
                                </div>
            ...
            <div class="modal-content" style="background: white; border-radius:25px">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="d-flex gap-3 align-items-center py-3">
                        {{-- <img src="{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->name).'/'.$villa[0]->image)}}" style="height: 48px; width: 48px;" class="rounded-circle shadow"> --}}
                    ...
                    <div>
                        <div class="row row-cols-1 row-cols-lg-2">
                            ...
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('villa', $villa[0]->id_villa) }}&display=popup" target="_blank" class="d-flex p-0">
                            ...
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="https://api.whatsapp.com/send?text={{ route('villa', $villa[0]->id_villa) }}" target="_blank" class="d-flex p-0">
                                    <div class="pr-5"><i class="fab fa-whatsapp"></i> <span class="fw-normal">WhatsApp</span></div>
                                </a> --}}
                            </div>
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="https://telegram.me/share/url?url={{ route('villa', $villa[0]->id_villa) }}&text={{ route('villa', $villa[0]->id_villa) }}" target="_blank" class="d-flex p-0">
                                    <div class="pr-5"><i class="fab fa-telegram"></i> <span class="fw-normal">Telegram</span></div>
                                </a> --}}
                            </div>
                            <div class="col-lg col-12 p-3 border share-med">
                                {{-- <a href="mailto:?subject=I wanted you to see this site&amp;body={{ route('villa', $villa[0]->id_villa) }}" target="_blank" class="d-flex p-0">
    ...
    <script>
        function shortDescription(text) {
            let result = text.substring(0, 100);
            return result;
        }

        document.getElementById('short-description').innerHTML = shortDescription('{{ $restaurant[0]->description }}')+'...';
    </script>
</body>
