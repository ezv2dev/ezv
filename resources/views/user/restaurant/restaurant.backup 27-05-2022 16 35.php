...
<body style="background-color:white">
                ...
                <div class="row top-profile">
                    <div class="col-lg-4- col-md-4 col-xs-12 pd-0">
                        <div class="profile-image">
                            ...
                            &nbsp;<a type="button" onclick="edit_restaurant_profile()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                            @if ($restaurant->image)
                            ...
                            <div>
                                ...
                                <p style="font-size: 12px;" id="time-content">
                                    ...
                                    @auth
                                    @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                    <a type="button" onclick="editTimeForm()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                                    @endif
                                    @endauth
                                </p>
                                @auth
                                ...
                                <div class="col-12" style="display: flex; padding-right: 70px; padding-left: 70px; margin-top: 18px;">
                                    ...
                                    <div class="col-1">
                                        @auth
                                        @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                        <a type="button" onclick="edit_contact()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                                        @endif
                                        @endauth
                                    </div>
                                </div>
                                ...
                                <div class="col-12" style=" margin-top: 18px;" id="type-content">
                                    <p style="font-size: 12px">
                                        ...
                                        @auth
                                        @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                        <a type="button" onclick="editTypeForm()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                                        @endif
                                        @endauth
                                    </p>
                    ...
                    <div class="col-lg-6- col-md-6 col-xs-12" style="padding-left: 40px;">
                        <h2 id="name-content">
                            ...
                            @auth
                            @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                            &nbsp;<a type="button" onclick="editNameForm()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                            @endif
                            @endauth
                        </h2>
                        @auth
                        ...
                        <p class="short-desc" id="short-description-content">{{ $restaurant->short_description }}
                            @auth
                            @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                            &nbsp;<a type="button" onclick="editShortDescriptionForm()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                            @endif
                            @endauth
                        </p>
                        @auth
                        ...
                        <p class="text-secondary">
                            ...
                            @for ($i = 0; $i < 7; $i++) <span class="badge rounded-pill fw-normal" style="background-color: #FF7400;">{{ $tags[$i]->name }}</span>
                                ...
                                @auth
                                @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                &nbsp;<a type="button" onclick="add_tag()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                                @endif
                                @endauth
                        </p>
                        {{-- END TAG --}}
                                                ...
                                                <div class="img-wrap">
                                                    <div class="video-position">
                                                        <a type="button" onclick="view_story_restaurant({{ $item->id_story }});">
                                                            ...
                                                            <video href="javascript:void(0)" class="story-video-grid" style="object-fit: cover;" src="{{ URL::asset('/foto/restaurant/' . strtolower($restaurant->uid) . '/' . $item->name) }}#t=1.0">
                                                            </video>
                                                            @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                    ...
                    <ul class="navigationList">
                        ...
                        <li class="navigationItem">
                            <a id="menu-sticky" class="hoover font-13 navigationItem__Button" onClick="document.getElementById('menu').scrollIntoView();">
                                <i aria-label="Posts" class="fa-solid fa-book navigationItem__Icon svg-icon" fill="#262626" viewBox="0 0 20 20"></i>&nbsp
                                MENU
                            </a>
                        </li>
                        <li class="navigationItem ">
                        ...
                        <li class="navigationItem ">
                            <a id="amenities-sticky" class="hoover font-13 navigationItem__Button" onClick="document.getElementById('amenities').scrollIntoView();">
                                <i aria-label="Posts" class="fas fa-bell navigationItem__Icon svg-icon" fill="#262626" viewBox="0 0 20 20"></i>&nbsp
                                FACILITIES
                            </a>
                        </li>
                        <li class="navigationItem ">
                            <a id="location-sticky" class="hoover font-13 navigationItem__Button" onClick="document.getElementById('location-map').scrollIntoView();">
                ...
                <div class="js-gallery">
                        ...
                        <div class="simple-lightbox-container">
                            ...
                            <div class="gallery">
                                <a href="{{ URL::asset('/foto/restaurant/' . strtolower($restaurant->uid) . '/' . $item->name) }}">
                                    <img class="photosGrid__Photo img-lightbox lozad-gallery-load lozad-gallery" src="{{ URL::asset('/foto/restaurant/' . strtolower($restaurant->uid) . '/' . $item->name) }}" title="{{ $item->name }}">
                                </a>
                                @auth
                                @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                <a class="delete" style="height:40px" href="javascript:void(0);" onclick="delete_photo_photo({'id': `{{ $restaurant->id_restaurant }}`, 'id_photo': `{{ $item->id_photo }}`})" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Delete"><i class="fa fa-trash"></i></a>
                                <a type="button" class="delete" style="left: -40px !important; height:40px;" onclick="position_photo()" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit Position"><i class="fa fa-pencil"></i></a>
                                @endif
                                @endauth
                            </div>
                            @endforeach
                            ...
                            <a class="video-grid" onclick="view_video_restaurant({{ $item->id_video }})" href="javascript:void(0);">
                                ...
                                <video href="javascript:void(0)" class="photosGrid__Photo" style="object-fit: cover;" loading="lazy" src="{{ URL::asset('/foto/restaurant/' . strtolower($restaurant->uid) . '/' . $item->name) }}#t=1.0">
                                </video>
                            </a>
                            @auth
                            @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                            <a class="delete" style="height:40px" href="javascript:void(0);" onclick="delete_photo_video({'id': `{{ $restaurant->id_restaurant }}`, 'id_video': `{{ $item->id_video }}`})" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Delete"><i class="fa fa-trash"></i></a>
                            <a type="button" class="delete" style="left: -40px !important; height:40px;" onclick="position_video()" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit Position"><i class="fa fa-pencil"></i></a>
                            @endif
                            @endauth
                            @endforeach
                            @endif
                    ...
                    <section id="menu" class="section-2">
                        ...
                        <div class="photosGrid">
                            <div class="simple-lightbox-container2">
                                ...
                                <div class="gallery2">
                                    ...
                                    @auth
                                    @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                    <a class="delete" style="height:40px" href="javascript:void(0);" onclick="delete_menu({'id': `{{ $restaurant->id_restaurant }}`, 'id_menu': `{{ $menu->id_menu }}`})" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Delete"><i class="fa fa-trash"></i>
                                    </a>
                                    @endif
                                    @endauth
                                </div>
    ...
    <div class="row-grid-amenities">
        <div>
            <h2>
                ...
                @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                &nbsp;
                <a type="button" onclick="add_facilities()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                @endif
                @endauth
            </h2>
        </div>
        <div>
            <h2>
                ...
                @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                &nbsp;
                <a type="button" onclick="edit_location()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                @endif
                @endauth
            </h2>
        </div>
    ...
    <div class="row-grid-amenities">
        <div class="row-grid-list-amenities">
            ...
            @for ($i = 0; $i < 2; $i++) <div class="list-amenities">
                <div class="text-align-center" data-maxlength="5">
        ...
        <div class="list-amenities">
            <button class="amenities-button" type="button" onclick="view_amenities()">
                <div style="height: 60px; width: 60px; border: 3px solid grey; display: flex; align-items: center; justify-content: center; border-radius: 50%; font-size: 30px; font-weight: 700;">
    ...
    <section id="description" class="section-2" style="margin-top: 12px;">
        ...
        <div style="padding-top:12px; padding-left:10px; padding-right:10px;">
            ...
            <p id="description-content" style="text-align: justify; padding-top:10px; padding-bottom:12px">
                ...
                @auth
                @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                &nbsp;<a type="button" onclick="editDescriptionForm()"><i class="fa fa-pencil-alt" style="color:#FF7400; padding-right:5px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                @endif
                @endauth
            </p>
            @auth
    ...
    <div class="col-lg-3 col-md-3 col-12">
        <div class="sidebar sidebar-activity sidebar-activity-idle">
            <div class="reserve-block-activity" style="box-shadow: 0 4px 8px 0 rgb(0 0 0 / 20%); padding: 15px;">
                <center>
                    <h4>Popular Villa</h4>
                </center>
                <a href="{{ route('villa', $villas_advertise->id_villa) }}">
                    <img id="image" style="border-radius: 10px; aspect-ratio: 4/3; object-fit: cover;" class="lozad" src="">
                </a>
                <div class="row mt-2">
                    <div class="col-12">
                        ...
                        <div>
                            ...
                            <span><i class="fa fa-{{ $item->icon }}" style="border: none; font-size: 15px;"></i></span>
                            @endforeach
                        </div>
                        {{-- <p style="font-size: 12px; color: grey; margin-bottom: 0px;">
            ...
            <div class="reserve-block-activity gradient-try" style="box-shadow: 0 4px 8px 0 rgb(0 0 0 / 20%); padding: 15px; margin-top:10px;">
                <center>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-xs-12">
                                <div class="d-flex">
                                    ...
                                    @auth
                                    @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                    &nbsp;<a type="button" onclick="editRestaurantRules()"><i class="fa fa-pencil-alt" style="color:#FF7400; margin-left: 10px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                                    @endif
                                    @endauth
                                </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-12">
                                <div class="d-flex">
                                    ...
                                    @auth
                                    @if (Auth::user()->id == $restaurant->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                    &nbsp;<a type="button" onclick="editRestaurantGuestSafety()"><i class="fa fa-pencil-alt" style="color:#FF7400; margin-left: 10px;" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="Edit"></i></a>
                                    @endif
                                    @endauth
                                </div>
            ...
            <div class="modal-content" style="background: white; border-radius:25px">
                ...
                <div class="modal-body pb-1">
                    ...
                    <ul id="sortable-video">
                        ...
                        @endphp
                        <li class="ui-state-default" data-id="{{ $id }}">
                            <video class="lozad" src="{{ LazyLoad::show() }}" data-src="{{ asset('foto/restaurant/' . strtolower($restaurant->uid) . '/' . $item->name) }}#t=1.0">
                        </li>
                        @empty
                        there is no image yet
                        @endforelse
