                                ...
                                @if ($restaurant->facilities->count() > 2)
                                    <div class="list-amenities">
                                        <button class="amenities-button" type="button" onclick="view_amenities()">
                                            <div
                                                style="height: 60px; width: 60px; border: 3px solid grey; display: flex; align-items: center; justify-content: center; border-radius: 50%; font-size: 30px; font-weight: 700;">
                        ...
                        @forelse ($restaurant->video->sortBy('order') as $item)
                            ...
                            <li class="ui-state-default" data-id="{{ $id }}">
                                <video class="lozad" src="{{ LazyLoad::show() }}"
                                    data-src="{{ asset('foto/restaurant/' . strtolower($restaurant->uid) . '/' . $item->name) }}#t=1.0">
                            </li>
                        @empty
                            there is no image yet
                        @endforelse
