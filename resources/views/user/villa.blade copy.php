        ...
        <div class="row page-content">
            ...
            <div class="col-lg-9 col-md-9 col-xs-12 rsv-block">
                ...
                <div class="js-gallery">
                        ...
                        <div class="mobile">
                            <div class="col-12 row gallery">
                                @if ($photo->count() > 0)
                                    @foreach ($photo->sortBy('order') as $item)
                                        <div class="col-4 grid-photo" id="displayPhoto{{ $item->id_photo }}">
                                            <a data-toggle="modal" data-target="#modal-photo-gallery"
                                                data-section="{{ $item->id_photo }}">
                                                <img class="photo-grid img-lightbox lozad-gallery-load lozad-gallery"
                                                    src="{{ URL::asset('/foto/gallery/' . $villa[0]->uid . '/' . $item->name) }}"
                                                    title="{{ $item->caption }}">
                                            </a>
                    ...
                    @if ($isSharedRoom == 'yes')
                        <section id="room_option" class="section-2 div-room_option px-xs-8p px-sm-14p"
...
<<<<<<< HEAD
                            @for ($i = 0; $i < $villa[0]->villaBedroomDetail->count(); $i++)
                                <div class="row-grid-room-option" id="row-room-option">
                                    <div class="mx-0 row list-row-gap pt-xxs-20p pt-xs-15p pt-sm-35p pt-xlg-0p pt-lg-10p pb-0"
                                        style="margin-bottom: 1.5rem; box-shadow: 1px 1px 10px #a4a4a4;border: solid 1px #fff;padding: 10px !important;border-radius: 20px;height: fit-content;">
                                        <!-- Left Sedtion -->
                                        <div
                                            class="col-lg-4 py-0 col-xs-12 list-image-container grid-desc-container list-image-container">
                                            <img class="img-fluid"
                                                style="display: block; border-radius: 10px; height: 210px;"
                                                src="https://source.unsplash.com/random/?bed">
                                        </div>
                                        <!-- End Left Section -->
                                        <!-- Right Section -->
                                        <div class="col-lg-6 py-2 col-xs-12 list-image-container">
                                            <div class="mt-0">
                                                <h6 class="mt-2 mt-md-3 mt-lg-0 mb-lg-4">
                                                    {{ __('user_page.Bedroom') }} {{ $i + 1 }}</h6>
                                            </div>
                                        ...
                                        <div class="mt-3 mt-lg-0 " style="height:100%;">
                                            <div class="col-12" style="font-size: 13px;">
                                                ...
                                                <div class="container-room-option villa-list-title">
                                                    ...
                                                    @endforelse
                                                    {{-- <div class="">
>>>>>>> 8bd0d1e41be4dcc2111fdf6eadff26303ad86540
                                                        <span class="list-description font-black">
                                        ...
                                        <div class="mt-lg-4 col-lg-2 py-2 col-xs-12 room-price-container">
                                            <h4 style=" margin-bottom: 5px; margin-top: 15px; font-size: 16px;">IDR
                                                1,200,000 / Night</h4>
                                            <button type="submit" id="button"
                ...
                success: function(response) {
                    ...
                    for (let i = 0; i < response.data.photo.length; i++) {
                        ...
                        contentMobile += '<div class="col-4 grid-photo" id="displayPhoto' +
                            response.data.photo[i].id_photo +
                            '"> <a data-toggle="modal" data-target="#modal-photo-gallery" data-section="' +
                            response.data.photo[i].id_photo +
                            '"> <img class="photo-grid img-lightbox lozad-gallery-load lozad-gallery" src="' +
                            path + lowerCaseUid + slash + response.data.photo[i].name +
                            '"> </a> <span class="edit-icon"> <button data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="{{ __('user_page.Swap Photo Position') }}" type="button" onclick="position_photo()"><i class="fa fa-arrows"></i></button> <button data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="{{ __('user_page.Delete Photo') }}" href="javascript:void(0);" data-id="{{ $villa[0]->id_villa }}" data-photo="' +
                    ...
                    if (response.data.video.length > 0) {
                        for (let v = 0; v < response.data.video.length; v++) {
                            ...
                            contentMobile += '<div class="col-4 grid-photo" id="displayVideo' + response.data
                                .video[v]
                                .id_video +
                                '"> <a class="pointer-normal" onclick="view(' + response.data.video[v]
                                .id_video +
