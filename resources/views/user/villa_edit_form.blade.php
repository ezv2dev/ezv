...
<body style="background-color:white">
        ...
        <div class="row page-content">
                ...
                <div class="row top-profile">
                    <div class="col-lg-4- col-md-4 col-xs-12">
                        <div class="profile-image">
                            <img
                                src="{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->name).'/'.$villa[0]->image)}}">
                            @auth
                            @if(Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 ||
                            Auth::user()->role_id == 2)
                            &nbsp;<a type="button" onclick="edit_villa_profile()"><i class="fa fa-pencil-alt"
                                ...
                                @if($amenities->count() > 0)
                                    ...
                                    @auth
                                        @if(Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                            <a type="button" onclick="edit_amenities()">EDIT</a>
                                        @endif
                                    @endauth
                                    @guest
                    ...
                    <div class="col-lg-6- col-md-6 col-xs-12">
                                ...
                                @if(Auth::user()->id == $villa[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                    <div id="short-description-form" style="display:none;">
                                        <form action="{{ route('villa_update_short_description') }}" method="post">
                                            ...
                                            <textarea name="short_description" id="short-description-form-input" cols="30" rows="3" maxlength="255" required>{{ $villa[0]->short_description }}</textarea>
                        ...
                        <ul class="stories inner-wrap">
                            ...
                            Auth::user()->role_id == 2)
                            @if($stories->count() == 0)
                            @for($i = 0; $i < 5; $i++) <li class="story dropzone">
                                <div class="img-wrap">
                                ...
                                @if($stories->count() < 5) @foreach($stories as $item) <li class="story">
                                    <div class="img-wrap">
                                        <a type="button" onclick="view_story({{ $item->id_story }});">
                                            {{-- <img src="{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->name).'/'.$item->thumbnail)}}">
                                            --}}
                                            <img
                                                src="{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->name).'/'.$villa[0]->image)}}">
                                        </a>
            ...
            <div id="navbar" class="sticky-div">
                <ul class="navigationList">
                    ...
                    <li class="navigationItem">
                        <a class="hoover font-13 navigationItem__Button" onClick="document.getElementById('review').scrollIntoView();">
                                ...
                                <div id="description-form" style="display:none;">
                                    <form action="{{ route('villa_update_description') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <textarea name="description" id="description-form-input" class="w-100" rows="5" required>{{ $villa[0]->description }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-sm btn-primary">
                                                <i class="fa fa-check"></i> Done
                    ...
                    <div class="row">
                        <div class="col-7">
                            <p class="price-box">IDR
                                <span>{{ number_format($villa[0]->price, 0, ',', '.') }}</span>/night</p>
                        </div>
                        <div class="col-5">
                            ...
                            <div class="col-6 p-5-price line-right">
                                <p class="price-box text-center"><strong>CHECK-IN</strong><br>
                                    <input class="flatpickr"
                                        style="margin-left: 15px; font-size: 15px; border: none !important; border-color: transparent !important;"
    ...
    <div id="rsv-block-btn">
        ...
        <div class="rsv">IDR <strong>{{ number_format($villa[0]->price, 0, ',', '.') }}</strong>/night <span><a
                    onclick="reserve2()" type="button" class="rsv-btn-button">RESERVE NOW</a></div>
                    ...
                    <div class="member-profile-desc">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-12 extra-info">
                                ...
                                <h6>How to get to <strong>{{ $villa[0]->name }}</strong> from Ngurah Rai International
                                    Airport?</h6>
                        ...
                        <p style="font-size: small;">* All distances are measured in straight lines. Actual travel
                            distances may vary.</p>
                        <hr>
                        <h4>Nearby Restaurants & Activities</h4>
                        <h6><span><i class="fas fa-utensils"></i></span> Restaurants</h6>
                        <div class="row related-properties">
                            <div class="col-lg-3 col-md-3 col-xs-12">
                                <p><a href="#"><img
                                            src="{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->name).'/'.$villa[0]->image)}}">
                                        <span>{{ $villa[0]->name }}</span></a></p>
                            </div>
                            <div class="col-lg-3 col-md-3 col-xs-12">
                                <p><a href="#"><img
                                            src="{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->name).'/'.$villa[0]->image)}}">
                        ...
                        <h6><span><i class="fas fa-walking"></i></span> Activities</h6>
                        <div class="row related-properties">
                            <div class="col-lg-3 col-md-3 col-xs-12">
                                <p><a href="#"><img
                                            src="{{ URL::asset('/foto/gallery/'.strtolower($villa[0]->name).'/'.$villa[0]->image)}}">
        ...
        <div class="col-12 p-5-price line-top">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="price-box mb-2"><input type="number" min="0" max="{{ $villa[0]->adult }}" value="1"
                    ...
                    <div class="col-6">
                        <p class="price-box mb-2"><input type="number" min="0" max="{{ $villa[0]->children }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="background: white; border-radius:25px">
                ...
                <div class="modal-body p-4">
                    <div class="row">
                        <div class="col-9">
                            <p class="price-box">IDR <span>{{ number_format($villa[0]->price, 0, ',', '.') }}</span>/night</p>
                        </div>
                        <div class="col-3">
                            <p class="price-box"><i class="fa fa-star" style="color: orange; font-size:14px"></i>
                                @if($ratting->count() > 0)
