...
@section('content')
    ...
    <div class="col-lg-12 container-grid translate-text-group">
        @php
            $local = "<script>document.write(localStorage.getItem(mode))</script>";
        echo $local;
        @endphp
            ...
            <div class="grid-list-container lozad">
                ...
                <div class="desc-container-grid mb-2">
                    ...
                    <div class=" max-lines skeleton skeleton-h-2 skeleton-w-100">
                        <span class="text-14 fw-500 {{ $textColor }} list-description">{{ $data->name ?? __('user_page.There is no name yet') }}</span>
                    </div>
                    ...
                    <!-- <div style="min-height: 21px;" class="col-12 d-flex justify-content-left text-14 fw-400 text-grey-2">
                        @foreach ($data->cuisine->take(3) as $item)
                            @php
                                $i += 1;
                            @endphp
