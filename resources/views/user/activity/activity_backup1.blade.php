...
<body style="background-color:white">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-xs-12 rsv-block">
                <div class="row top-profile">
                    <div class="col-lg-4- col-md-4 col-xs-12">
                        <div class="profile-image">
                            <img
                                src="{{ URL::asset('/foto/activity/' . strtolower($activity[0]->name) . '/' . $activity[0]->image) }}">
                            <div class="amenities">
                    ...
                    <div class="col-lg-6- col-md-6 col-xs-12">
                        ...
                        @if ($activity[0]->price)
                            <h3><small>IDR</small> {{ NumberToCurrency::IDR($activity[0]->price->price) }}</h3>
                        @endif
                        <p style="margin-top: 20px;"><a
                                href="https://maps.google.com/?q={{ $activity[0]->latitude }},{{ $activity[0]->longitude }}"
                                target="_blank"><i class="fa fa-map-marker-alt" style="font-size:14px"></i>
                                {{ $activity[0]->location }}</a></p>
                        <p class="short-desc" id="short-description"></p>
                        <ul class="stories inner-wrap">
                            @auth
                                @if (Auth::user()->id == $activity[0]->created_by || Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                    @if ($stories->count() == 0)
                                        @for ($i = 0; $i < 5; $i++)
                                            <li class="story">
                                                <div class="img-wrap">
                                                ...
                                                <li class="story">
                                                    <div class="img-wrap">
                                                        <a type="button" onclick="view_story({{ $item->id_story }});">
                                                            <img
                                                                src="{{ URL::asset('/foto/activity/' . strtolower($activity[0]->name) . '/' . $item->thumbnail) }}">
                                                        </a>
                                                    </div>
                                                </li>
                                            @endforeach
                                            ...
                                            <div class="img-wrap">
                                                <a type="button" onclick="view_story({{ $item->id_story }});">
                                                    ...
                                                    <video preload href="" class="story-video-grid"
                                                        ...
                                                        src="{{ URL::asset('/foto/activity/' . strtolower($activity[0]->name) . '/' . $item->name) }}#t=1.0">
                                                    </video></a>
                                            </div>
                ...
                <div class="js-gallery">
                    ...
                    <section id="gallery" class="photosGrid section">
                        @if ($photo->count() > 0)
                            @foreach ($photo as $item)
                                <a href="{{ URL::asset('/foto/activity/' . strtolower($activity[0]->name) . '/' . $item->name) }}"
                    ...
                    <section id="description" class="section-2">
                        ...
                        <div style="padding-top:10px; padding-left:10px; padding-right:10px;">
                            ...
                            <p style="text-align: justify; padding-top:10px; padding-bottom:10px">
                                @if (!empty($activity[0]->description))
                    ...
                    <div style="padding-top:10px; padding-left:10px; padding-right:10px;">
                        <h2>Location</h2>
                        <input type="hidden" value="{{$activity[0]->latitude}}" name="latitude" id="latitude">
                        <input type="hidden" value="{{$activity[0]->longitude}}" name="longitude" id="longitude">
                    ...
                    <div class="reserve-block">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <p class="price-box">IDR
                                    {{-- <span>{{ number_format($activity[0]->price, 0, ',', '.') }}</span>/night</p> --}}
                            </div>
                            <div class="col-5">
                        ...
                        <div class="reserve-inner-block">
                            ...
                            <div class="col-12 p-5-price line-top">
                                ...
                                <button type="button" class="collapsible"><span id="total_guest"></span>
                                    Guest</button>
                                <div class="content">
                                    <div class="row">
                                        <div class="col-6">
            ...
            <div id="rsv-block-btn">
                ...
                {{-- <div class="rsv">IDR <strong>{{ number_format($activity[0]->price, 0, ',', '.') }}</strong>/night <span><a onclick="reserve2()" type="button" class="rsv-btn-button">RESERVE NOW</a></div> --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-xs-12 extra-info">
                                        ...
                                        <p><i class="fas fa-car"></i> Taxi &nbsp; <i class="fas fa-bus"></i>
                                            Private Suttle &nbsp; <i class="fas fa-motorcycle"></i> GoJek</p>
    ...
    <script>
        ...
        document.getElementById('short-description').innerHTML = shortDescription('{{ $activity[0]->description }}') +
            '...';
    </script>
</body>
