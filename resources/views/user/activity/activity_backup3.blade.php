                                                            ...
                                                            <div class="card4 col-lg-3" style="border-radius: 5px;">
                                                                <div class="img-wrap">
                                                                    <div class="video-position">
                                                                        <a type="button" onclick="view_story_activity({{ $item->id_story }});">
                    ...
                    <section id="amenities" class="section-2">
                        ...
                        <div class="row-grid-amenities">
                            <div class="row-grid-list-amenities">
                                @if ($activity->facilities->count() > 9)
                                    ...
                                    <div class="list-amenities">
                                        <div class="text-align-center">
                                            ...
                                            <p class="mb-0">{{ Translate::translate($activity->facilities[$i]->name) }}</p>
                                        </div>
                                    </div>
                                    @endfor
                                @else
                                    ...
                                    <div class="list-amenities">
                                        <div class="text-align-center">
                                            ...
                                            <p class="mb-0">{{ Translate::translate($item->name) }}</p>
                                        </div>
                                    </div>
                                    @empty
                                        <div class='list-amenities'>
                                ...
                                @if ($activity->facilities->count() > 5)
                                <div class="list-amenities">
