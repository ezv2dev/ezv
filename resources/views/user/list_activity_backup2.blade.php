            ...
            <div class="row top-20">
                <div class="col-lg-4 col-md-3 col-sm-12">
                    <div class="js-slider slick-nav-black slick-dotted-inner slick-dotted-white" data-dots="false"
                        data-arrows="true">
                        @php
                        $gallery = App\Http\Controllers\ViewController::restaurant_gallery($data->id_activity);
                        @endphp
                        @forelse ($gallery as $item)
                            <div>
                                <a href="{{ route('activity', $data->id_activity) }}" target="_blank">
                                    <img class="img-fluid video-slider"
                                        src="{{ URL::asset('/foto/activity/'.strtolower($data->name).'/'.$item->photo)}}"
                                        alt="">
                                </a>
                            </div>
                        @empty
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-12">
                            <div class="description">
                                ...
                                {{-- <div class="list-facilities">{{ $data->bedroom }} Bedroom, {{ $data->bathroom }}
                                    ...
                                    {{ $data->beds }} Beds</div> --}}
                                <div class="row fac">
                                    @php $facilities = App\Http\Controllers\ViewController::amenities($data->id_activity);
                                    @endphp
                                    @if(!$facilities->isEmpty())
                                    @if(count($facilities) >= 3)
                                    @for($i=0; $i<=2; $i++) <div class="col-1">
                        ...
                        <div class="short-description" id="short-description-{{ $data->id_activity }}"></div>
                        {{-- sort description --}}
                        <script>
                            ...
                            document.getElementById('short-description-{{ $data->id_activity }}').innerHTML = shortDescription('{{ $data->description }}')+'...';
                        </script>
                        <!-- End Villa Bed Type -->
                        <div class="address">
                            <i class="fa fa-map-pin color-green"></i> {{ $data->address }} - <span><a href="javascript.void(0)" data-bs-toggle="modal"
                                data-bs-target="#modal-map-{{$data->id_activity}}">View Map</a></span>
                        </div>
                ...
                <div class="col-lg-4 col-md-3 col-sm-12">
                    ...
                    <video class="photo" src="{{ URL::asset('/foto/gallery/'.strtolower($data->name).'/'.$data->video)}}#t=0.1" alt="Best villa in Bali"></video>
                    </a>
                    {{-- if promotion true
                        <p class="promo"><a type="button" class="btn-promo btn-sm"><i class="fa fa-gift"></i> Promotion</a></p>--}}
                    {{-- if promotion false  --}}
                        <p class="promo" data-bs-toggle="popover" data-bs-animation="true" data-bs-placement="bottom" title="There is no promotion available for the moment. Please visit us later!"><span class="btn-promo-false"><i class="fa fa-gift"></i> Promotion</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-11 rates-block">
                ...
                <div style="padding-top:10px">
                    ...
                    <span class="badge bg-green" style="font-size:16px;">from IDR
                        {{-- {{ number_format($data->price->price, 0, ',', '.') }}</span><br /> --}}
                        {{ NumberToCurrency::IDR($data->price->price) }}</span><br />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-map">
                ...
                <div class="modal-body pb-1" style="height: 500px">
                    <iframe src="https://maps.google.com/?q={{$data->latitude}},{{$data->longitude}}&output=embed" class="w-100 h-100"></iframe>
                </div>
            </div>
        </div>
    </div>
