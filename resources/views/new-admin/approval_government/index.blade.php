...
@section('title', 'UnApproval Government Page - EZV2')
            ...
            <div class="content content-full">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="background: transparent; margin-bottom: 0;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data Government UnApproved</li>
                    </ol>
                </nav>
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 mx-3 fs-3 fw-semibold">Data Government UnApproved</h1>
        ...
        <div class="col-12">
            ...
            <div class="col-md-7 mt-5" style="border-bottom: 1px solid #DFDFDE;">
                <div class="title-bar" style="margin-right: 20px; border-bottom: 2px solid #FF7400; display: inline-block;">
                    <a style="text-decoration: none;" href="{{ route('government_approval_index') }}"><h6><b>UnApproved</b></h6></a>
                </div>
                <div class="title-bar" style="margin-right: 20px; display: inline-block;">
                    <a style="text-decoration: none;" href="{{ route('government_list_approval_index') }}"><h6>Approved</h6></a>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#dataTable').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('government_unapproval_datatable') }}",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
