...
@section('title', 'User Reward Balance - EZV2')
        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">User Reward Balance</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-bordered table-hover" style="color: #383838" id="dataTable" width="100%"
                        ...
                        <thead style="color: #383838;" class="thead-dark table-borderless">
                            <tr>
                                ...
                                <th class="text-center">USER REWARD</th>
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#dataTable').dataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin_user_reward_balance_datatable') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
