...
@section('content_admin')
    ...
    <div class="container">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form style="font-size: 14px;" action="{{ route('admin_user_store') }}" method="POST" id="frm_tambah" class="js-validation text-black">
                    @csrf
                    <div class="block-content font-size-sm">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-input-admin-font" id="last_name" name="last_name" placeholder="Enter a last name.." required>
                            </div>
                            @error('last_name')
                                    <small class="form-text text-muted">{{ $message }}</small>
                            @enderror
