    ...
    <div class="container" style="padding-bottom: 30px;">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg">
                        <a class="btn btn-danger" style="color: #fff" href="{{ route('admin_user_trash') }}"><i class="fa fa-trash mr-2" aria-hidden="true"></i> Trash Data</a></span>
                    </div>
                </div>
            </div>
            <div class="card-body">
