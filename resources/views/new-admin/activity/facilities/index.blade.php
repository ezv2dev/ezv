...
@section('content_admin')
        ...
        <div class="bg-body-light">
            <div class="content content-full">
              <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Things To Do Facilities</h1>
                <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <a type="button" class="btn admin-adddata-button btn-sm btn-alt-primary" href="{{ route('admin_activity_facilities_create') }}">
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-header">Things To Do Facilities</div>
            <div class="card-body">
                <div class="datatable">
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#dataTable').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:"{{ route('admin_activity_facilities_datatable') }}",
            columns: [
