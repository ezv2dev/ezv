...
@section('content_admin')
        ...
        <div class="bg-body-light">
            <div class="content content-full">
              <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Villa Bedroom</h1>
                <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <a type="button" class="btn admin-adddata-button btn-sm btn-alt-primary" href="{{ route('admin_bedroom_create') }}">
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-header">Villa Bedroom</div>
            <div class="card-body">
                <div class="datatable">
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#dataTable').dataTable({
            processing: true,
            serverSide: true,
            ajax:"{{ route('admin_bedroom_datatable') }}",
            columns: [
