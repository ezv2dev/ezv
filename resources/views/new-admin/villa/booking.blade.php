...
@section('content_admin')
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-header">Add Booking Villa</div>
            <div class="card-body">
                <form action="{{ route('admin_villa_booking_store') }}" method="POST" id="basic-form" class="js-validation" enctype="multipart/form-data" >
                    @csrf
                            ...
                            <div class="block-content font-size-sm">
                                <div class="form-group row">
                                    <div class="col-sm-6 padding-left-none">
                                        <label class="form-label text-black" for="firstname">Firstname <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Enter a firstame..">
                                    </div>
                                    <div class="col-sm-6 padding-left-none">
                                        <label class="form-label text-black" for="lastname">Lastname <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Enter a lastname..">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <div class="col-sm-6 padding-left-none">
                                        <label class="form-label text-black" for="email">Email <span class="text-danger">*</span></label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter a email..">
                                    </div>
                                    <div class="col-sm-6 padding-left-none">
                                        <label class="form-label text-black" for="phone">Phone <span class="text-danger">*</span></label>
                            ...
                            <div class="block-content font-size-sm">
                                <div class="form-group row">
                                    <div class="col-sm-8 padding-left-none">
                                        <label class="form-label text-black" for="id_villa">Villa <span class="text-danger">*</span></label>
                                        <select class="js-select2 form-control" id="id_villa" name="id_villa" style="width: 100%;" data-placeholder="Choose one villa.." onchange="myChange(this)">
                                            <option></option><!-- Required for data-placeholder attribute to work with Select2 plugin -->
                                            @foreach($villa as $data)
                                                <option value="{{ $data->id_villa }}" data-price="{{ $data->price }}" data-stay="{{ $data->min_stay }}" data-adult="{{ $data->adult }}" data-children="{{ $data->children }}">{{ $data->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="form-label text-black" for="price">Price <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="price" name="price">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        {{-- <label class="form-label text-black" for="min_stay">Min Stay</label> --}}
                                        <input type="hidden" class="form-control" id="min_stay" name="min_stay" >
                                    </div>
                                    <div class="col-sm-4">
                                        {{-- <label class="form-label text-black" for="adult">Max Adult</label> --}}
                                        <input type="hidden" class="form-control" id="max_adult" name="max_adult" >
                                    </div>
                                    <div class="col-sm-4">
                                        {{-- <label class="form-label text-black" for="children">Max Children</label> --}}
                                        <input type="hidden" class="form-control" id="max_children" name="max_children" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 padding-left-none">
                                        <label class="form-label text-black" for="adult">Adult <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="adult" name="adult" placeholder="Enter a adult number..">
                                    </div>
                                    <div class="col-sm-6 padding-left-none">
                                        <label class="form-label text-black" for="child">Children <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="child" name="child" placeholder="Enter a children number..">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 padding-left-none">
                                        <label class="form-label text-black" for="check_in">Check In <span class="text-danger">*</span></label>
                                        <input type="text" class="flatpickr form-control bg-white" id="check_in" name="check_in" placeholder="Y-m-d">
                                    </div>
                                    <div class="col-sm-6 padding-left-none">
                                        <label class="form-label text-black" for="check_out">Check Out <span class="text-danger">*</span></label>
