...
@section('title', 'Villa Trash - EZV2')
    ...
    <div class="container" style="padding-bottom: 30px;">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg">
                        <a class="btn btn-success" style="color: #fff" href="{{ route('admin_villa') }}"><i class="fa fa-list mr-2" aria-hidden="true"></i> Data Villa</a></span>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
@section('scripts')
    ...
    $.ajaxSetup({
        ...
        var table = $('#dataTable').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin_villa_datatableTrash') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
        ...
        Swal.fire({
            ...
            if(result.isConfirmed){
                $.ajax({
                    type: "get",
                    dataType: 'json',
                    url: "{{ route('admin_villa_destroy','') }}/"+id,
                    statusCode: {
                        500: () => {
