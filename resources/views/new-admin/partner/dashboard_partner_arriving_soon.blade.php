        ...
        <ul class="ml-n5 mt-2">
            <li type="button" class="btn btn-light"
                style="color: #000; border-radius: 20px; border: 1px solid #DDDDDD; background-color:#fff;"><a style="color: black; text-decoration:none;" href="{{ route('partner_dashboard') }}">Currently
                    Hosting ({{$count}})</a></li>
            <li type="button" class="btn btn-light"
                style="color: #000; border-radius: 20px; border: 2px solid #000; background-color:#fff;"><a style="color: black; text-decoration:none;" href="{{ route('partner_dashboard2') }}">Arriving
...
<script>
    ...
    var table = $('#dataTable').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax:"{{ route('reservations_dashboard_datatables2') }}",
        columns: [
