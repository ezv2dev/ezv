...
<div class="page-header">
    <div class="container text-dark mb-max-lg-12r mb-max-xlg-17r mb-xlg-10r">
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between" style="position: relative;">
                ...
                <div class="col-12 col-md-3 card-guest-info-container">
                    <div class="card p-4 card-guest-info">
                        <div class="card-body">
