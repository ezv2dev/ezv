...
<body>
        ...
        <nav class="navbar-1-1 navbar navbar-expand-lg navbar-light p-4 px-md-4 mb-3 bg-body"
            ...
            <div class="container">
                <a href="{{ route('index') }}" class="navbar-brand" target="_blank">
                    <h3>EZV<span style="color: #FF7400;">2</span></h3>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <div class="d-flex">
                        <a class="btn btn-get-started btn-get-started-blue text-white" href="#">Get Started</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #000000; ">
        ...
        <div class="content-2-4 container-xxl mx-auto p-0  position-relative"
            style="font-family: 'Poppins', sans-serif">
