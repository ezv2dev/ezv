            ...
            <div class="col-12">
                ...
                <div class="col-md-7 mt-5" style="border-bottom: 1px solid #DFDFDE;">
                    <div class="title-bar" style="margin-right: 20px; border-bottom: 2px solid #FF7400; display: inline-block;">
                        <a style="text-decoration: none;" href="{{ route('hotel_room_reservations_dashboard') }}"><h6><b>Upcoming</b></h6></a>
                    </div>
                    ...
                    <div class="title-bar" style="margin-right: 20px; display: inline-block;">
                        <a style="text-decoration: none;" href="{{ route('hotel_reservations_all') }}"><h6>All</h6></a>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#dataTable').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax:"{{ route('hotel_room_reservations_datatable') }}",
            columns: [
