...
<div class="container pt-4">
    ...
    <div class="opportunity">
        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col-md-6 col-lg-4 p-0 mb-3">
                    <div class="card">
                        <div class="card-horizontal">
                            ...
                            <div class="card-body py-2 px-4">
                                <h4 class="card-title">Why it's smart to offer flexible cancellations
                                    right now</h4>
                    ...
                    <div class="card">
                        <div class="card-horizontal">
                            <img class="img-opportunities" aria-hidden="true" alt="" elementtiming="LCP-target"
                                ...
                                style="object-fit: cover; vertical-align: bottom;">
                            <div class="card-body py-2 px-4">
                                <h4 class="card-title">Getting started with EZV’s cleaning protocol
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-horizontal">
                            <img class="img-opportunities" aria-hidden="true" alt="" elementtiming="LCP-target"
                                ...
                                style="object-fit: cover; vertical-align: bottom;">
                            <div class="card-body py-2 px-4">
                                <h4 class="card-title">The do's and don’ts of providing self check-in
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-horizontal">
                            <img class="img-opportunities" aria-hidden="true" alt="" elementtiming="LCP-target"
                                ...
                                style="object-fit: cover; vertical-align: bottom;">
                            <div class="card-body py-2 px-4">
                                <h4 class="card-title">What you need to know about hosting families and
                                    pets</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-horizontal">
                            <img class="img-opportunities" aria-hidden="true" alt="" elementtiming="LCP-target"
                                ...
                                style="object-fit: cover; vertical-align: bottom;">
                            <div class="card-body py-2 px-4">
                                <h4 class="card-title">How to make your space comfortable for remote
                                    workers</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-horizontal">
                            <img class="img-opportunities" aria-hidden="true" alt="" elementtiming="LCP-target"
                                ...
                                style="object-fit: cover; vertical-align: bottom;">
                            <div class="card-body py-2 px-4">
                                <h4 class="card-title">The best amenities to offer right now</h4>
                            </div>
                        </div>
                    </div>
                </div>
