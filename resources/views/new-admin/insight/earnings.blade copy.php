    ...
    <div class="col-8">
        <div class="earnings pt-5 pb-5 text-dark">
            ...
            <div class="value-earnings mt-5">
                <h3 id="getEarnings" class="text-xl" style="font-weight: bold; color: rgb(54, 50, 50)">$0.00</h3>
    ...
    function changeYear(id){
        ...
        $.ajax({
            ...
            success: function(data){
                if (data.total == 0){
                    document.getElementById('getEarnings').textContent = "$0.00";
                    ...
                    document.getElementById('select-year').textContent = id;
                    document.getElementById('getEarnings').textContent = "Rp. "+data.total;
