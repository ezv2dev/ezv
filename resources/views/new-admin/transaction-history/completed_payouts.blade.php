    ...
    <div class="row mx-0 px-0">
        <div class="col-lg-8 mx-0 px-0">
            ...
            <div class="mb-4 tab-bar px-0">
                <a class="title-bar active" href="{{ route('completed_payouts') }}">Completed Payouts</a>
                <a class="title-bar" href="{{ route('upcoming_payouts') }}">Upcoming Payouts</a>
                <a class="title-bar" href="{{ route('gross_earnings') }}">Gross Earnings</a>
            </div>
            <div class="row mx-0 px-0">
                <div class="col-sm-6 px-0 pr-sm-2 mb-sm-0 mb-2">
            ...
            <div class="row mx-0 px-0 mt-2">
                <div class="col-sm-6 col-md-4 px-0 pr-sm-2 mb-sm-0 mb-2">
                    <select class="form-control">
                        <option><b>Form:</b> January</option>
                    </select>
                </div>
                <div class="col-sm-6 col-md-2 px-0 pr-md-2 mb-md-0 mb-2">
                    <select class="form-control">
                        <option>2022</option>
                    </select>
                </div>
            ...
            <div class="px-0 d-flex justify-content-between align-items-center mt-4">
                <p class="m-0"> <b>Paid Out:</b> IDR 0.00 </p>
