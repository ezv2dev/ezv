...
@section('title', 'Tax Setting - EZV2')
        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Tax Setting</h1>
                    <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <a type="button" class="btn admin-adddata-button btn-sm btn-alt-primary"
                                href="{{ route('admin_tax_setting_create') }}">
                    ...
                    <table class="table table-bordered table-hover" style="color: #383838" id="dataTable" width="100%"
                        ...
                        <thead style="color: #383838;" class="thead-dark table-borderless">
                            <tr>
                                ...
                                <th class="d-none d-sm-table-cell text-center" style="width: 20%;">CREATED AT</th>
...
@section('scripts')
    ...
    <script>
        ...
        var table = $('#dataTable').dataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin_tax_setting_datatable') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
