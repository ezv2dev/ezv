!(function (t, e) {
                ...
                ? Nt
                    ? function (t, e, n) {
                          if ((Pt(t), (e = jt(e)), Pt(n), "function" == typeof t && "prototype" === e && "value" in n && Dt in n && !n.writable)) {
                              var i = qt(t, e);
                              i && i.writable && ((t[e] = n.value), (n = { configurable: Ht in n ? n.configurable : i.configurable, enumerable: Bt in n ? n.enumerable : i.enumerable, writable: !1 }));
                          }
                          return Mt(t, e, n);
                      }
                    : Mt
        ...
        fe = l(function (t) {
            ...
            (t.exports = function (t, n, r, a) {
                ...
                M(r) &&
                    ...
                    (s = i(r)).source || (s.source = o.join("string" == typeof h ? h : ""))),
                    t !== f ? (l ? !u && t[n] && (c = !0) : delete t[n], c ? (t[n] = r) : $t(t, n, r)) : c ? (t[n] = r) : ot(n, r);
        ...
        fn = function () {
            ...
            fn =
                "undefined" != typeof document
                    ? document.domain && Ve
                        ? hn(Ve)
                        : (((e = kt("iframe")).style.display = "none"), sn.appendChild(e), (e.src = String("javascript:")), (t = e.contentWindow.document).open(), t.write(un("document.F=Object")), t.close(), t.F)
                    : hn(Ve);
        ...
        (xn = function (t) {
            ...
            if (
                (p &&
                    ...
                    -1 === Cn(d, "g") && (d += "g"),
                    (b = kn(u, l.lastIndex)),
                    l.lastIndex > 0 && (!l.multiline || (l.multiline && "\n" !== jn(u, l.lastIndex - 1))) && ((g = "(?: " + g + ")"), (b = " " + b), v++),
                    (n = new RegExp("^(?:" + g + ")", d))),
                In && (n = new RegExp("^" + g + "$(?!\\s)", d)),
                En && (i = l.lastIndex),
                (o = m(Sn, p ? n : l, b)),
                p ? (o ? ((o.input = kn(o.input, v)), (o[0] = kn(o[0], v)), (o.index = l.lastIndex), (l.lastIndex += o[0].length)) : (l.lastIndex = 0)) : En && o && (l.lastIndex = l.global ? o.index + o[0].length : i),
                In &&
                    o &&
                    o.length > 1 &&
                    m(_n, o[0], n, function () {
            ...
            if (!r || !a || n) {
                var s = A(/./[o]),
                    l = e(o, ""[t], function (t, e, n, i, o) {
                        var a = A(t),
                            l = e.exec;
                        return l === Nn || l === On.exec ? (r && !o ? { done: !0, value: s(e, n, i) } : { done: !0, value: a(n, e, i) }) : { done: !1 };
                    });
                ...
                (i =
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                        ? function (t, n) {
                              ...
                              for (
                                  var r, a, s, l = [], c = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), u = 0, h = new RegExp(t.source, c + "g");
                                  (r = m(Nn, h, i)) && !((a = h.lastIndex) > u && (qi(l, Bi(i, u, r.index)), r.length > 1 && r.index < i.length && xi(Ri, l, Ni(r, 1)), (s = r[0].length), (u = a), l.length >= o));
                    ...
                    function (t, o) {
                        ...
                        for (var p = 0, d = 0, g = []; d < a.length; ) {
                            ...
                            if (null === m || (v = Pi(we(h.lastIndex + (Li ? d : 0)), a.length)) === p) d = Dn(a, d, c);
                                ...
                                for (var b = 1; b <= m.length - 1; b++) if ((qi(g, m[b]), g.length === f)) return g;
                                d = p = v;
                            }
                        }
    ...
    $e({ target: "Object", stat: !0, forced: Object.assign !== Yi }, { assign: Yi });
    var Qi = Math.floor,
        Zi = A("".charAt),
        to = A("".replace),
        eo = A("".slice),
    ...
    function mo(t) {
        if (t) {
            ...
            Xi(e.element) ? Di(t, "introjs-fixedTooltip") : go(t, "introjs-fixedTooltip"),
                "floating" === e.position && (i = 0),
                vo(t, { width: "".concat(n.width + i, "px"), height: "".concat(n.height + i, "px"), top: "".concat(n.top - i / 2, "px"), left: "".concat(n.left - i / 2, "px") });
        }
    }
    Pn(
        "replace",
    ...
    function Xo(t, e, n, i) {
        ...
        if (
            ...
            switch (
                ...
                "floating" !== (l = this._introItems[this._currentStep].position) && this._options.autoPosition && (l = Yo.call(this, t, e, l)),
                (a = Ji(t)),
                (r = Ji(e)),
                (s = Gi()),
                ...
                case "right":
                    (e.style.left = "".concat(a.width + 20, "px")),
                        a.top + r.height > s.height ? ((n.className = "introjs-arrow left-bottom"), (e.style.top = "-".concat(r.height - a.height - 20, "px"))) : (n.className = "introjs-arrow left");
                    break;
                case "left":
                    i || !0 !== this._options.showStepNumbers || (e.style.top = "15px"),
                        a.top + r.height > s.height ? ((e.style.top = "-".concat(r.height - a.height - 20, "px")), (n.className = "introjs-arrow right-bottom")) : (n.className = "introjs-arrow right"),
        ...
        if (("string" == typeof t.highlightClass && (l += " ".concat(t.highlightClass)), "string" == typeof this._options.highlightClass && (l += " ".concat(this._options.highlightClass)), null !== a && null !== s)) {
            ...
            (o = s.querySelector(".introjs-skipbutton")),
                ...
                (r._lastShowElementTimer = window.setTimeout(function () {
                    null !== c && (c.innerHTML = "".concat(t.step, " ").concat(e._options.stepNumbersOfLabel, " ").concat(e._introItems.length)),
                        (u.innerHTML = t.intro),
                        (h.innerHTML = t.title),
            ...
            var d = Qo("div", { className: l }),
                ...
                _ = Qo("div");
            if (
                (vo(d, { "box-shadow": "0 0 1px 2px rgba(33, 33, 33, 0.8), rgba(33, 33, 33, ".concat(r._options.overlayOpacity.toString(), ") 0 0 0 5000px") }),
                $i.call(r, t),
                mo.call(r, d),
                mo.call(r, g),
            ...
            var C = Qo("div");
            !0 === this._options.showStepNumbers && ((C.className = "introjs-helperNumberLayer"), (C.innerHTML = "".concat(t.step, " ").concat(this._options.stepNumbersOfLabel, " ").concat(this._introItems.length)), m.appendChild(C)),
                m.appendChild(v),
                g.appendChild(m),
                ((n = Qo("a")).onclick = function () {
                    r._introItems.length - 1 !== r._currentStep
                        ? ur.call(r)
                        : /introjs-donebutton/gi.test(n.className) && ("function" == typeof r._introCompleteCallback && r._introCompleteCallback.call(r, r._currentStep, "done"), Yr.call(r, r._targetElement));
                }),
                zi(n),
                ...
                (o.onclick = function () {
                    r._introItems.length - 1 === r._currentStep && "function" == typeof r._introCompleteCallback && r._introCompleteCallback.call(r, r._currentStep, "skip"),
            ...
            0 === this._currentStep && this._introItems.length > 1
                ? (null != n && ((n.className = "".concat(this._options.buttonClass, " introjs-nextbutton")), (n.innerHTML = this._options.nextLabel)),
                  !0 === this._options.hidePrev
                      ? (null != i && (i.className = "".concat(this._options.buttonClass, " introjs-prevbutton introjs-hidden")), null != n && Di(n, "introjs-fullbutton"))
                ...
                ? (null != i && (i.className = "".concat(this._options.buttonClass, " introjs-prevbutton")),
                  !0 === this._options.hideNext
                      ? (null != n && (n.className = "".concat(this._options.buttonClass, " introjs-nextbutton introjs-hidden")), null != i && Di(i, "introjs-fullbutton"))
                      : null != n &&
                        (!0 === this._options.nextToDone
                            ? ((n.innerHTML = this._options.doneLabel), Di(n, "".concat(this._options.buttonClass, " introjs-nextbutton introjs-donebutton")))
    ...
    function ur() {
        ...
        var e = this._introItems[this._currentStep],
            n = !0;
        return (
            void 0 !== this._introBeforeChangeCallback && (n = this._introBeforeChangeCallback.call(this, e && e.element)),
            !1 === n
                ? (--this._currentStep, !1)
                : this._introItems.length <= this._currentStep
                ? ("function" == typeof this._introCompleteCallback && this._introCompleteCallback.call(this, this._currentStep, "end"), void Yr.call(this, this._targetElement))
                : void sr.call(this, e)
        );
    }
    function hr() {
        ...
        if ((null === e && (e = null === t.charCode ? t.keyCode : t.charCode), ("Escape" !== e && 27 !== e) || !0 !== this._options.exitOnEsc)) {
            if ("ArrowLeft" === e || 37 === e) hr.call(this);
                ...
                n && n.className.match("introjs-prevbutton")
                    ...
                    ? (this._introItems.length - 1 === this._currentStep && "function" == typeof this._introCompleteCallback && this._introCompleteCallback.call(this, this._currentStep, "skip"), Yr.call(this, this._targetElement))
    ...
    function wr() {
        ...
        r(gr(".introjs-hint"), function (e) {
            ...
            this._hintsAutoRefreshFunction && a.off(window, "scroll", this._hintsAutoRefreshFunction, this, !0);
    }
    function _r(t) {
        var e = gr('.introjs-hint[data-step="'.concat(t, '"]'))[0];
    ...
    $e(
        { target: "Array", proto: !0, forced: !$o },
        {
            splice: function (t, e) {
                ...
                } else if (n > i) for (r = c - i; r > u; r--) (s = r + n - 1), (a = r + i - 1) in l ? (l[s] = l[a]) : delete l[s];
        ...
        if (this._options.steps)
            ...
            r(n, function (t) {
                if ((!e._options.group || t.getAttribute("data-intro-group") === e._options.group) && "none" !== t.style.display) {
                    ...
                    (o = t.hasAttribute("data-disable-interaction") ? !!t.getAttribute("data-disable-interaction") : e._options.disableInteraction),
                        n > 0 &&
                            (i[n - 1] = {
                                element: t,
    ...
    function Ur(t) {
        ...
        if (
            ...
            mo.call(this, e),
            mo.call(this, i),
            t && ((this._introItems = zr.call(this, this._targetElement)), ir.call(this, e, this._introItems[this._currentStep]), ar.call(this, e)),
