                ...
                var SimpleLightbox = /*#__PURE__*/ function() {
                    ...
                    _createClass(SimpleLightbox, [{
                        ...
                        value: function createDomNodes() {
                            ...
                            this.domNodes.navigation.innerHTML = "<button class=\"sl-prev\" onclick=\"photoViews()\">".concat(this.options.navText[0], "</button><button class=\"sl-next\" onclick=\"photoViews()\">").concat(this.options.navText[1], "</button>");
