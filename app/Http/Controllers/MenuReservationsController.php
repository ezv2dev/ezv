...
class MenuReservationsController extends Controller
{
    public function index()
    {
        return view('new-admin.reservations.reservations_index');
    }

    public function reservations_completed_index()
    {
        return view('new-admin.reservations.reservations_completed');
    }

    public function reservations_canceled_index()
    {
        return view('new-admin.reservations.reservations_canceled');
    }

    public function reservations_all_index()
    {
        return view('new-admin.reservations.reservations_all');
    }
    ...
    public function datatableUpcoming(Request $request)
    {
        if ($request->ajax())
        {
    ...
    public function datatableCompleted(Request $request)
    {
        if ($request->ajax())
        {
            if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
            ...
            ->addColumn('aksi', function ($data) {
                if ($data->check_in > Carbon::now()->format('Y-m-d'))
                {
                    $aksi = "";
                $aksi .= "<center>";
                $aksi .= "
    ...
    public function datatableCanceled(Request $request)
    {
        if ($request->ajax())
        {
            if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
