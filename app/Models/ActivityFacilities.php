...
class ActivityFacilities extends Model
{
    protected $fillable = [
        'name',
        'icon',
    ...
    public function scopeDatatables()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                //             <a class='dropdown-item' href='/admin/activity/facilities/show/" . $data->id_facilities . "'>Edit</a>
                //             <a class='dropdown-item' href='/admin/activity/facilities/delete/" . $data->id_facilities . "'>Delete</a>
                //         </div>
                //     </div>";
                $aksi .= "
                    <li class='nav-item dropdown no-caret mr-3 d-none d-md-inline'>
                        ...
                        <div class='dropdown-menu dropdown-menu-right py-0 mr-sm-n15 mr-lg-0 o-hidden animated--fade-in-up' aria-labelledby='navbarDropdownDocs'>
                            <a class='dropdown-item py-3' href='" . route('admin_activity_facilities_show', $data->id_facilities) . "' target='_blank'>
                            ...
                            <a class='dropdown-item py-3' href='" . route('admin_activity_facilities_delete', $data->id_facilities) . "'>
    ...
    {
        return $this->belongsToMany(Activity::class, 'activity_has_facilities', 'id_facilities', 'id_activity', 'id_facilities', 'id_activity')->withPivot('created_by', 'updated_by')->withTimestamps();
    }
}
