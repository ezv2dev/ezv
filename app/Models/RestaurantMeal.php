...
class RestaurantMeal extends Model
{
    ...
    protected $table = 'restaurant_meal';
    ...
    public function scopeDatatables()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                //             <a class='dropdown-item' href='/admin/restaurant/meal/show/" . $data->id_meal . "'>Edit</a>
                //             <a class='dropdown-item' href='/admin/restaurant/meal/delete/" . $data->id_meal . "'>Delete</a>
                //         </div>
                //     </div>";
                $aksi .= "
                    <li class='nav-item dropdown no-caret mr-3 d-none d-md-inline'>
                        ...
                        <div class='dropdown-menu dropdown-menu-right py-0 mr-sm-n15 mr-lg-0 o-hidden animated--fade-in-up' aria-labelledby='navbarDropdownDocs'>
                            <a class='dropdown-item py-3' href='" . route('admin_restaurant_meal_show', $data->id_meal) . "' target='_blank'>
                            ...
                            <a class='dropdown-item py-3' href='" . route('admin_restaurant_meal_delete', $data->id_meal) . "'>
    ...
    {
        return $this->belongsToMany(Restaurant::class, 'restaurant_has_meal', 'id_meal', 'id_restaurant', 'id_meal', 'id_restaurant')->withPivot('created_by', 'updated_by')->withTimestamps();
    }
}
