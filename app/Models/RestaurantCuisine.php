...
class RestaurantCuisine extends Model
{
    ...
    protected $primaryKey = 'id_cuisine';
    ...
    public function scopeDatatables()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                //             <a class='dropdown-item' href='/admin/restaurant/cuisine/show/" . $data->id_cuisine . "'>Edit</a>
                //             <a class='dropdown-item' href='/admin/restaurant/cuisine/delete/" . $data->id_cuisine . "'>Delete</a>
                //         </div>
                //     </div>";
                $aksi .= "
                    <li class='nav-item dropdown no-caret mr-3 d-none d-md-inline'>
                        ...
                        <div class='dropdown-menu dropdown-menu-right py-0 mr-sm-n15 mr-lg-0 o-hidden animated--fade-in-up' aria-labelledby='navbarDropdownDocs'>
                            <a class='dropdown-item py-3' href='" . route('admin_restaurant_cuisine_show', $data->id_cuisine) . "' target='_blank'>
                            ...
                            <a class='dropdown-item py-3' href='" . route('admin_restaurant_cuisine_delete', $data->id_cuisine) . "'>
    ...
    {
        return $this->belongsToMany(Restaurant::class, 'restaurant_has_cuisine', 'id_cuisine', 'id_restaurant', 'id_cuisine', 'id_restaurant')->withPivot('created_by', 'updated_by')->withTimestamps();
    }
}
