...
class ActivityCategory extends Model
{
    ...
    {
        return $this->hasMany(ActivitySubcategory::class, 'id_category', 'id_category');
    }
    ...
    public function scopeDatatables()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                //             <a class='dropdown-item' href='/admin/things-to-do/category/show/" . $data->id_category . "'>Edit</a>
                //             <a class='dropdown-item' href='/admin/things-to-do/category/delete/" . $data->id_category . "'>Delete</a>
                //         </div>
                //     </div>";
                $aksi .= "
                    <li class='nav-item dropdown no-caret mr-3 d-none d-md-inline'>
                        ...
                        <div class='dropdown-menu dropdown-menu-right py-0 mr-sm-n15 mr-lg-0 o-hidden animated--fade-in-up' aria-labelledby='navbarDropdownDocs'>
                            <a class='dropdown-item py-3' href='" . route('admin_activity_category_show', $data->id_category) . "' target='_blank'>
                            ...
                            <a class='dropdown-item py-3' href='" . route('admin_activity_category_delete', $data->id_category) . "'>
