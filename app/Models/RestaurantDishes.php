...
class RestaurantDishes extends Model
{
    ...
    public function scopeDatatables()
    {
        ...
        return Datatables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                //             <a class='dropdown-item' href='/admin/restaurant/dishes/show/" . $data->id_dishes . "'>Edit</a>
                //             <a class='dropdown-item' href='/admin/restaurant/dishes/delete/" . $data->id_dishes . "'>Delete</a>
                //         </div>
                //     </div>";
                $aksi .= "
                    <li class='nav-item dropdown no-caret mr-3 d-none d-md-inline'>
                        ...
                        <div class='dropdown-menu dropdown-menu-right py-0 mr-sm-n15 mr-lg-0 o-hidden animated--fade-in-up' aria-labelledby='navbarDropdownDocs'>
                            <a class='dropdown-item py-3' href='" . route('admin_restaurant_dishes_show', $data->id_dishes) . "' target='_blank'>
                            ...
                            <a class='dropdown-item py-3' href='" . route('admin_restaurant_dishes_delete', $data->id_dishes) . "'>
    ...
    {
        return $this->belongsToMany(Restaurant::class, 'restaurant_has_dishes', 'id_dishes', 'id_restaurant', 'id_dishes', 'id_restaurant')->withPivot('created_by', 'updated_by')->withTimestamps();
    }
}
