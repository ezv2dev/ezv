...
class RestaurantType extends Model
{
    ...
    {
        $data = DB::table('restaurant_type')->select('*')->get();
        return Datatables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                //             <a class='dropdown-item' href='/admin/restaurant/type/show/" . $data->id_type . "'>Edit</a>
                //             <a class='dropdown-item' href='/admin/restaurant/type/delete/" . $data->id_type . "'>Delete</a>
                //         </div>
                //     </div>";
                $aksi .= "
                    <li class='nav-item dropdown no-caret mr-3 d-none d-md-inline'>
                        ...
                        <div class='dropdown-menu dropdown-menu-right py-0 mr-sm-n15 mr-lg-0 o-hidden animated--fade-in-up' aria-labelledby='navbarDropdownDocs'>
                            <a class='dropdown-item py-3' href='" . route('admin_restaurant_type_show', $data->id_type) . "' target='_blank'>
                            ...
                            <a class='dropdown-item py-3' href='" . route('admin_restaurant_type_delete', $data->id_type) . "'>
    ...
    {
        return $this->belongsToMany(Restaurant::class, 'restaurant_has_type', 'id_type', 'id_restaurant', 'id_type', 'id_restaurant')->withPivot('created_by', 'updated_by')->withTimestamps();
    }
}
